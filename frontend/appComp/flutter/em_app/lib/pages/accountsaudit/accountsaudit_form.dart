...
class AccountsAuditForm extends StatefulWidget { 
  const AccountsAuditForm({Key? key}) : super(key: key); 
 
  @override 
  _AccountsAuditFormState createState() => _AccountsAuditFormState(); 
} 
 
class _AccountsAuditFormState extends State<AccountsAuditForm> { 
...
void didChangeDependencies() { 
  ...
  Widget build(BuildContext context) { 
	return Scaffold( 
        ...
        appBar: AppBar( 
          title: const Text("AccountsAudit Add Form"), 
          centerTitle: true, 
        ), 
        body: Center( 
          child: Padding( 
 ...
 */ 
 ...
 // [4] Uncomment For Media Upload Customization. Also Uncomment Media Field Assignment in  newAccountsAudit creation below  
 /* 
                          //Get Base64 ready 
 ...
 */ 
 ...
 /* 
                          //Uncomment and Use Model AccountsAuditWoKey from model.dart, when key should not be passed, it is @GeneratedValue on API side  
                          AccountsAuditWoKey newAccountsAudit = AccountsAuditWoKey( 
 ...
 */ 
					   ...
					   afterValueText: afterValueTextVar , 
                          ...
                          await AccountsAuditService.AccountsAuditCreate( 
                                  newAccountsAudit.toJson()) 
                              .then((message) { 
                                    apiMessage = message; 
