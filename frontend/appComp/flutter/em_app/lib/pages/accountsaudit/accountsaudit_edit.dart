...
class AccountsAuditEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AccountsAuditEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AccountsAuditEditState createState() => _AccountsAuditEditState(); 
} 
 
class _AccountsAuditEditState extends State<AccountsAuditEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("AccountsAudit Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
...
class AccountsAuditEditRec extends StatefulWidget { 
  final AccountsAudit accountsAudit; 
  const AccountsAuditEditRec({Key? key, required this.accountsAudit}) : super(key: key); 
 
  @override 
  _AccountsAuditEditRecState createState() => _AccountsAuditEditRecState(); 
} 
 
class _AccountsAuditEditRecState extends State<AccountsAuditEditRec> { 
