...
class AccountsAuditGraph extends StatefulWidget { 	
  const AccountsAuditGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _AccountsAuditGraphState createState() => _AccountsAuditGraphState(); 	
} 	
	 	
class _AccountsAuditGraphState extends State<AccountsAuditGraph> { 	
 	
  //List<AccountsAudit> accountsAuditList = []; 	
  List<EmChartModel> accountsAuditList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    super.initState(); 	
    //AccountsAuditService.AccountsAuditViewAll().then((getList) { 	
    setState(() { 	
      //accountsAuditList = getList; 	
      //Local static data loading 	
      accountsAuditList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'AccountsAudit Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                accountsAuditList: accountsAuditList) 	
                            : LineChart(lineChartAccountsAudit()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartAccountsAudit() { 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> accountsAuditList; 	
  const BarChartSample2({Key? key, required this.accountsAuditList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.accountsAuditList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	
