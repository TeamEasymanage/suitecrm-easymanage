...
class AccountsAuditFilter extends StatefulWidget { 
  const AccountsAuditFilter({Key? key}) : super(key: key); 
 
  @override 
  _AccountsAuditFilterState createState() => _AccountsAuditFilterState(); 
} 
 
class _AccountsAuditFilterState extends State<AccountsAuditFilter> { 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AccountsAuditDataTable(viewType: "ListView", 
                                            pageNo: 0, 
