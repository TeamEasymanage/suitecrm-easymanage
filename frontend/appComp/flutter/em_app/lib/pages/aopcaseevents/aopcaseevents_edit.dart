...
class AopCaseEventsEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AopCaseEventsEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AopCaseEventsEditState createState() => _AopCaseEventsEditState(); 
} 
 
class _AopCaseEventsEditState extends State<AopCaseEventsEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("AopCaseEvents Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
...
class AopCaseEventsEditRec extends StatefulWidget { 
  final AopCaseEvents aopCaseEvents; 
  const AopCaseEventsEditRec({Key? key, required this.aopCaseEvents}) : super(key: key); 
 
  @override 
  _AopCaseEventsEditRecState createState() => _AopCaseEventsEditRecState(); 
} 
 
class _AopCaseEventsEditRecState extends State<AopCaseEventsEditRec> { 
