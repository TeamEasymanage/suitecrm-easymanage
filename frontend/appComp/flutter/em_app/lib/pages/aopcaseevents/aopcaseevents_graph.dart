...
class AopCaseEventsGraph extends StatefulWidget { 	
  const AopCaseEventsGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _AopCaseEventsGraphState createState() => _AopCaseEventsGraphState(); 	
} 	
	 	
class _AopCaseEventsGraphState extends State<AopCaseEventsGraph> { 	
 	
  //List<AopCaseEvents> aopCaseEventsList = []; 	
  List<EmChartModel> aopCaseEventsList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    super.initState(); 	
    //AopCaseEventsService.AopCaseEventsViewAll().then((getList) { 	
    setState(() { 	
      //aopCaseEventsList = getList; 	
      //Local static data loading 	
      aopCaseEventsList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'AopCaseEvents Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                aopCaseEventsList: aopCaseEventsList) 	
                            : LineChart(lineChartAopCaseEvents()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartAopCaseEvents() { 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> aopCaseEventsList; 	
  const BarChartSample2({Key? key, required this.aopCaseEventsList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.aopCaseEventsList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	
