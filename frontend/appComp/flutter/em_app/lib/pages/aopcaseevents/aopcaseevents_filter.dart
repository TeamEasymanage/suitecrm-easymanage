...
class AopCaseEventsFilter extends StatefulWidget { 
  const AopCaseEventsFilter({Key? key}) : super(key: key); 
 
  @override 
  _AopCaseEventsFilterState createState() => _AopCaseEventsFilterState(); 
} 
 
class _AopCaseEventsFilterState extends State<AopCaseEventsFilter> { 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AopCaseEventsDataTable(viewType: "ListView", 
                                            pageNo: 0, 
