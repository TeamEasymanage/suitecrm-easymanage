...
class AopCaseEventsForm extends StatefulWidget { 
  const AopCaseEventsForm({Key? key}) : super(key: key); 
 
  @override 
  _AopCaseEventsFormState createState() => _AopCaseEventsFormState(); 
} 
 
class _AopCaseEventsFormState extends State<AopCaseEventsForm> { 
...
void didChangeDependencies() { 
  ...
  Widget build(BuildContext context) { 
	return Scaffold( 
        ...
        appBar: AppBar( 
          title: const Text("AopCaseEvents Add Form"), 
          centerTitle: true, 
        ), 
        body: Center( 
          child: Padding( 
 ...
 */ 
 ...
 // [4] Uncomment For Media Upload Customization. Also Uncomment Media Field Assignment in  newAopCaseEvents creation below  
 /* 
                          //Get Base64 ready 
 ...
 */ 
 ...
 /* 
                          //Uncomment and Use Model AopCaseEventsWoKey from model.dart, when key should not be passed, it is @GeneratedValue on API side  
                          AopCaseEventsWoKey newAopCaseEvents = AopCaseEventsWoKey( 
 ...
 */ 
					   ...
					   caseId: caseIdVar , 
                          ...
                          await AopCaseEventsService.AopCaseEventsCreate( 
                                  newAopCaseEvents.toJson()) 
                              .then((message) { 
                                    apiMessage = message; 
