...
class AmTasktemplatesAmProjecttemplatesCOnlyDd extends StatefulWidget { 
  const AmTasktemplatesAmProjecttemplatesCOnlyDd({Key? key}) : super(key: key); 
 
  @override 
  _AmTasktemplatesAmProjecttemplatesCOnlyDdState createState() => _AmTasktemplatesAmProjecttemplatesCOnlyDdState(); 
} 
 
class _AmTasktemplatesAmProjecttemplatesCOnlyDdState extends State<AmTasktemplatesAmProjecttemplatesCOnlyDd> { 
    ...
    AmTasktemplatesAmProjecttemplatesCService.AmTasktemplatesAmProjecttemplatesCViewAll( 	
      ...
      setState(() { 	
       amTasktemplatesAmProjecttemplatesCList = getList; 	
		idSelected = amTasktemplatesAmProjecttemplatesCList[0].toListLabVal()[0][1].toString();	
		 //Remove duplicates 	
        //amTasktemplatesAmProjecttemplatesCList = amTasktemplatesAmProjecttemplatesCList.toSet().toList();	
        _loading = false;	
      });	
    });	
  } 	
                                  ...
                                  children: [	
                                    ...
                                    DropdownButton<String>(	
                                      ...
                                      style: const TextStyle(	
                                          ...
                                          color: Colors.black),	
                                      items: amTasktemplatesAmProjecttemplatesCList	
...
class AmTasktemplatesAmProjecttemplatesCEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AmTasktemplatesAmProjecttemplatesCEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AmTasktemplatesAmProjecttemplatesCEditDdState createState() => _AmTasktemplatesAmProjecttemplatesCEditDdState(); 
} 
 
class _AmTasktemplatesAmProjecttemplatesCEditDdState extends State<AmTasktemplatesAmProjecttemplatesCEditDd> { 
  ...
  void initState() {	
    ...
    AmTasktemplatesAmProjecttemplatesCService.AmTasktemplatesAmProjecttemplatesCViewAllIds().then((ids) { 	
      if (ids is String) {	
        setState(() {	
          errorMsg = ids;	
        });	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
	     backgroundColor: Colors.blue.shade200,	
        appBar: AppBar( 	
          title: const Text("AmTasktemplatesAmProjecttemplatesC Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
            ? EmShowProgress(msg: errorMsg)	
                ...
                child: Row(	
                  ...
                  children: [	
                    Padding(	
                      ...
                      _isKeySelected 	
                          ? FutureBuilder<AmTasktemplatesAmProjecttemplatesC>( 	
                              future: AmTasktemplatesAmProjecttemplatesCService 	
                                      .AmTasktemplatesAmProjecttemplatesCQuery(_chosenValue) 	
                                  .then((value) => value), 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AmTasktemplatesAmProjecttemplatesCEditDdRec( 	
                                          amTasktemplatesAmProjecttemplatesC: snapshot.data!); 	
                                    } 	
                                } 	
                              }) 	
                          : const SizedBox( 	
...
class AmTasktemplatesAmProjecttemplatesCEditDdRec extends StatefulWidget { 
  final AmTasktemplatesAmProjecttemplatesC amTasktemplatesAmProjecttemplatesC; 
  const AmTasktemplatesAmProjecttemplatesCEditDdRec({Key? key, required this.amTasktemplatesAmProjecttemplatesC}) : super(key: key); 
 
  @override 
  _AmTasktemplatesAmProjecttemplatesCEditDdRecState createState() => _AmTasktemplatesAmProjecttemplatesCEditDdRecState(); 
} 
 
class _AmTasktemplatesAmProjecttemplatesCEditDdRecState extends State<AmTasktemplatesAmProjecttemplatesCEditDdRec> { 
  AmTasktemplatesAmProjecttemplatesC foundAmTasktemplatesAmProjecttemplatesC = AmTasktemplatesAmProjecttemplatesC(id: "" ); 
...
void didChangeDependencies() { 
  ...
  void initState() { 
    super.initState(); 
    setState(() { 
      foundAmTasktemplatesAmProjecttemplatesC = widget.amTasktemplatesAmProjecttemplatesC; 
    }); 
  } 
            ...
            child: Form( 
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					   enabled: false,    initialValue: getEmStrOpt(foundAmTasktemplatesAmProjecttemplatesC.id),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmTasktemplatesAmProjecttemplatesC.dateModified),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmTasktemplatesAmProjecttemplatesC.deleted),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
                    ...
                    builder: (context) => ButtonWidget( 
                      ...
                      onClicked: () async { 
						...
						// ===== BEGIN BLOCK : Calling API Service Calls ('Edit') 1st (optional 2nd...) and Routing to Next Screen 
                          ...
                          AmTasktemplatesAmProjecttemplatesC newAmTasktemplatesAmProjecttemplatesC = AmTasktemplatesAmProjecttemplatesC( 
					   id: idVar , 
					   dateModified: dateModifiedVar , 
					   deleted: deletedVar , 
							  ); 
 
                          await AmTasktemplatesAmProjecttemplatesCService.AmTasktemplatesAmProjecttemplatesCEdit( 
                                  newAmTasktemplatesAmProjecttemplatesC.id, 
                                  newAmTasktemplatesAmProjecttemplatesC) 
                              .then((message) { 
                                    apiMessage = message; 
