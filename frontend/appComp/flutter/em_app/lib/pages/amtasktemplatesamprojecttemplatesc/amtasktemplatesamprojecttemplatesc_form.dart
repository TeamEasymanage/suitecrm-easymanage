...
class AmTasktemplatesAmProjecttemplatesCForm extends StatefulWidget { 
  const AmTasktemplatesAmProjecttemplatesCForm({Key? key}) : super(key: key); 
 
  @override 
  _AmTasktemplatesAmProjecttemplatesCFormState createState() => _AmTasktemplatesAmProjecttemplatesCFormState(); 
} 
 
class _AmTasktemplatesAmProjecttemplatesCFormState extends State<AmTasktemplatesAmProjecttemplatesCForm> { 
...
void didChangeDependencies() { 
  ...
  Widget build(BuildContext context) { 
	return Scaffold( 
        ...
        appBar: AppBar( 
          title: const Text("AmTasktemplatesAmProjecttemplatesC Add Form"), 
          centerTitle: true, 
        ), 
        body: Center( 
          child: Padding( 
 ...
 */ 
 ...
 // [4] Uncomment For Media Upload Customization. Also Uncomment Media Field Assignment in  newAmTasktemplatesAmProjecttemplatesC creation below  
 /* 
                          //Get Base64 ready 
 ...
 */ 
 ...
 /* 
                          //Uncomment and Use Model AmTasktemplatesAmProjecttemplatesCWoKey from model.dart, when key should not be passed, it is @GeneratedValue on API side  
                          AmTasktemplatesAmProjecttemplatesCWoKey newAmTasktemplatesAmProjecttemplatesC = AmTasktemplatesAmProjecttemplatesCWoKey( 
 ...
 */ 
					   ...
					   deleted: deletedVar , 
                          ...
                          await AmTasktemplatesAmProjecttemplatesCService.AmTasktemplatesAmProjecttemplatesCCreate( 
                                  newAmTasktemplatesAmProjecttemplatesC.toJson()) 
                              .then((message) { 
                                    apiMessage = message; 
