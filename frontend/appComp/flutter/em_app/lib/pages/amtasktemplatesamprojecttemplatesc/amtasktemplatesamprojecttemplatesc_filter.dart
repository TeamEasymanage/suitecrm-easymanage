...
class AmTasktemplatesAmProjecttemplatesCFilter extends StatefulWidget { 
  const AmTasktemplatesAmProjecttemplatesCFilter({Key? key}) : super(key: key); 
 
  @override 
  _AmTasktemplatesAmProjecttemplatesCFilterState createState() => _AmTasktemplatesAmProjecttemplatesCFilterState(); 
} 
 
class _AmTasktemplatesAmProjecttemplatesCFilterState extends State<AmTasktemplatesAmProjecttemplatesCFilter> { 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AmTasktemplatesAmProjecttemplatesCDataTable(viewType: "ListView", 
                                            pageNo: 0, 
