...
class AmTasktemplatesAmProjecttemplatesCEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AmTasktemplatesAmProjecttemplatesCEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AmTasktemplatesAmProjecttemplatesCEditState createState() => _AmTasktemplatesAmProjecttemplatesCEditState(); 
} 
 
class _AmTasktemplatesAmProjecttemplatesCEditState extends State<AmTasktemplatesAmProjecttemplatesCEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("AmTasktemplatesAmProjecttemplatesC Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AmTasktemplatesAmProjecttemplatesCEditRec( 	
...
class AmTasktemplatesAmProjecttemplatesCEditRec extends StatefulWidget { 
  final AmTasktemplatesAmProjecttemplatesC amTasktemplatesAmProjecttemplatesC; 
  const AmTasktemplatesAmProjecttemplatesCEditRec({Key? key, required this.amTasktemplatesAmProjecttemplatesC}) : super(key: key); 
 
  @override 
  _AmTasktemplatesAmProjecttemplatesCEditRecState createState() => _AmTasktemplatesAmProjecttemplatesCEditRecState(); 
} 
 
class _AmTasktemplatesAmProjecttemplatesCEditRecState extends State<AmTasktemplatesAmProjecttemplatesCEditRec> { 
