...
import 'package:em_app/pages/amtasktemplatesamprojecttemplatesc/amtasktemplatesamprojecttemplatesc_service.dart'; 
import 'package:em_app/pages/amtasktemplatesamprojecttemplatesc/amtasktemplatesamprojecttemplatesc_lib.dart'; 
...
class AmTasktemplatesAmProjecttemplatesCDataTable extends StatefulWidget { 
  final String? viewType; 
  final int? pageNo; 
  final String? searchClause; 
  final String? sortClause; 
  const AmTasktemplatesAmProjecttemplatesCDataTable({Key? key, this.viewType  
  , this.pageNo 
  , this.searchClause 
  , this.sortClause 
  }) : super(key: key); 
  ...
  @override 
  _AmTasktemplatesAmProjecttemplatesCDataTableState createState() => _AmTasktemplatesAmProjecttemplatesCDataTableState(); 
} 
 
class _AmTasktemplatesAmProjecttemplatesCDataTableState extends State<AmTasktemplatesAmProjecttemplatesCDataTable> { 
  String dispType = "DataTable"; 
  String emTitle =  "AmTasktemplatesAmProjecttemplatesC Data Table"; 
  int noOfCardsPerRow = 2; 
  int noOfFieldsForCard = 2; 
 
  String errorMsg = timeErrStr; 
 
  List<AmTasktemplatesAmProjecttemplatesC> amTasktemplatesAmProjecttemplatesCList = []; 
  ...
  void initState() { 
    ...
    if (widget.viewType != null ) { 
      ...
      switch (widget.viewType) { 
        case "ListView": { 
        dispType = "ListView"; 
        emTitle = "AmTasktemplatesAmProjecttemplatesC List View"; 
        } 
        break; 
        case "ListCard": { 
        dispType = "ListCard"; 
        emTitle = "AmTasktemplatesAmProjecttemplatesC List Card"; 
        } 
        break; 
        default: 
      } 
    ...
    print("Calling Service : AmTasktemplatesAmProjecttemplatesCSelectWhere ... "); 
    print("searchClause: [" +searchFilter +"]");  
    print("sortClause: [" +sortBy +"]");  
    AmTasktemplatesAmProjecttemplatesCService.AmTasktemplatesAmProjecttemplatesCSelectWhere( 
      currPageNo 
      , searchFilter 
      , sortBy 
    ).then((getList) { 
      ...
      setState(() { 
        amTasktemplatesAmProjecttemplatesCList = getList; 
        _loading = false; 
      }); 
      }  
    }); 
    ...
    print("Calling Service : AmTasktemplatesAmProjecttemplatesCViewAll ... "); 
    AmTasktemplatesAmProjecttemplatesCService.AmTasktemplatesAmProjecttemplatesCViewAll( 
      currPageNo 
    ).then((getList) { 
      if (getList is String) { 
        setState(() { 
 ...
 /* ---------- To Implement - GET value from Hive and FindByColumnName -------------------  
  ...
  bool _loadingProvider = true; 
    ...
    _loading = true; 
    print("Calling Service : AmTasktemplatesAmProjecttemplatesCFindByColumnName ... "); 
    if (userCode.isNotEmpty) {
    AmTasktemplatesAmProjecttemplatesCService.AmTasktemplatesAmProjecttemplatesCFindByColumnName(userCode).then((getList) {
      if (getList is String) {
        setState(() {
          errorMsg = getList;
        });
...
Container getDataTableView() { 
          ...
          return Container(  
                   ...
                   //------------------------------------ Scrollbars 	
                      ...
                      source: AmTasktemplatesAmProjecttemplatesCDataSource(amTasktemplatesAmProjecttemplatesCList), 
                      columns: <DataColumn>[ 
                DataColumn( 
...
// --------------- List Card View ------------------- 
  GridView getListCard() { 
    Iterable AmTasktemplatesAmProjecttemplatesCCardList = 
        amTasktemplatesAmProjecttemplatesCList.map((e) =>  
     SizedBox( 
    ...
    return GridView.count( 
        ...
        children: List.from(AmTasktemplatesAmProjecttemplatesCCardList) 
    ); 
  } 
 
  Widget getColumnsForListCard1(AmTasktemplatesAmProjecttemplatesC e) { 
...
Widget _buildListView() {  
    ...
    if (amTasktemplatesAmProjecttemplatesCList.length == 0) { 
    return Column( 
      children: [ 
                            ...
                            IconButton( 	 
                              onPressed: () { 	 
                                Navigator.of(context).push(MaterialPageRoute( 	 
                                  builder: (context) =>  
                                  const AmTasktemplatesAmProjecttemplatesCForm(), 	 
                                  ), 	 
                                ); 	 
                              }, 	 
                              icon: const Icon( 	 
    ...
    var noOfFields = amTasktemplatesAmProjecttemplatesCList[0].toMapLabelVal().length;  
    //print (noOfFields);  
    ...
    dataColumns.add(  
              DataColumn( 
                label: Text(  
                            amTasktemplatesAmProjecttemplatesCList[0].toListLabVal()[i][0].toString(),  
    ...
    return DataTable(  
      columns: dataColumns, 
      /* <DataColumn>[  
        DataColumn(label: Text(amTasktemplatesAmProjecttemplatesCList[0].toListLabVal()[0][0].toString(), style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600))),  
        DataColumn(label: Text(amTasktemplatesAmProjecttemplatesCList[0].toListLabVal()[1][0].toString(), style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600))),  
      ],  
      */ 
      rows: amTasktemplatesAmProjecttemplatesCList  
          .map((e) =>  
              getDataRow(e) 
          ).toList(),  
    );  
...
DataRow getDataRow(AmTasktemplatesAmProjecttemplatesC oh) { 
                      ...
                      children: [ 
                        IconButton( 	 
                            onPressed:  () => showDialog<String>( 	 
                                ...
                                builder: (BuildContext context) => AlertDialog(  
                                  ...
                                  title: Text('AmTasktemplatesAmProjecttemplatesC Details', 	 
                                      style: TextStyle( 	 
                                          color: Colors.red.shade400, 	 
                                          //fontSize: 22, 	 
                                          //fontWeight: FontWeight.w400 	 
                                          )), 	 
                                  content: _AmTasktemplatesAmProjecttemplatesCInfo(foundAmTasktemplatesAmProjecttemplatesC: oh), 	 
                                  actions: <Widget>[ 	 
                                    TextButton( 	 
                        ...
                        IconButton( 	 
                                ...
                                builder: (BuildContext context) => AlertDialog(  
                                  ...
                                  actions: <Widget>[ 	 
                                    ...
                                    TextButton( 	  
                                      ...
                                      Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AmTasktemplatesAmProjecttemplatesCDataTable(viewType: dispType, pageNo: 0, searchClause: " id = "+valParam+" ",),  
                                            ), 
                                          ); 
                                      }, 
                                      child: const Text('Go'), 
                            ...
                            IconButton( 	 
                              onPressed: () { 	 
                                Navigator.of(context).push(MaterialPageRoute( 	 
                                  builder: (context) => AmTasktemplatesAmProjecttemplatesCEdit( 	 
                      				idSelected: oh.id, 	
                                  ), 	 
                                )); 	 
                              }, 	 
                        ...
                        actions: <Widget>[ 	 
                          ...
                          TextButton( 	 
                            onPressed: () async { 	 
                              ...
                              String apiMessage = ""; 	 
                              // Begin Service Call 	 
                              await AmTasktemplatesAmProjecttemplatesCService.AmTasktemplatesAmProjecttemplatesCDelete( 	 
                                      oh.id) 	 
                                  .then((message) { 	 
                                    apiMessage = message;	 
...
// --------------- DataTable Functions ------------------- 
  void doColumnSort(int columnIndex, bool ascending) { 
	if (columnIndex == 0) { 
	  amTasktemplatesAmProjecttemplatesCList.sort((item1, item2) => 
...
void goPage(int pageNoNext) { 
                          ...
                          //} else { 
                            ...
                            Navigator.pushAndRemoveUntil( 
                              context, 
                              MaterialPageRoute(  
                                      builder: (context) =>  AmTasktemplatesAmProjecttemplatesCDataTable(viewType: dispType, pageNo: pageNoNext, searchClause: searchFilter, sortClause: sortBy,), 
                                    ), 
                              (Route<dynamic> route) => route.isFirst 
                              ); 
...
class AmTasktemplatesAmProjecttemplatesCDataSource extends DataTableSource { 
  // Generate some made-up data 
  @required 
  late List<AmTasktemplatesAmProjecttemplatesC> _data; 
 
  AmTasktemplatesAmProjecttemplatesCDataSource(List<AmTasktemplatesAmProjecttemplatesC> amTasktemplatesAmProjecttemplatesCList) { 
    _data = amTasktemplatesAmProjecttemplatesCList; 
  } 
            ...
            return IconButton( 	
                onPressed: () => showDialog<String>( 	
                      ...
                      builder: (BuildContext context) => AlertDialog( 	
                        ...
                        content: _AmTasktemplatesAmProjecttemplatesCInfo(foundAmTasktemplatesAmProjecttemplatesC: _data[index]), 	
                        actions: <Widget>[ 	
                          TextButton( 	
                            onPressed: () => Navigator.pop(context, 'Cancel'), 	
                            child: const Text('Cancel'), 	
                          ...
                          TextButton( 	
                            onPressed: () async { 	
                              ...
                              context,  
                              MaterialPageRoute(   
                                      builder: (context) =>  const AmTasktemplatesAmProjecttemplatesCDataTable(), //default: Disp type PaginatedDataTable   
                                    ),  
                              (Route<dynamic> route) => route.isFirst  
                              ) 
                              : null; 	
...
// --------------- DataTable Delete Call Functions - View Record -------------------	
	...
	class _AmTasktemplatesAmProjecttemplatesCInfo extends StatelessWidget { 	
	  final AmTasktemplatesAmProjecttemplatesC foundAmTasktemplatesAmProjecttemplatesC; 	
	  const _AmTasktemplatesAmProjecttemplatesCInfo({Key? key, required this.foundAmTasktemplatesAmProjecttemplatesC}) 	
	      : super(key: key); 	
	 	
	  @override 	
	  Widget build(BuildContext context) { 	
			return AmTasktemplatesAmProjecttemplatesC_dispForm(context, foundAmTasktemplatesAmProjecttemplatesC); 	
	  } 	
	} 	
