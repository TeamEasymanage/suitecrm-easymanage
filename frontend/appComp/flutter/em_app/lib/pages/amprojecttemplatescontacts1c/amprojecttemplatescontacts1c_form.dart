...
class AmProjecttemplatesContacts1CForm extends StatefulWidget { 
  const AmProjecttemplatesContacts1CForm({Key? key}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesContacts1CFormState createState() => _AmProjecttemplatesContacts1CFormState(); 
} 
 
class _AmProjecttemplatesContacts1CFormState extends State<AmProjecttemplatesContacts1CForm> { 
...
void didChangeDependencies() { 
  ...
  Widget build(BuildContext context) { 
	return Scaffold( 
        ...
        appBar: AppBar( 
          title: const Text("AmProjecttemplatesContacts1C Add Form"), 
          centerTitle: true, 
        ), 
        body: Center( 
          child: Padding( 
            ...
            child: SingleChildScrollView(
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.amProjecttemplatesIda),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.contactsIdb),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
 ...
 */ 
 ...
 // [4] Uncomment For Media Upload Customization. Also Uncomment Media Field Assignment in  newAmProjecttemplatesContacts1C creation below  
 /* 
                          //Get Base64 ready 
 ...
 */ 
 ...
 /* 
                          //Uncomment and Use Model AmProjecttemplatesContacts1CWoKey from model.dart, when key should not be passed, it is @GeneratedValue on API side  
                          AmProjecttemplatesContacts1CWoKey newAmProjecttemplatesContacts1C = AmProjecttemplatesContacts1CWoKey( 
 ...
 */ 
					   ...
					   contactsIdb: contactsIdbVar , 
                          ...
                          await AmProjecttemplatesContacts1CService.AmProjecttemplatesContacts1CCreate( 
                                  newAmProjecttemplatesContacts1C.toJson()) 
                              .then((message) { 
                                    apiMessage = message; 
