...
class AmProjecttemplatesContacts1CEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AmProjecttemplatesContacts1CEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesContacts1CEditState createState() => _AmProjecttemplatesContacts1CEditState(); 
} 
 
class _AmProjecttemplatesContacts1CEditState extends State<AmProjecttemplatesContacts1CEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("AmProjecttemplatesContacts1C Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AmProjecttemplatesContacts1CEditRec( 	
...
class AmProjecttemplatesContacts1CEditRec extends StatefulWidget { 
  final AmProjecttemplatesContacts1C amProjecttemplatesContacts1C; 
  const AmProjecttemplatesContacts1CEditRec({Key? key, required this.amProjecttemplatesContacts1C}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesContacts1CEditRecState createState() => _AmProjecttemplatesContacts1CEditRecState(); 
} 
 
class _AmProjecttemplatesContacts1CEditRecState extends State<AmProjecttemplatesContacts1CEditRec> { 
