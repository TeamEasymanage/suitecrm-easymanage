...
class AmProjecttemplatesContacts1COnlyDd extends StatefulWidget { 
  const AmProjecttemplatesContacts1COnlyDd({Key? key}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesContacts1COnlyDdState createState() => _AmProjecttemplatesContacts1COnlyDdState(); 
} 
 
class _AmProjecttemplatesContacts1COnlyDdState extends State<AmProjecttemplatesContacts1COnlyDd> { 
    ...
    AmProjecttemplatesContacts1CService.AmProjecttemplatesContacts1CViewAll( 	
      ...
      setState(() { 	
       amProjecttemplatesContacts1CList = getList; 	
		idSelected = amProjecttemplatesContacts1CList[0].toListLabVal()[0][1].toString();	
		 //Remove duplicates 	
        //amProjecttemplatesContacts1CList = amProjecttemplatesContacts1CList.toSet().toList();	
        _loading = false;	
      });	
    });	
  } 	
                                  ...
                                  children: [	
                                    ...
                                    DropdownButton<String>(	
                                      ...
                                      style: const TextStyle(	
                                          ...
                                          color: Colors.black),	
                                      items: amProjecttemplatesContacts1CList	
...
class AmProjecttemplatesContacts1CEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AmProjecttemplatesContacts1CEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesContacts1CEditDdState createState() => _AmProjecttemplatesContacts1CEditDdState(); 
} 
 
class _AmProjecttemplatesContacts1CEditDdState extends State<AmProjecttemplatesContacts1CEditDd> { 
  ...
  void initState() {	
    ...
    AmProjecttemplatesContacts1CService.AmProjecttemplatesContacts1CViewAllIds().then((ids) { 	
      if (ids is String) {	
        setState(() {	
          errorMsg = ids;	
        });	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
	     backgroundColor: Colors.blue.shade200,	
        appBar: AppBar( 	
          title: const Text("AmProjecttemplatesContacts1C Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
            ? EmShowProgress(msg: errorMsg)	
                ...
                child: Row(	
                  ...
                  children: [	
                    Padding(	
                      ...
                      _isKeySelected 	
                          ? FutureBuilder<AmProjecttemplatesContacts1C>( 	
                              future: AmProjecttemplatesContacts1CService 	
                                      .AmProjecttemplatesContacts1CQuery(_chosenValue) 	
                                  .then((value) => value), 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AmProjecttemplatesContacts1CEditDdRec( 	
                                          amProjecttemplatesContacts1C: snapshot.data!); 	
                                    } 	
                                } 	
                              }) 	
                          : const SizedBox( 	
...
class AmProjecttemplatesContacts1CEditDdRec extends StatefulWidget { 
  final AmProjecttemplatesContacts1C amProjecttemplatesContacts1C; 
  const AmProjecttemplatesContacts1CEditDdRec({Key? key, required this.amProjecttemplatesContacts1C}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesContacts1CEditDdRecState createState() => _AmProjecttemplatesContacts1CEditDdRecState(); 
} 
 
class _AmProjecttemplatesContacts1CEditDdRecState extends State<AmProjecttemplatesContacts1CEditDdRec> { 
  AmProjecttemplatesContacts1C foundAmProjecttemplatesContacts1C = AmProjecttemplatesContacts1C(id: "" ); 
...
void didChangeDependencies() { 
  ...
  void initState() { 
    super.initState(); 
    setState(() { 
      foundAmProjecttemplatesContacts1C = widget.amProjecttemplatesContacts1C; 
    }); 
  } 
            ...
            child: Form( 
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					   enabled: false,    initialValue: getEmStrOpt(foundAmProjecttemplatesContacts1C.id),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmProjecttemplatesContacts1C.dateModified),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmProjecttemplatesContacts1C.deleted),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmProjecttemplatesContacts1C.amProjecttemplatesIda),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
                  ...
                  const SizedBox(height: 10), 
				  // ---------------------------------------------------------------------------------------  
				  // Column Details:  Srl No : [5] [ Name [Contactsidb] : EM Type [CHAR], Java Type [String]  
				  //                  EM size: maxlength: 36, Display Size : 20 
				  // Flutter Details: Field Label [Contacts Idb], Name [contactsIdb], Type [String]  
				  // ---------------------------------------------------------------------------------------  
				Row( 
				  mainAxisAlignment: MainAxisAlignment.spaceBetween, 
				  children: <Widget>[ 
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmProjecttemplatesContacts1C.contactsIdb),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
					...
					*/  
					//maxLength: 30, 
					onSaved: (value) => setState(() => contactsIdbVar = value.toString()), 
				  ), //textformfield 
				), //flexible 
				]), //Widget[] //Row 
                  const SizedBox(height: 10), 
                    ...
                    builder: (context) => ButtonWidget( 
                      ...
                      onClicked: () async { 
						...
						// ===== BEGIN BLOCK : Calling API Service Calls ('Edit') 1st (optional 2nd...) and Routing to Next Screen 
                          ...
                          AmProjecttemplatesContacts1C newAmProjecttemplatesContacts1C = AmProjecttemplatesContacts1C( 
					   id: idVar , 
					   dateModified: dateModifiedVar , 
					   deleted: deletedVar , 
					   amProjecttemplatesIda: amProjecttemplatesIdaVar , 
					   contactsIdb: contactsIdbVar , 
							  ); 
 
                          await AmProjecttemplatesContacts1CService.AmProjecttemplatesContacts1CEdit( 
                                  newAmProjecttemplatesContacts1C.id, 
                                  newAmProjecttemplatesContacts1C) 
                              .then((message) { 
                                    apiMessage = message; 
