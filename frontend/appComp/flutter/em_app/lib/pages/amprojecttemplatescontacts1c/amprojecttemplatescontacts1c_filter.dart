...
class AmProjecttemplatesContacts1CFilter extends StatefulWidget { 
  const AmProjecttemplatesContacts1CFilter({Key? key}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesContacts1CFilterState createState() => _AmProjecttemplatesContacts1CFilterState(); 
} 
 
class _AmProjecttemplatesContacts1CFilterState extends State<AmProjecttemplatesContacts1CFilter> { 
	...
	List<List<String>> tblColumnList = [ 
		...
		["Am Projecttemplates Ida", 'amProjecttemplatesIda', 'CHAR'],  
		["Contacts Idb", 'contactsIdb', 'CHAR'],  
	]; 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AmProjecttemplatesContacts1CDataTable(viewType: "ListView", 
                                            pageNo: 0, 
