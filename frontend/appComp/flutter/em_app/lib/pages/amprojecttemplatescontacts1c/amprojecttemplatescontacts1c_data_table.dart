...
import 'package:em_app/pages/amprojecttemplatescontacts1c/amprojecttemplatescontacts1c_service.dart'; 
import 'package:em_app/pages/amprojecttemplatescontacts1c/amprojecttemplatescontacts1c_lib.dart'; 
...
class AmProjecttemplatesContacts1CDataTable extends StatefulWidget { 
  final String? viewType; 
  final int? pageNo; 
  final String? searchClause; 
  final String? sortClause; 
  const AmProjecttemplatesContacts1CDataTable({Key? key, this.viewType  
  , this.pageNo 
  , this.searchClause 
  , this.sortClause 
  }) : super(key: key); 
  ...
  @override 
  _AmProjecttemplatesContacts1CDataTableState createState() => _AmProjecttemplatesContacts1CDataTableState(); 
} 
 
class _AmProjecttemplatesContacts1CDataTableState extends State<AmProjecttemplatesContacts1CDataTable> { 
  String dispType = "DataTable"; 
  String emTitle =  "AmProjecttemplatesContacts1C Data Table"; 
  int noOfCardsPerRow = 2; 
  int noOfFieldsForCard = 2; 
 
  String errorMsg = timeErrStr; 
 
  List<AmProjecttemplatesContacts1C> amProjecttemplatesContacts1CList = []; 
  ...
  void initState() { 
    ...
    if (widget.viewType != null ) { 
      ...
      switch (widget.viewType) { 
        case "ListView": { 
        dispType = "ListView"; 
        emTitle = "AmProjecttemplatesContacts1C List View"; 
        } 
        break; 
        case "ListCard": { 
        dispType = "ListCard"; 
        emTitle = "AmProjecttemplatesContacts1C List Card"; 
        } 
        break; 
        default: 
      } 
    ...
    print("Calling Service : AmProjecttemplatesContacts1CSelectWhere ... "); 
    print("searchClause: [" +searchFilter +"]");  
    print("sortClause: [" +sortBy +"]");  
    AmProjecttemplatesContacts1CService.AmProjecttemplatesContacts1CSelectWhere( 
      currPageNo 
      , searchFilter 
      , sortBy 
    ).then((getList) { 
      ...
      setState(() { 
        amProjecttemplatesContacts1CList = getList; 
        _loading = false; 
      }); 
      }  
    }); 
    ...
    print("Calling Service : AmProjecttemplatesContacts1CViewAll ... "); 
    AmProjecttemplatesContacts1CService.AmProjecttemplatesContacts1CViewAll( 
      currPageNo 
    ).then((getList) { 
      if (getList is String) { 
        setState(() { 
 ...
 /* ---------- To Implement - GET value from Hive and FindByColumnName -------------------  
  ...
  bool _loadingProvider = true; 
    ...
    _loading = true; 
    print("Calling Service : AmProjecttemplatesContacts1CFindByColumnName ... "); 
    if (userCode.isNotEmpty) {
    AmProjecttemplatesContacts1CService.AmProjecttemplatesContacts1CFindByColumnName(userCode).then((getList) {
      if (getList is String) {
        setState(() {
          errorMsg = getList;
        });
...
Container getDataTableView() { 
          ...
          return Container(  
                   ...
                   //------------------------------------ Scrollbars 	
                      ...
                      source: AmProjecttemplatesContacts1CDataSource(amProjecttemplatesContacts1CList), 
                      columns: <DataColumn>[ 
                DataColumn( 
                ...
                DataColumn( 
                    label: const Text('Am Projecttemplates Ida'), onSort: doColumnSort), 
                DataColumn( 
                    label: const Text('Contacts Idb'), onSort: doColumnSort), 
                      const DataColumn( 
                        label: Text( 
                          'Edit/Delete', 
...
// --------------- List Card View ------------------- 
  GridView getListCard() { 
    Iterable AmProjecttemplatesContacts1CCardList = 
        amProjecttemplatesContacts1CList.map((e) =>  
     SizedBox( 
    ...
    return GridView.count( 
        ...
        children: List.from(AmProjecttemplatesContacts1CCardList) 
    ); 
  } 
 
  Widget getColumnsForListCard1(AmProjecttemplatesContacts1C e) { 
...
Widget _buildListView() {  
    ...
    if (amProjecttemplatesContacts1CList.length == 0) { 
    return Column( 
      children: [ 
                            ...
                            IconButton( 	 
                              onPressed: () { 	 
                                Navigator.of(context).push(MaterialPageRoute( 	 
                                  builder: (context) =>  
                                  const AmProjecttemplatesContacts1CForm(), 	 
                                  ), 	 
                                ); 	 
                              }, 	 
                              icon: const Icon( 	 
    ...
    var noOfFields = amProjecttemplatesContacts1CList[0].toMapLabelVal().length;  
    //print (noOfFields);  
    ...
    dataColumns.add(  
              DataColumn( 
                label: Text(  
                            amProjecttemplatesContacts1CList[0].toListLabVal()[i][0].toString(),  
    ...
    return DataTable(  
      columns: dataColumns, 
      /* <DataColumn>[  
        DataColumn(label: Text(amProjecttemplatesContacts1CList[0].toListLabVal()[0][0].toString(), style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600))),  
        DataColumn(label: Text(amProjecttemplatesContacts1CList[0].toListLabVal()[1][0].toString(), style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600))),  
      ],  
      */ 
      rows: amProjecttemplatesContacts1CList  
          .map((e) =>  
              getDataRow(e) 
          ).toList(),  
    );  
...
DataRow getDataRow(AmProjecttemplatesContacts1C oh) { 
                      ...
                      children: [ 
                        IconButton( 	 
                            onPressed:  () => showDialog<String>( 	 
                                ...
                                builder: (BuildContext context) => AlertDialog(  
                                  ...
                                  title: Text('AmProjecttemplatesContacts1C Details', 	 
                                      style: TextStyle( 	 
                                          color: Colors.red.shade400, 	 
                                          //fontSize: 22, 	 
                                          //fontWeight: FontWeight.w400 	 
                                          )), 	 
                                  content: _AmProjecttemplatesContacts1CInfo(foundAmProjecttemplatesContacts1C: oh), 	 
                                  actions: <Widget>[ 	 
                                    TextButton( 	 
                        ...
                        IconButton( 	 
                                ...
                                builder: (BuildContext context) => AlertDialog(  
                                  ...
                                  actions: <Widget>[ 	 
                                    ...
                                    TextButton( 	  
                                      ...
                                      Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AmProjecttemplatesContacts1CDataTable(viewType: dispType, pageNo: 0, searchClause: " id = "+valParam+" ",),  
                                            ), 
                                          ); 
                                      }, 
                                      child: const Text('Go'), 
                            ...
                            IconButton( 	 
                              onPressed: () { 	 
                                Navigator.of(context).push(MaterialPageRoute( 	 
                                  builder: (context) => AmProjecttemplatesContacts1CEdit( 	 
                      				idSelected: oh.id, 	
                                  ), 	 
                                )); 	 
                              }, 	 
                        ...
                        actions: <Widget>[ 	 
                          ...
                          TextButton( 	 
                            onPressed: () async { 	 
                              ...
                              String apiMessage = ""; 	 
                              // Begin Service Call 	 
                              await AmProjecttemplatesContacts1CService.AmProjecttemplatesContacts1CDelete( 	 
                                      oh.id) 	 
                                  .then((message) { 	 
                                    apiMessage = message;	 
...
// --------------- DataTable Functions ------------------- 
  void doColumnSort(int columnIndex, bool ascending) { 
	if (columnIndex == 0) { 
	  amProjecttemplatesContacts1CList.sort((item1, item2) => 
	  ...
	  amProjecttemplatesContacts1CList.sort((item1, item2) => 
		  compareColumn(ascending, item1.amProjecttemplatesIda, item2.amProjecttemplatesIda)); 
	} else if (columnIndex == 4) { 
	  amProjecttemplatesContacts1CList.sort((item1, item2) => 
		  compareColumn(ascending, item1.contactsIdb, item2.contactsIdb)); 
    } 
...
void goPage(int pageNoNext) { 
                          ...
                          //} else { 
                            ...
                            Navigator.pushAndRemoveUntil( 
                              context, 
                              MaterialPageRoute(  
                                      builder: (context) =>  AmProjecttemplatesContacts1CDataTable(viewType: dispType, pageNo: pageNoNext, searchClause: searchFilter, sortClause: sortBy,), 
                                    ), 
                              (Route<dynamic> route) => route.isFirst 
                              ); 
...
class AmProjecttemplatesContacts1CDataSource extends DataTableSource { 
  // Generate some made-up data 
  @required 
  late List<AmProjecttemplatesContacts1C> _data; 
 
  AmProjecttemplatesContacts1CDataSource(List<AmProjecttemplatesContacts1C> amProjecttemplatesContacts1CList) { 
    _data = amProjecttemplatesContacts1CList; 
  } 
  ...
  DataRow getRow(int index) { 
	...
	DataCell(Text(getEmStrOpt(_data[index].amProjecttemplatesIda))), 
	DataCell(Text(getEmStrOpt(_data[index].contactsIdb))), 
      DataCell(Row( 	
        mainAxisAlignment: MainAxisAlignment.spaceBetween, 	
        children: [ 	
          Builder(builder: (context) { 	
            ...
            return IconButton( 	
                onPressed: () => showDialog<String>( 	
                      ...
                      builder: (BuildContext context) => AlertDialog( 	
                        ...
                        content: _AmProjecttemplatesContacts1CInfo(foundAmProjecttemplatesContacts1C: _data[index]), 	
                        actions: <Widget>[ 	
                          TextButton( 	
                            onPressed: () => Navigator.pop(context, 'Cancel'), 	
                            child: const Text('Cancel'), 	
                          ...
                          TextButton( 	
                            onPressed: () async { 	
                              ...
                              context,  
                              MaterialPageRoute(   
                                      builder: (context) =>  const AmProjecttemplatesContacts1CDataTable(), //default: Disp type PaginatedDataTable   
                                    ),  
                              (Route<dynamic> route) => route.isFirst  
                              ) 
                              : null; 	
...
// --------------- DataTable Delete Call Functions - View Record -------------------	
	...
	class _AmProjecttemplatesContacts1CInfo extends StatelessWidget { 	
	  final AmProjecttemplatesContacts1C foundAmProjecttemplatesContacts1C; 	
	  const _AmProjecttemplatesContacts1CInfo({Key? key, required this.foundAmProjecttemplatesContacts1C}) 	
	      : super(key: key); 	
	 	
	  @override 	
	  Widget build(BuildContext context) { 	
			return AmProjecttemplatesContacts1C_dispForm(context, foundAmProjecttemplatesContacts1C); 	
	  } 	
	} 	
