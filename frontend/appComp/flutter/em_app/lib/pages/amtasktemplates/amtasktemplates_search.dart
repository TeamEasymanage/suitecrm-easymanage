...
import 'package:em_app/pages/amtasktemplates/amtasktemplates_lib.dart'; 
	...
	class AmTasktemplatesSearch extends StatefulWidget { 	
	  const AmTasktemplatesSearch({Key? key}) : super(key: key); 	
	 	
	  @override 	
	  _AmTasktemplatesSearchState createState() => _AmTasktemplatesSearchState(); 	
	} 	
	 	
	class _AmTasktemplatesSearchState extends State<AmTasktemplatesSearch> { 	
	  ...
	  Widget build(BuildContext context) { 	
		return Scaffold( 	
	        ...
	        appBar: AppBar( 	
	          title: const Text("AmTasktemplates Search Record"), 	
	          centerTitle: true, 	
	        ), 	
	                    ...
	                    children: [ 	
	                      ...
	                      _isKeySelected 	
	                          ? FutureBuilder<AmTasktemplates>( 	
	                              future: AmTasktemplatesService.AmTasktemplatesQuery(_chosenValue) 	
	                                  .then((value) => value), 	
	                                ...
	                                switch (snapshot.connectionState) { 	
	                                  ...
	                                  default: 	
	                                    if (snapshot.hasError) { 	
	                                      ...
	                                      return AmTasktemplatesSearchResult( 	
	                                          foundAmTasktemplates: snapshot.data!); 	
	                                    } 	
	                                } 	
	                              }) 	
	                          : const SizedBox( 	
	...
	class AmTasktemplatesSearchResult extends StatelessWidget { 	
	  final AmTasktemplates foundAmTasktemplates; 	
	  const AmTasktemplatesSearchResult({Key? key, required this.foundAmTasktemplates}) : super(key: key); 	
