...
class AmTasktemplatesFilter extends StatefulWidget { 
  const AmTasktemplatesFilter({Key? key}) : super(key: key); 
 
  @override 
  _AmTasktemplatesFilterState createState() => _AmTasktemplatesFilterState(); 
} 
 
class _AmTasktemplatesFilterState extends State<AmTasktemplatesFilter> { 
	...
	List<List<String>> tblColumnList = [ 
		...
		["Predecessors", 'predecessors', 'NUMBER'],  
		["Milestone Flag", 'milestoneFlag', 'CHAR'],  
		["Relationship Type", 'relationshipType', 'CHAR'],  
		["Task Number", 'taskNumber', 'NUMBER'],  
		["Order Number", 'orderNumber', 'NUMBER'],  
		["Estimated Effort", 'estimatedEffort', 'NUMBER'],  
		["Utilization", 'utilization', 'CHAR'],  
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AmTasktemplatesDataTable(viewType: "ListView", 
                                            pageNo: 0, 
