...
class AmTasktemplatesGraph extends StatefulWidget { 	
  const AmTasktemplatesGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _AmTasktemplatesGraphState createState() => _AmTasktemplatesGraphState(); 	
} 	
	 	
class _AmTasktemplatesGraphState extends State<AmTasktemplatesGraph> { 	
 	
  //List<AmTasktemplates> amTasktemplatesList = []; 	
  List<EmChartModel> amTasktemplatesList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    super.initState(); 	
    //AmTasktemplatesService.AmTasktemplatesViewAll().then((getList) { 	
    setState(() { 	
      //amTasktemplatesList = getList; 	
      //Local static data loading 	
      amTasktemplatesList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'AmTasktemplates Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                amTasktemplatesList: amTasktemplatesList) 	
                            : LineChart(lineChartAmTasktemplates()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartAmTasktemplates() { 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> amTasktemplatesList; 	
  const BarChartSample2({Key? key, required this.amTasktemplatesList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.amTasktemplatesList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	
