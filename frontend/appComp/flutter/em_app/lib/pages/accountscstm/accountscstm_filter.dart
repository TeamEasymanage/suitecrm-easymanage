...
class AccountsCstmFilter extends StatefulWidget { 
  const AccountsCstmFilter({Key? key}) : super(key: key); 
 
  @override 
  _AccountsCstmFilterState createState() => _AccountsCstmFilterState(); 
} 
 
class _AccountsCstmFilterState extends State<AccountsCstmFilter> { 
	...
	List<List<String>> tblColumnList = [ 
		["Id C", 'idC', 'CHAR'],  
		["Jjwg Maps Lng C", 'jjwgMapsLngC', 'FLOAT'],  
		["Jjwg Maps Lat C", 'jjwgMapsLatC', 'FLOAT'],  
		["Jjwg Maps Geocode Status C", 'jjwgMapsGeocodeStatusC', 'CHAR'],  
		["Jjwg Maps Address C", 'jjwgMapsAddressC', 'CHAR'],  
	]; 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AccountsCstmDataTable(viewType: "ListView", 
                                            pageNo: 0, 
