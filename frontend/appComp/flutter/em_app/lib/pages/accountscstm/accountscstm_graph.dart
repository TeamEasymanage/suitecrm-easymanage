...
class AccountsCstmGraph extends StatefulWidget { 	
  const AccountsCstmGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _AccountsCstmGraphState createState() => _AccountsCstmGraphState(); 	
} 	
	 	
class _AccountsCstmGraphState extends State<AccountsCstmGraph> { 	
 	
  //List<AccountsCstm> accountsCstmList = []; 	
  List<EmChartModel> accountsCstmList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    super.initState(); 	
    //AccountsCstmService.AccountsCstmViewAll().then((getList) { 	
    setState(() { 	
      //accountsCstmList = getList; 	
      //Local static data loading 	
      accountsCstmList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'AccountsCstm Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                accountsCstmList: accountsCstmList) 	
                            : LineChart(lineChartAccountsCstm()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartAccountsCstm() { 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> accountsCstmList; 	
  const BarChartSample2({Key? key, required this.accountsCstmList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.accountsCstmList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	
