...
class AccountsCasesFilter extends StatefulWidget { 
  const AccountsCasesFilter({Key? key}) : super(key: key); 
 
  @override 
  _AccountsCasesFilterState createState() => _AccountsCasesFilterState(); 
} 
 
class _AccountsCasesFilterState extends State<AccountsCasesFilter> { 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AccountsCasesDataTable(viewType: "ListView", 
                                            pageNo: 0, 
