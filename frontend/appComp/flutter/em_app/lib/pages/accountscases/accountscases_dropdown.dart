...
class AccountsCasesOnlyDd extends StatefulWidget { 
  const AccountsCasesOnlyDd({Key? key}) : super(key: key); 
 
  @override 
  _AccountsCasesOnlyDdState createState() => _AccountsCasesOnlyDdState(); 
} 
 
class _AccountsCasesOnlyDdState extends State<AccountsCasesOnlyDd> { 
    ...
    AccountsCasesService.AccountsCasesViewAll( 	
      ...
      setState(() { 	
       accountsCasesList = getList; 	
		idSelected = accountsCasesList[0].toListLabVal()[0][1].toString();	
		 //Remove duplicates 	
        //accountsCasesList = accountsCasesList.toSet().toList();	
        _loading = false;	
      });	
    });	
  } 	
...
class AccountsCasesEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AccountsCasesEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AccountsCasesEditDdState createState() => _AccountsCasesEditDdState(); 
} 
 
class _AccountsCasesEditDdState extends State<AccountsCasesEditDd> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
	     backgroundColor: Colors.blue.shade200,	
        appBar: AppBar( 	
          title: const Text("AccountsCases Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
            ? EmShowProgress(msg: errorMsg)	
...
class AccountsCasesEditDdRec extends StatefulWidget { 
  final AccountsCases accountsCases; 
  const AccountsCasesEditDdRec({Key? key, required this.accountsCases}) : super(key: key); 
 
  @override 
  _AccountsCasesEditDdRecState createState() => _AccountsCasesEditDdRecState(); 
} 
 
class _AccountsCasesEditDdRecState extends State<AccountsCasesEditDdRec> { 
