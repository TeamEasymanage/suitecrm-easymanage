...
class AccountsCasesGraph extends StatefulWidget { 	
  const AccountsCasesGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _AccountsCasesGraphState createState() => _AccountsCasesGraphState(); 	
} 	
	 	
class _AccountsCasesGraphState extends State<AccountsCasesGraph> { 	
 	
  //List<AccountsCases> accountsCasesList = []; 	
  List<EmChartModel> accountsCasesList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    super.initState(); 	
    //AccountsCasesService.AccountsCasesViewAll().then((getList) { 	
    setState(() { 	
      //accountsCasesList = getList; 	
      //Local static data loading 	
      accountsCasesList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'AccountsCases Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                accountsCasesList: accountsCasesList) 	
                            : LineChart(lineChartAccountsCases()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartAccountsCases() { 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> accountsCasesList; 	
  const BarChartSample2({Key? key, required this.accountsCasesList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.accountsCasesList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	
