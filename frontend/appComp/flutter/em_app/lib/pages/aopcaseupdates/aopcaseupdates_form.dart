...
class AopCaseUpdatesForm extends StatefulWidget { 
  const AopCaseUpdatesForm({Key? key}) : super(key: key); 
 
  @override 
  _AopCaseUpdatesFormState createState() => _AopCaseUpdatesFormState(); 
} 
 
class _AopCaseUpdatesFormState extends State<AopCaseUpdatesForm> { 
...
void didChangeDependencies() { 
  ...
  Widget build(BuildContext context) { 
	return Scaffold( 
        ...
        appBar: AppBar( 
          title: const Text("AopCaseUpdates Add Form"), 
          centerTitle: true, 
        ), 
        body: Center( 
          child: Padding( 
            ...
            child: SingleChildScrollView(
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.contactId),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.internal),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
 ...
 */ 
 ...
 // [4] Uncomment For Media Upload Customization. Also Uncomment Media Field Assignment in  newAopCaseUpdates creation below  
 /* 
                          //Get Base64 ready 
 ...
 */ 
 ...
 /* 
                          //Uncomment and Use Model AopCaseUpdatesWoKey from model.dart, when key should not be passed, it is @GeneratedValue on API side  
                          AopCaseUpdatesWoKey newAopCaseUpdates = AopCaseUpdatesWoKey( 
 ...
 */ 
					   ...
					   internal: internalVar , 
                          ...
                          await AopCaseUpdatesService.AopCaseUpdatesCreate( 
                                  newAopCaseUpdates.toJson()) 
                              .then((message) { 
                                    apiMessage = message; 
