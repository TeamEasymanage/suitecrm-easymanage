...
class AopCaseUpdatesFilter extends StatefulWidget { 
  const AopCaseUpdatesFilter({Key? key}) : super(key: key); 
 
  @override 
  _AopCaseUpdatesFilterState createState() => _AopCaseUpdatesFilterState(); 
} 
 
class _AopCaseUpdatesFilterState extends State<AopCaseUpdatesFilter> { 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AopCaseUpdatesDataTable(viewType: "ListView", 
                                            pageNo: 0, 
