...
class AopCaseUpdatesOnlyDd extends StatefulWidget { 
  const AopCaseUpdatesOnlyDd({Key? key}) : super(key: key); 
 
  @override 
  _AopCaseUpdatesOnlyDdState createState() => _AopCaseUpdatesOnlyDdState(); 
} 
 
class _AopCaseUpdatesOnlyDdState extends State<AopCaseUpdatesOnlyDd> { 
    ...
    AopCaseUpdatesService.AopCaseUpdatesViewAll( 	
      ...
      setState(() { 	
       aopCaseUpdatesList = getList; 	
		idSelected = aopCaseUpdatesList[0].toListLabVal()[0][1].toString();	
		 //Remove duplicates 	
        //aopCaseUpdatesList = aopCaseUpdatesList.toSet().toList();	
        _loading = false;	
      });	
    });	
  } 	
...
class AopCaseUpdatesEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AopCaseUpdatesEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AopCaseUpdatesEditDdState createState() => _AopCaseUpdatesEditDdState(); 
} 
 
class _AopCaseUpdatesEditDdState extends State<AopCaseUpdatesEditDd> { 
  ...
  void initState() {	
    ...
    AopCaseUpdatesService.AopCaseUpdatesViewAllIds().then((ids) { 	
      if (ids is String) {	
        setState(() {	
          errorMsg = ids;	
        });	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
	     backgroundColor: Colors.blue.shade200,	
        appBar: AppBar( 	
          title: const Text("AopCaseUpdates Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
            ? EmShowProgress(msg: errorMsg)	
                ...
                child: Row(	
                  ...
                  children: [	
                    Padding(	
                      ...
                      _isKeySelected 	
                          ? FutureBuilder<AopCaseUpdates>( 	
                              future: AopCaseUpdatesService 	
                                      .AopCaseUpdatesQuery(_chosenValue) 	
                                  .then((value) => value), 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AopCaseUpdatesEditDdRec( 	
                                          aopCaseUpdates: snapshot.data!); 	
                                    } 	
                                } 	
                              }) 	
                          : const SizedBox( 	
...
class AopCaseUpdatesEditDdRec extends StatefulWidget { 
  final AopCaseUpdates aopCaseUpdates; 
  const AopCaseUpdatesEditDdRec({Key? key, required this.aopCaseUpdates}) : super(key: key); 
 
  @override 
  _AopCaseUpdatesEditDdRecState createState() => _AopCaseUpdatesEditDdRecState(); 
} 
 
class _AopCaseUpdatesEditDdRecState extends State<AopCaseUpdatesEditDdRec> { 
  AopCaseUpdates foundAopCaseUpdates = AopCaseUpdates(id: "" ); 
...
void didChangeDependencies() { 
  ...
  void initState() { 
    super.initState(); 
    setState(() { 
      foundAopCaseUpdates = widget.aopCaseUpdates; 
    }); 
  } 
            ...
            child: Form( 
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					   enabled: false,    initialValue: getEmStrOpt(foundAopCaseUpdates.id),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAopCaseUpdates.name),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAopCaseUpdates.dateEntered),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAopCaseUpdates.dateModified),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAopCaseUpdates.modifiedUserId),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAopCaseUpdates.createdBy),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
				  ...
				  TextFormField( 
					...
					//em size: Lines : Size: 3, Columns : Display Size: 50 
					      initialValue: getEmStrOpt(foundAopCaseUpdates.description),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAopCaseUpdates.deleted),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAopCaseUpdates.assignedUserId),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAopCaseUpdates.caseId),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
                  ...
                  const SizedBox(height: 10), 
				  // ---------------------------------------------------------------------------------------  
				  // Column Details:  Srl No : [11] [ Name [Contactid] : EM Type [CHAR], Java Type [String]  
				  //                  EM size: maxlength: 36, Display Size : 20 
				  // Flutter Details: Field Label [Contact Id], Name [contactId], Type [String]  
				  // ---------------------------------------------------------------------------------------  
				Row( 
				  mainAxisAlignment: MainAxisAlignment.spaceBetween, 
				  children: <Widget>[ 
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAopCaseUpdates.contactId),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
					...
					*/  
					//maxLength: 30, 
					onSaved: (value) => setState(() => contactIdVar = value.toString()), 
				  ), //textformfield 
				), //flexible 
				]), //Widget[] //Row 
                  const SizedBox(height: 10), 
				  // ---------------------------------------------------------------------------------------  
				  // Column Details:  Srl No : [12] [ Name [Internal] : EM Type [CHAR], Java Type [String]  
				  //                  EM size: maxlength: 0, Display Size : 20 
				  // Flutter Details: Field Label [Internal], Name [internal], Type [String]  
				  // ---------------------------------------------------------------------------------------  
				Row( 
				  mainAxisAlignment: MainAxisAlignment.spaceBetween, 
				  children: <Widget>[ 
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAopCaseUpdates.internal),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
					...
					*/  
					//maxLength: 30, 
					onSaved: (value) => setState(() => internalVar = value.toString()), 
				  ), //textformfield 
				), //flexible 
				]), //Widget[] //Row 
                  const SizedBox(height: 10), 
                    ...
                    builder: (context) => ButtonWidget( 
                      ...
                      onClicked: () async { 
						...
						// ===== BEGIN BLOCK : Calling API Service Calls ('Edit') 1st (optional 2nd...) and Routing to Next Screen 
                          ...
                          AopCaseUpdates newAopCaseUpdates = AopCaseUpdates( 
					   id: idVar , 
					   name: nameVar , 
					   ...
					   internal: internalVar , 
                          ...
                          await AopCaseUpdatesService.AopCaseUpdatesEdit( 
                                  newAopCaseUpdates.id, 
                                  newAopCaseUpdates) 
                              .then((message) { 
                                    apiMessage = message; 
