...
class AopCaseUpdatesEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AopCaseUpdatesEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AopCaseUpdatesEditState createState() => _AopCaseUpdatesEditState(); 
} 
 
class _AopCaseUpdatesEditState extends State<AopCaseUpdatesEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("AopCaseUpdates Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
...
class AopCaseUpdatesEditRec extends StatefulWidget { 
  final AopCaseUpdates aopCaseUpdates; 
  const AopCaseUpdatesEditRec({Key? key, required this.aopCaseUpdates}) : super(key: key); 
 
  @override 
  _AopCaseUpdatesEditRecState createState() => _AopCaseUpdatesEditRecState(); 
} 
 
class _AopCaseUpdatesEditRecState extends State<AopCaseUpdatesEditRec> { 
