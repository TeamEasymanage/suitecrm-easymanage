...
class AccountsContactsEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AccountsContactsEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AccountsContactsEditState createState() => _AccountsContactsEditState(); 
} 
 
class _AccountsContactsEditState extends State<AccountsContactsEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("AccountsContacts Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AccountsContactsEditRec( 	
...
class AccountsContactsEditRec extends StatefulWidget { 
  final AccountsContacts accountsContacts; 
  const AccountsContactsEditRec({Key? key, required this.accountsContacts}) : super(key: key); 
 
  @override 
  _AccountsContactsEditRecState createState() => _AccountsContactsEditRecState(); 
} 
 
class _AccountsContactsEditRecState extends State<AccountsContactsEditRec> { 
