...
class AccountsContactsOnlyDd extends StatefulWidget { 
  const AccountsContactsOnlyDd({Key? key}) : super(key: key); 
 
  @override 
  _AccountsContactsOnlyDdState createState() => _AccountsContactsOnlyDdState(); 
} 
 
class _AccountsContactsOnlyDdState extends State<AccountsContactsOnlyDd> { 
    ...
    AccountsContactsService.AccountsContactsViewAll( 	
      ...
      setState(() { 	
       accountsContactsList = getList; 	
		idSelected = accountsContactsList[0].toListLabVal()[0][1].toString();	
		 //Remove duplicates 	
        //accountsContactsList = accountsContactsList.toSet().toList();	
        _loading = false;	
      });	
    });	
  } 	
...
class AccountsContactsEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AccountsContactsEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AccountsContactsEditDdState createState() => _AccountsContactsEditDdState(); 
} 
 
class _AccountsContactsEditDdState extends State<AccountsContactsEditDd> { 
  ...
  void initState() {	
    ...
    AccountsContactsService.AccountsContactsViewAllIds().then((ids) { 	
      if (ids is String) {	
        setState(() {	
          errorMsg = ids;	
        });	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
	     backgroundColor: Colors.blue.shade200,	
        appBar: AppBar( 	
          title: const Text("AccountsContacts Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
            ? EmShowProgress(msg: errorMsg)	
                ...
                child: Row(	
                  ...
                  children: [	
                    Padding(	
                      ...
                      _isKeySelected 	
                          ? FutureBuilder<AccountsContacts>( 	
                              future: AccountsContactsService 	
                                      .AccountsContactsQuery(_chosenValue) 	
                                  .then((value) => value), 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AccountsContactsEditDdRec( 	
                                          accountsContacts: snapshot.data!); 	
                                    } 	
                                } 	
                              }) 	
                          : const SizedBox( 	
...
class AccountsContactsEditDdRec extends StatefulWidget { 
  final AccountsContacts accountsContacts; 
  const AccountsContactsEditDdRec({Key? key, required this.accountsContacts}) : super(key: key); 
 
  @override 
  _AccountsContactsEditDdRecState createState() => _AccountsContactsEditDdRecState(); 
} 
 
class _AccountsContactsEditDdRecState extends State<AccountsContactsEditDdRec> { 
  AccountsContacts foundAccountsContacts = AccountsContacts(id: "" ); 
...
void didChangeDependencies() { 
  ...
  void initState() { 
    super.initState(); 
    setState(() { 
      foundAccountsContacts = widget.accountsContacts; 
    }); 
  } 
            ...
            child: Form( 
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					   enabled: false,    initialValue: getEmStrOpt(foundAccountsContacts.id),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				  ...
				  // ---------------------------------------------------------------------------------------  
				  // Column Details:  Srl No : [2] [ Name [Contactid] : EM Type [CHAR], Java Type [String]  
				  //                  EM size: maxlength: 36, Display Size : 20 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAccountsContacts.contactId),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAccountsContacts.accountId),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAccountsContacts.dateModified),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAccountsContacts.deleted),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
                    ...
                    builder: (context) => ButtonWidget( 
                      ...
                      onClicked: () async { 
						...
						// ===== BEGIN BLOCK : Calling API Service Calls ('Edit') 1st (optional 2nd...) and Routing to Next Screen 
                          ...
                          AccountsContacts newAccountsContacts = AccountsContacts( 
					   id: idVar , 
					   ...
					   deleted: deletedVar , 
                          ...
                          await AccountsContactsService.AccountsContactsEdit( 
                                  newAccountsContacts.id, 
                                  newAccountsContacts) 
                              .then((message) { 
                                    apiMessage = message; 
