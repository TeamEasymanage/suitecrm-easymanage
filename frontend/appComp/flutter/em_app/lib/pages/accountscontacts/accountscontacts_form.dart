...
class AccountsContactsForm extends StatefulWidget { 
  const AccountsContactsForm({Key? key}) : super(key: key); 
 
  @override 
  _AccountsContactsFormState createState() => _AccountsContactsFormState(); 
} 
 
class _AccountsContactsFormState extends State<AccountsContactsForm> { 
...
void didChangeDependencies() { 
  ...
  Widget build(BuildContext context) { 
	return Scaffold( 
        ...
        appBar: AppBar( 
          title: const Text("AccountsContacts Add Form"), 
          centerTitle: true, 
        ), 
        body: Center( 
          child: Padding( 
 ...
 */ 
 ...
 // [4] Uncomment For Media Upload Customization. Also Uncomment Media Field Assignment in  newAccountsContacts creation below  
 /* 
                          //Get Base64 ready 
 ...
 */ 
 ...
 /* 
                          //Uncomment and Use Model AccountsContactsWoKey from model.dart, when key should not be passed, it is @GeneratedValue on API side  
                          AccountsContactsWoKey newAccountsContacts = AccountsContactsWoKey( 
 ...
 */ 
					   ...
					   deleted: deletedVar , 
                          ...
                          await AccountsContactsService.AccountsContactsCreate( 
                                  newAccountsContacts.toJson()) 
                              .then((message) { 
                                    apiMessage = message; 
