...
class AccountsContactsFilter extends StatefulWidget { 
  const AccountsContactsFilter({Key? key}) : super(key: key); 
 
  @override 
  _AccountsContactsFilterState createState() => _AccountsContactsFilterState(); 
} 
 
class _AccountsContactsFilterState extends State<AccountsContactsFilter> { 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AccountsContactsDataTable(viewType: "ListView", 
                                            pageNo: 0, 
