...
class AokKnowledgebaseAuditEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AokKnowledgebaseAuditEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AokKnowledgebaseAuditEditState createState() => _AokKnowledgebaseAuditEditState(); 
} 
 
class _AokKnowledgebaseAuditEditState extends State<AokKnowledgebaseAuditEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("AokKnowledgebaseAudit Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AokKnowledgebaseAuditEditRec( 	
...
class AokKnowledgebaseAuditEditRec extends StatefulWidget { 
  final AokKnowledgebaseAudit aokKnowledgebaseAudit; 
  const AokKnowledgebaseAuditEditRec({Key? key, required this.aokKnowledgebaseAudit}) : super(key: key); 
 
  @override 
  _AokKnowledgebaseAuditEditRecState createState() => _AokKnowledgebaseAuditEditRecState(); 
} 
 
class _AokKnowledgebaseAuditEditRecState extends State<AokKnowledgebaseAuditEditRec> { 
