...
class AokKnowledgebaseAuditFilter extends StatefulWidget { 
  const AokKnowledgebaseAuditFilter({Key? key}) : super(key: key); 
 
  @override 
  _AokKnowledgebaseAuditFilterState createState() => _AokKnowledgebaseAuditFilterState(); 
} 
 
class _AokKnowledgebaseAuditFilterState extends State<AokKnowledgebaseAuditFilter> { 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AokKnowledgebaseAuditDataTable(viewType: "ListView", 
                                            pageNo: 0, 
