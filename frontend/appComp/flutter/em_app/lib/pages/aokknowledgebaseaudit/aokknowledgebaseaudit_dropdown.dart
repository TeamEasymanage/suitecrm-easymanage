...
class AokKnowledgebaseAuditOnlyDd extends StatefulWidget { 
  const AokKnowledgebaseAuditOnlyDd({Key? key}) : super(key: key); 
 
  @override 
  _AokKnowledgebaseAuditOnlyDdState createState() => _AokKnowledgebaseAuditOnlyDdState(); 
} 
 
class _AokKnowledgebaseAuditOnlyDdState extends State<AokKnowledgebaseAuditOnlyDd> { 
    ...
    AokKnowledgebaseAuditService.AokKnowledgebaseAuditViewAll( 	
      ...
      setState(() { 	
       aokKnowledgebaseAuditList = getList; 	
		idSelected = aokKnowledgebaseAuditList[0].toListLabVal()[0][1].toString();	
		 //Remove duplicates 	
        //aokKnowledgebaseAuditList = aokKnowledgebaseAuditList.toSet().toList();	
        _loading = false;	
      });	
    });	
  } 	
                                  ...
                                  children: [	
                                    ...
                                    DropdownButton<String>(	
                                      ...
                                      style: const TextStyle(	
                                          ...
                                          color: Colors.black),	
                                      items: aokKnowledgebaseAuditList	
...
class AokKnowledgebaseAuditEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AokKnowledgebaseAuditEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AokKnowledgebaseAuditEditDdState createState() => _AokKnowledgebaseAuditEditDdState(); 
} 
 
class _AokKnowledgebaseAuditEditDdState extends State<AokKnowledgebaseAuditEditDd> { 
  ...
  void initState() {	
    ...
    AokKnowledgebaseAuditService.AokKnowledgebaseAuditViewAllIds().then((ids) { 	
      if (ids is String) {	
        setState(() {	
          errorMsg = ids;	
        });	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
	     backgroundColor: Colors.blue.shade200,	
        appBar: AppBar( 	
          title: const Text("AokKnowledgebaseAudit Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
            ? EmShowProgress(msg: errorMsg)	
                ...
                child: Row(	
                  ...
                  children: [	
                    Padding(	
                      ...
                      _isKeySelected 	
                          ? FutureBuilder<AokKnowledgebaseAudit>( 	
                              future: AokKnowledgebaseAuditService 	
                                      .AokKnowledgebaseAuditQuery(_chosenValue) 	
                                  .then((value) => value), 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AokKnowledgebaseAuditEditDdRec( 	
                                          aokKnowledgebaseAudit: snapshot.data!); 	
                                    } 	
                                } 	
                              }) 	
                          : const SizedBox( 	
...
class AokKnowledgebaseAuditEditDdRec extends StatefulWidget { 
  final AokKnowledgebaseAudit aokKnowledgebaseAudit; 
  const AokKnowledgebaseAuditEditDdRec({Key? key, required this.aokKnowledgebaseAudit}) : super(key: key); 
 
  @override 
  _AokKnowledgebaseAuditEditDdRecState createState() => _AokKnowledgebaseAuditEditDdRecState(); 
} 
 
class _AokKnowledgebaseAuditEditDdRecState extends State<AokKnowledgebaseAuditEditDdRec> { 
  AokKnowledgebaseAudit foundAokKnowledgebaseAudit = AokKnowledgebaseAudit(id: "" ); 
...
void didChangeDependencies() { 
  ...
  void initState() { 
    super.initState(); 
    setState(() { 
      foundAokKnowledgebaseAudit = widget.aokKnowledgebaseAudit; 
    }); 
  } 
            ...
            child: Form( 
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					   enabled: false,    initialValue: getEmStrOpt(foundAokKnowledgebaseAudit.id),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAokKnowledgebaseAudit.parentId),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAokKnowledgebaseAudit.dateCreated),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAokKnowledgebaseAudit.createdBy),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAokKnowledgebaseAudit.fieldName),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAokKnowledgebaseAudit.dataType),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAokKnowledgebaseAudit.beforeValueString),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAokKnowledgebaseAudit.afterValueString),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
				  ...
				  TextFormField( 
					...
					//em size: Lines : Size: 3, Columns : Display Size: 50 
					      initialValue: getEmStrOpt(foundAokKnowledgebaseAudit.beforeValueText),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
				  ...
				  TextFormField( 
						keyboardType: TextInputType.multiline,  
							maxLines: 3, 
					//em size: Lines : Size: 3, Columns : Display Size: 50 
					      initialValue: getEmStrOpt(foundAokKnowledgebaseAudit.afterValueText),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
                    ...
                    builder: (context) => ButtonWidget( 
                      ...
                      onClicked: () async { 
						...
						// ===== BEGIN BLOCK : Calling API Service Calls ('Edit') 1st (optional 2nd...) and Routing to Next Screen 
                          ...
                          AokKnowledgebaseAudit newAokKnowledgebaseAudit = AokKnowledgebaseAudit( 
					   id: idVar , 
					   ...
					   afterValueText: afterValueTextVar , 
                          ...
                          await AokKnowledgebaseAuditService.AokKnowledgebaseAuditEdit( 
                                  newAokKnowledgebaseAudit.id, 
                                  newAokKnowledgebaseAudit) 
                              .then((message) { 
                                    apiMessage = message; 
