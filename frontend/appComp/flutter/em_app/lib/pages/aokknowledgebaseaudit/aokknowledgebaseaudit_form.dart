...
class AokKnowledgebaseAuditForm extends StatefulWidget { 
  const AokKnowledgebaseAuditForm({Key? key}) : super(key: key); 
 
  @override 
  _AokKnowledgebaseAuditFormState createState() => _AokKnowledgebaseAuditFormState(); 
} 
 
class _AokKnowledgebaseAuditFormState extends State<AokKnowledgebaseAuditForm> { 
...
void didChangeDependencies() { 
  ...
  Widget build(BuildContext context) { 
	return Scaffold( 
        ...
        appBar: AppBar( 
          title: const Text("AokKnowledgebaseAudit Add Form"), 
          centerTitle: true, 
        ), 
        body: Center( 
          child: Padding( 
 ...
 */ 
 ...
 // [4] Uncomment For Media Upload Customization. Also Uncomment Media Field Assignment in  newAokKnowledgebaseAudit creation below  
 /* 
                          //Get Base64 ready 
 ...
 */ 
 ...
 /* 
                          //Uncomment and Use Model AokKnowledgebaseAuditWoKey from model.dart, when key should not be passed, it is @GeneratedValue on API side  
                          AokKnowledgebaseAuditWoKey newAokKnowledgebaseAudit = AokKnowledgebaseAuditWoKey( 
 ...
 */ 
					   ...
					   afterValueText: afterValueTextVar , 
                          ...
                          await AokKnowledgebaseAuditService.AokKnowledgebaseAuditCreate( 
                                  newAokKnowledgebaseAudit.toJson()) 
                              .then((message) { 
                                    apiMessage = message; 
