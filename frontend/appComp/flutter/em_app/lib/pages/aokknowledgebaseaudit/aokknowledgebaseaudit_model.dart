...
List<AokKnowledgebaseAudit> aokKnowledgebaseAuditFromJson(String str) => 
    List<AokKnowledgebaseAudit>.from(json.decode(str).map((x) => AokKnowledgebaseAudit.fromJson(x))); 
 
String aokKnowledgebaseAuditToJson(List<AokKnowledgebaseAudit> data) => 
...
class AokKnowledgebaseAudit { 
  ...
  factory AokKnowledgebaseAudit.fromJson(Map<String, dynamic> json) => AokKnowledgebaseAudit( 
		id: json["id"], 
...
/* 
class AokKnowledgebaseAuditWoKey { 
  AokKnowledgebaseAuditWoKey({ 
	//		required this.id, 
		this.parentId, 
		this.dateCreated, 
		this.createdBy, 
