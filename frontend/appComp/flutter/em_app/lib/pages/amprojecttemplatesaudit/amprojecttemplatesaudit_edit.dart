...
class AmProjecttemplatesAuditEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AmProjecttemplatesAuditEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesAuditEditState createState() => _AmProjecttemplatesAuditEditState(); 
} 
 
class _AmProjecttemplatesAuditEditState extends State<AmProjecttemplatesAuditEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("AmProjecttemplatesAudit Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AmProjecttemplatesAuditEditRec( 	
...
class AmProjecttemplatesAuditEditRec extends StatefulWidget { 
  final AmProjecttemplatesAudit amProjecttemplatesAudit; 
  const AmProjecttemplatesAuditEditRec({Key? key, required this.amProjecttemplatesAudit}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesAuditEditRecState createState() => _AmProjecttemplatesAuditEditRecState(); 
} 
 
class _AmProjecttemplatesAuditEditRecState extends State<AmProjecttemplatesAuditEditRec> { 
