...
import 'package:em_app/pages/amprojecttemplatesaudit/amprojecttemplatesaudit_service.dart'; 
import 'package:em_app/pages/amprojecttemplatesaudit/amprojecttemplatesaudit_lib.dart'; 
...
class AmProjecttemplatesAuditDataTable extends StatefulWidget { 
  final String? viewType; 
  final int? pageNo; 
  final String? searchClause; 
  final String? sortClause; 
  const AmProjecttemplatesAuditDataTable({Key? key, this.viewType  
  , this.pageNo 
  , this.searchClause 
  , this.sortClause 
  }) : super(key: key); 
  ...
  @override 
  _AmProjecttemplatesAuditDataTableState createState() => _AmProjecttemplatesAuditDataTableState(); 
} 
 
class _AmProjecttemplatesAuditDataTableState extends State<AmProjecttemplatesAuditDataTable> { 
  String dispType = "DataTable"; 
  String emTitle =  "AmProjecttemplatesAudit Data Table"; 
  int noOfCardsPerRow = 2; 
  int noOfFieldsForCard = 2; 
 
  String errorMsg = timeErrStr; 
 
  List<AmProjecttemplatesAudit> amProjecttemplatesAuditList = []; 
  ...
  void initState() { 
    ...
    if (widget.viewType != null ) { 
      ...
      switch (widget.viewType) { 
        case "ListView": { 
        dispType = "ListView"; 
        emTitle = "AmProjecttemplatesAudit List View"; 
        } 
        break; 
        case "ListCard": { 
        dispType = "ListCard"; 
        emTitle = "AmProjecttemplatesAudit List Card"; 
        } 
        break; 
        default: 
      } 
    ...
    print("Calling Service : AmProjecttemplatesAuditSelectWhere ... "); 
    print("searchClause: [" +searchFilter +"]");  
    print("sortClause: [" +sortBy +"]");  
    AmProjecttemplatesAuditService.AmProjecttemplatesAuditSelectWhere( 
      currPageNo 
      , searchFilter 
      , sortBy 
    ).then((getList) { 
      ...
      setState(() { 
        amProjecttemplatesAuditList = getList; 
        _loading = false; 
      }); 
      }  
    }); 
    ...
    print("Calling Service : AmProjecttemplatesAuditViewAll ... "); 
    AmProjecttemplatesAuditService.AmProjecttemplatesAuditViewAll( 
      currPageNo 
    ).then((getList) { 
      if (getList is String) { 
        setState(() { 
 ...
 /* ---------- To Implement - GET value from Hive and FindByColumnName -------------------  
  ...
  bool _loadingProvider = true; 
    ...
    _loading = true; 
    print("Calling Service : AmProjecttemplatesAuditFindByColumnName ... "); 
    if (userCode.isNotEmpty) {
    AmProjecttemplatesAuditService.AmProjecttemplatesAuditFindByColumnName(userCode).then((getList) {
      if (getList is String) {
        setState(() {
          errorMsg = getList;
        });
...
Container getDataTableView() { 
          ...
          return Container(  
                   ...
                   //------------------------------------ Scrollbars 	
                      ...
                      source: AmProjecttemplatesAuditDataSource(amProjecttemplatesAuditList), 
                      columns: <DataColumn>[ 
                DataColumn( 
...
// --------------- List Card View ------------------- 
  GridView getListCard() { 
    Iterable AmProjecttemplatesAuditCardList = 
        amProjecttemplatesAuditList.map((e) =>  
     SizedBox( 
    ...
    return GridView.count( 
        ...
        children: List.from(AmProjecttemplatesAuditCardList) 
    ); 
  } 
 
  Widget getColumnsForListCard1(AmProjecttemplatesAudit e) { 
...
Widget _buildListView() {  
    ...
    if (amProjecttemplatesAuditList.length == 0) { 
    return Column( 
      children: [ 
                            ...
                            IconButton( 	 
                              onPressed: () { 	 
                                Navigator.of(context).push(MaterialPageRoute( 	 
                                  builder: (context) =>  
                                  const AmProjecttemplatesAuditForm(), 	 
                                  ), 	 
                                ); 	 
                              }, 	 
                              icon: const Icon( 	 
    ...
    var noOfFields = amProjecttemplatesAuditList[0].toMapLabelVal().length;  
    //print (noOfFields);  
    ...
    dataColumns.add(  
              DataColumn( 
                label: Text(  
                            amProjecttemplatesAuditList[0].toListLabVal()[i][0].toString(),  
    ...
    return DataTable(  
      columns: dataColumns, 
      /* <DataColumn>[  
        DataColumn(label: Text(amProjecttemplatesAuditList[0].toListLabVal()[0][0].toString(), style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600))),  
        DataColumn(label: Text(amProjecttemplatesAuditList[0].toListLabVal()[1][0].toString(), style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600))),  
      ],  
      */ 
      rows: amProjecttemplatesAuditList  
          .map((e) =>  
              getDataRow(e) 
          ).toList(),  
    );  
...
DataRow getDataRow(AmProjecttemplatesAudit oh) { 
                      ...
                      children: [ 
                        IconButton( 	 
                            onPressed:  () => showDialog<String>( 	 
                                ...
                                builder: (BuildContext context) => AlertDialog(  
                                  ...
                                  title: Text('AmProjecttemplatesAudit Details', 	 
                                      style: TextStyle( 	 
                                          color: Colors.red.shade400, 	 
                                          //fontSize: 22, 	 
                                          //fontWeight: FontWeight.w400 	 
                                          )), 	 
                                  content: _AmProjecttemplatesAuditInfo(foundAmProjecttemplatesAudit: oh), 	 
                                  actions: <Widget>[ 	 
                                    TextButton( 	 
                        ...
                        IconButton( 	 
                                ...
                                builder: (BuildContext context) => AlertDialog(  
                                  ...
                                  actions: <Widget>[ 	 
                                    ...
                                    TextButton( 	  
                                      ...
                                      Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AmProjecttemplatesAuditDataTable(viewType: dispType, pageNo: 0, searchClause: " id = "+valParam+" ",),  
                                            ), 
                                          ); 
                                      }, 
                                      child: const Text('Go'), 
                            ...
                            IconButton( 	 
                              onPressed: () { 	 
                                Navigator.of(context).push(MaterialPageRoute( 	 
                                  builder: (context) => AmProjecttemplatesAuditEdit( 	 
                      				idSelected: oh.id, 	
                                  ), 	 
                                )); 	 
                              }, 	 
                        ...
                        actions: <Widget>[ 	 
                          ...
                          TextButton( 	 
                            onPressed: () async { 	 
                              ...
                              String apiMessage = ""; 	 
                              // Begin Service Call 	 
                              await AmProjecttemplatesAuditService.AmProjecttemplatesAuditDelete( 	 
                                      oh.id) 	 
                                  .then((message) { 	 
                                    apiMessage = message;	 
...
// --------------- DataTable Functions ------------------- 
  void doColumnSort(int columnIndex, bool ascending) { 
	if (columnIndex == 0) { 
	  amProjecttemplatesAuditList.sort((item1, item2) => 
...
void goPage(int pageNoNext) { 
                          ...
                          //} else { 
                            ...
                            Navigator.pushAndRemoveUntil( 
                              context, 
                              MaterialPageRoute(  
                                      builder: (context) =>  AmProjecttemplatesAuditDataTable(viewType: dispType, pageNo: pageNoNext, searchClause: searchFilter, sortClause: sortBy,), 
                                    ), 
                              (Route<dynamic> route) => route.isFirst 
                              ); 
...
class AmProjecttemplatesAuditDataSource extends DataTableSource { 
  // Generate some made-up data 
  @required 
  late List<AmProjecttemplatesAudit> _data; 
 
  AmProjecttemplatesAuditDataSource(List<AmProjecttemplatesAudit> amProjecttemplatesAuditList) { 
    _data = amProjecttemplatesAuditList; 
  } 
            ...
            return IconButton( 	
                onPressed: () => showDialog<String>( 	
                      ...
                      builder: (BuildContext context) => AlertDialog( 	
                        ...
                        content: _AmProjecttemplatesAuditInfo(foundAmProjecttemplatesAudit: _data[index]), 	
                        actions: <Widget>[ 	
                          TextButton( 	
                            onPressed: () => Navigator.pop(context, 'Cancel'), 	
                            child: const Text('Cancel'), 	
                          ...
                          TextButton( 	
                            onPressed: () async { 	
                              ...
                              context,  
                              MaterialPageRoute(   
                                      builder: (context) =>  const AmProjecttemplatesAuditDataTable(), //default: Disp type PaginatedDataTable   
                                    ),  
                              (Route<dynamic> route) => route.isFirst  
                              ) 
                              : null; 	
...
// --------------- DataTable Delete Call Functions - View Record -------------------	
	...
	class _AmProjecttemplatesAuditInfo extends StatelessWidget { 	
	  final AmProjecttemplatesAudit foundAmProjecttemplatesAudit; 	
	  const _AmProjecttemplatesAuditInfo({Key? key, required this.foundAmProjecttemplatesAudit}) 	
	      : super(key: key); 	
	 	
	  @override 	
	  Widget build(BuildContext context) { 	
			return AmProjecttemplatesAudit_dispForm(context, foundAmProjecttemplatesAudit); 	
	  } 	
	} 	
