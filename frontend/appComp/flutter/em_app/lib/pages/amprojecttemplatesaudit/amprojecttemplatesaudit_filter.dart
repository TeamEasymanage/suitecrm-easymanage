...
class AmProjecttemplatesAuditFilter extends StatefulWidget { 
  const AmProjecttemplatesAuditFilter({Key? key}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesAuditFilterState createState() => _AmProjecttemplatesAuditFilterState(); 
} 
 
class _AmProjecttemplatesAuditFilterState extends State<AmProjecttemplatesAuditFilter> { 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AmProjecttemplatesAuditDataTable(viewType: "ListView", 
                                            pageNo: 0, 
