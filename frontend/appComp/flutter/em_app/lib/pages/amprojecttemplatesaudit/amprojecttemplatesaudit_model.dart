...
List<AmProjecttemplatesAudit> amProjecttemplatesAuditFromJson(String str) => 
    List<AmProjecttemplatesAudit>.from(json.decode(str).map((x) => AmProjecttemplatesAudit.fromJson(x))); 
 
String amProjecttemplatesAuditToJson(List<AmProjecttemplatesAudit> data) => 
...
class AmProjecttemplatesAudit { 
  ...
  factory AmProjecttemplatesAudit.fromJson(Map<String, dynamic> json) => AmProjecttemplatesAudit( 
		id: json["id"], 
...
/* 
class AmProjecttemplatesAuditWoKey { 
  AmProjecttemplatesAuditWoKey({ 
	//		required this.id, 
		this.parentId, 
		this.dateCreated, 
		this.createdBy, 
