...
class AmProjecttemplatesAuditOnlyDd extends StatefulWidget { 
  const AmProjecttemplatesAuditOnlyDd({Key? key}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesAuditOnlyDdState createState() => _AmProjecttemplatesAuditOnlyDdState(); 
} 
 
class _AmProjecttemplatesAuditOnlyDdState extends State<AmProjecttemplatesAuditOnlyDd> { 
    ...
    AmProjecttemplatesAuditService.AmProjecttemplatesAuditViewAll( 	
      ...
      setState(() { 	
       amProjecttemplatesAuditList = getList; 	
		idSelected = amProjecttemplatesAuditList[0].toListLabVal()[0][1].toString();	
		 //Remove duplicates 	
        //amProjecttemplatesAuditList = amProjecttemplatesAuditList.toSet().toList();	
        _loading = false;	
      });	
    });	
  } 	
                                  ...
                                  children: [	
                                    ...
                                    DropdownButton<String>(	
                                      ...
                                      style: const TextStyle(	
                                          ...
                                          color: Colors.black),	
                                      items: amProjecttemplatesAuditList	
...
class AmProjecttemplatesAuditEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AmProjecttemplatesAuditEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesAuditEditDdState createState() => _AmProjecttemplatesAuditEditDdState(); 
} 
 
class _AmProjecttemplatesAuditEditDdState extends State<AmProjecttemplatesAuditEditDd> { 
  ...
  void initState() {	
    ...
    AmProjecttemplatesAuditService.AmProjecttemplatesAuditViewAllIds().then((ids) { 	
      if (ids is String) {	
        setState(() {	
          errorMsg = ids;	
        });	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
	     backgroundColor: Colors.blue.shade200,	
        appBar: AppBar( 	
          title: const Text("AmProjecttemplatesAudit Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
            ? EmShowProgress(msg: errorMsg)	
                ...
                child: Row(	
                  ...
                  children: [	
                    Padding(	
                      ...
                      _isKeySelected 	
                          ? FutureBuilder<AmProjecttemplatesAudit>( 	
                              future: AmProjecttemplatesAuditService 	
                                      .AmProjecttemplatesAuditQuery(_chosenValue) 	
                                  .then((value) => value), 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AmProjecttemplatesAuditEditDdRec( 	
                                          amProjecttemplatesAudit: snapshot.data!); 	
                                    } 	
                                } 	
                              }) 	
                          : const SizedBox( 	
...
class AmProjecttemplatesAuditEditDdRec extends StatefulWidget { 
  final AmProjecttemplatesAudit amProjecttemplatesAudit; 
  const AmProjecttemplatesAuditEditDdRec({Key? key, required this.amProjecttemplatesAudit}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesAuditEditDdRecState createState() => _AmProjecttemplatesAuditEditDdRecState(); 
} 
 
class _AmProjecttemplatesAuditEditDdRecState extends State<AmProjecttemplatesAuditEditDdRec> { 
  AmProjecttemplatesAudit foundAmProjecttemplatesAudit = AmProjecttemplatesAudit(id: "" ); 
...
void didChangeDependencies() { 
  ...
  void initState() { 
    super.initState(); 
    setState(() { 
      foundAmProjecttemplatesAudit = widget.amProjecttemplatesAudit; 
    }); 
  } 
            ...
            child: Form( 
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					   enabled: false,    initialValue: getEmStrOpt(foundAmProjecttemplatesAudit.id),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmProjecttemplatesAudit.parentId),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmProjecttemplatesAudit.dateCreated),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmProjecttemplatesAudit.createdBy),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmProjecttemplatesAudit.fieldName),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmProjecttemplatesAudit.dataType),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmProjecttemplatesAudit.beforeValueString),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmProjecttemplatesAudit.afterValueString),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
				  ...
				  TextFormField( 
					...
					//em size: Lines : Size: 3, Columns : Display Size: 50 
					      initialValue: getEmStrOpt(foundAmProjecttemplatesAudit.beforeValueText),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
				  ...
				  TextFormField( 
						keyboardType: TextInputType.multiline,  
							maxLines: 3, 
					//em size: Lines : Size: 3, Columns : Display Size: 50 
					      initialValue: getEmStrOpt(foundAmProjecttemplatesAudit.afterValueText),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
                    ...
                    builder: (context) => ButtonWidget( 
                      ...
                      onClicked: () async { 
						...
						// ===== BEGIN BLOCK : Calling API Service Calls ('Edit') 1st (optional 2nd...) and Routing to Next Screen 
                          ...
                          AmProjecttemplatesAudit newAmProjecttemplatesAudit = AmProjecttemplatesAudit( 
					   id: idVar , 
					   ...
					   afterValueText: afterValueTextVar , 
                          ...
                          await AmProjecttemplatesAuditService.AmProjecttemplatesAuditEdit( 
                                  newAmProjecttemplatesAudit.id, 
                                  newAmProjecttemplatesAudit) 
                              .then((message) { 
                                    apiMessage = message; 
