...
class AccountsOpportunitiesOnlyDd extends StatefulWidget { 
  const AccountsOpportunitiesOnlyDd({Key? key}) : super(key: key); 
 
  @override 
  _AccountsOpportunitiesOnlyDdState createState() => _AccountsOpportunitiesOnlyDdState(); 
} 
 
class _AccountsOpportunitiesOnlyDdState extends State<AccountsOpportunitiesOnlyDd> { 
    ...
    AccountsOpportunitiesService.AccountsOpportunitiesViewAll( 	
      ...
      setState(() { 	
       accountsOpportunitiesList = getList; 	
		idSelected = accountsOpportunitiesList[0].toListLabVal()[0][1].toString();	
		 //Remove duplicates 	
        //accountsOpportunitiesList = accountsOpportunitiesList.toSet().toList();	
        _loading = false;	
      });	
    });	
  } 	
                                  ...
                                  children: [	
                                    ...
                                    DropdownButton<String>(	
                                      ...
                                      style: const TextStyle(	
                                          ...
                                          color: Colors.black),	
                                      items: accountsOpportunitiesList	
...
class AccountsOpportunitiesEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AccountsOpportunitiesEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AccountsOpportunitiesEditDdState createState() => _AccountsOpportunitiesEditDdState(); 
} 
 
class _AccountsOpportunitiesEditDdState extends State<AccountsOpportunitiesEditDd> { 
  ...
  void initState() {	
    ...
    AccountsOpportunitiesService.AccountsOpportunitiesViewAllIds().then((ids) { 	
      if (ids is String) {	
        setState(() {	
          errorMsg = ids;	
        });	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
	     backgroundColor: Colors.blue.shade200,	
        appBar: AppBar( 	
          title: const Text("AccountsOpportunities Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
            ? EmShowProgress(msg: errorMsg)	
                ...
                child: Row(	
                  ...
                  children: [	
                    Padding(	
                      ...
                      _isKeySelected 	
                          ? FutureBuilder<AccountsOpportunities>( 	
                              future: AccountsOpportunitiesService 	
                                      .AccountsOpportunitiesQuery(_chosenValue) 	
                                  .then((value) => value), 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AccountsOpportunitiesEditDdRec( 	
                                          accountsOpportunities: snapshot.data!); 	
                                    } 	
                                } 	
                              }) 	
                          : const SizedBox( 	
...
class AccountsOpportunitiesEditDdRec extends StatefulWidget { 
  final AccountsOpportunities accountsOpportunities; 
  const AccountsOpportunitiesEditDdRec({Key? key, required this.accountsOpportunities}) : super(key: key); 
 
  @override 
  _AccountsOpportunitiesEditDdRecState createState() => _AccountsOpportunitiesEditDdRecState(); 
} 
 
class _AccountsOpportunitiesEditDdRecState extends State<AccountsOpportunitiesEditDdRec> { 
  AccountsOpportunities foundAccountsOpportunities = AccountsOpportunities(id: "" ); 
...
void didChangeDependencies() { 
  ...
  void initState() { 
    super.initState(); 
    setState(() { 
      foundAccountsOpportunities = widget.accountsOpportunities; 
    }); 
  } 
            ...
            child: Form( 
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					   enabled: false,    initialValue: getEmStrOpt(foundAccountsOpportunities.id),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				  ...
				  // ---------------------------------------------------------------------------------------  
				  // Column Details:  Srl No : [2] [ Name [Opportunityid] : EM Type [CHAR], Java Type [String]  
				  //                  EM size: maxlength: 36, Display Size : 20 
				  // Flutter Details: Field Label [Opportunity Id], Name [opportunityId], Type [String]  
				  // ---------------------------------------------------------------------------------------  
				Row( 
				  mainAxisAlignment: MainAxisAlignment.spaceBetween, 
				  children: <Widget>[ 
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAccountsOpportunities.opportunityId),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
					...
					*/  
					//maxLength: 30, 
					onSaved: (value) => setState(() => opportunityIdVar = value.toString()), 
				  ), //textformfield 
				), //flexible 
				]), //Widget[] //Row 
                  const SizedBox(height: 10), 
				  // ---------------------------------------------------------------------------------------  
				  // Column Details:  Srl No : [3] [ Name [Accountid] : EM Type [CHAR], Java Type [String]  
				  //                  EM size: maxlength: 36, Display Size : 20 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAccountsOpportunities.accountId),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAccountsOpportunities.dateModified),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAccountsOpportunities.deleted),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
                    ...
                    builder: (context) => ButtonWidget( 
                      ...
                      onClicked: () async { 
						...
						// ===== BEGIN BLOCK : Calling API Service Calls ('Edit') 1st (optional 2nd...) and Routing to Next Screen 
                          ...
                          AccountsOpportunities newAccountsOpportunities = AccountsOpportunities( 
					   id: idVar , 
					   opportunityId: opportunityIdVar , 
					   accountId: accountIdVar , 
					   dateModified: dateModifiedVar , 
					   deleted: deletedVar , 
							  ); 
 
                          await AccountsOpportunitiesService.AccountsOpportunitiesEdit( 
                                  newAccountsOpportunities.id, 
                                  newAccountsOpportunities) 
                              .then((message) { 
                                    apiMessage = message; 
