...
class AccountsOpportunitiesEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AccountsOpportunitiesEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AccountsOpportunitiesEditState createState() => _AccountsOpportunitiesEditState(); 
} 
 
class _AccountsOpportunitiesEditState extends State<AccountsOpportunitiesEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("AccountsOpportunities Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AccountsOpportunitiesEditRec( 	
...
class AccountsOpportunitiesEditRec extends StatefulWidget { 
  final AccountsOpportunities accountsOpportunities; 
  const AccountsOpportunitiesEditRec({Key? key, required this.accountsOpportunities}) : super(key: key); 
 
  @override 
  _AccountsOpportunitiesEditRecState createState() => _AccountsOpportunitiesEditRecState(); 
} 
 
class _AccountsOpportunitiesEditRecState extends State<AccountsOpportunitiesEditRec> { 
