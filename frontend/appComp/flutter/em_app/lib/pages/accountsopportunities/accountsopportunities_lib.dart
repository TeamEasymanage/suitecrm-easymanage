 ...
 */ 
	...
	SingleChildScrollView AccountsOpportunities_dispForm(BuildContext context, AccountsOpportunities foundAccountsOpportunities) { 	
        ...
        child: Flex(	
          ...
          children: [	
            Table(	
	            ...
	            children: foundAccountsOpportunities 	
	                .toListLabVal() 	
