...
class AccountsOpportunitiesForm extends StatefulWidget { 
  const AccountsOpportunitiesForm({Key? key}) : super(key: key); 
 
  @override 
  _AccountsOpportunitiesFormState createState() => _AccountsOpportunitiesFormState(); 
} 
 
class _AccountsOpportunitiesFormState extends State<AccountsOpportunitiesForm> { 
...
void didChangeDependencies() { 
  ...
  Widget build(BuildContext context) { 
	return Scaffold( 
        ...
        appBar: AppBar( 
          title: const Text("AccountsOpportunities Add Form"), 
          centerTitle: true, 
        ), 
        body: Center( 
          child: Padding( 
            ...
            child: SingleChildScrollView(
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.opportunityId),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
 ...
 */ 
 ...
 // [4] Uncomment For Media Upload Customization. Also Uncomment Media Field Assignment in  newAccountsOpportunities creation below  
 /* 
                          //Get Base64 ready 
 ...
 */ 
 ...
 /* 
                          //Uncomment and Use Model AccountsOpportunitiesWoKey from model.dart, when key should not be passed, it is @GeneratedValue on API side  
                          AccountsOpportunitiesWoKey newAccountsOpportunities = AccountsOpportunitiesWoKey( 
 ...
 */ 
					   ...
					   deleted: deletedVar , 
                          ...
                          await AccountsOpportunitiesService.AccountsOpportunitiesCreate( 
                                  newAccountsOpportunities.toJson()) 
                              .then((message) { 
                                    apiMessage = message; 
