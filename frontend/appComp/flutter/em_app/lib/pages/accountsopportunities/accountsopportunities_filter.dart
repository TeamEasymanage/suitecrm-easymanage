...
class AccountsOpportunitiesFilter extends StatefulWidget { 
  const AccountsOpportunitiesFilter({Key? key}) : super(key: key); 
 
  @override 
  _AccountsOpportunitiesFilterState createState() => _AccountsOpportunitiesFilterState(); 
} 
 
class _AccountsOpportunitiesFilterState extends State<AccountsOpportunitiesFilter> { 
	...
	List<List<String>> tblColumnList = [ 
		["Id", 'id', 'CHAR'],  
		["Opportunity Id", 'opportunityId', 'CHAR'],  
		["Account Id", 'accountId', 'CHAR'],  
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AccountsOpportunitiesDataTable(viewType: "ListView", 
                                            pageNo: 0, 
