...
class AclActionsForm extends StatefulWidget { 
  const AclActionsForm({Key? key}) : super(key: key); 
 
  @override 
  _AclActionsFormState createState() => _AclActionsFormState(); 
} 
 
class _AclActionsFormState extends State<AclActionsForm> { 
...
void didChangeDependencies() { 
  ...
  Widget build(BuildContext context) { 
	return Scaffold( 
        ...
        appBar: AppBar( 
          title: const Text("AclActions Add Form"), 
          centerTitle: true, 
        ), 
        body: Center( 
          child: Padding( 
            ...
            child: SingleChildScrollView(
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.acltype),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.aclaccess.toString()),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
 ...
 */ 
 ...
 // [4] Uncomment For Media Upload Customization. Also Uncomment Media Field Assignment in  newAclActions creation below  
 /* 
                          //Get Base64 ready 
 ...
 */ 
 ...
 /* 
                          //Uncomment and Use Model AclActionsWoKey from model.dart, when key should not be passed, it is @GeneratedValue on API side  
                          AclActionsWoKey newAclActions = AclActionsWoKey( 
 ...
 */ 
					   ...
					   deleted: deletedVar , 
                          ...
                          await AclActionsService.AclActionsCreate( 
                                  newAclActions.toJson()) 
                              .then((message) { 
                                    apiMessage = message; 
