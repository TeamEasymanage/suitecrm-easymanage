...
class AclActionsFilter extends StatefulWidget { 
  const AclActionsFilter({Key? key}) : super(key: key); 
 
  @override 
  _AclActionsFilterState createState() => _AclActionsFilterState(); 
} 
 
class _AclActionsFilterState extends State<AclActionsFilter> { 
	...
	List<List<String>> tblColumnList = [ 
		...
		["Acltype", 'acltype', 'CHAR'],  
		["Aclaccess", 'aclaccess', 'NUMBER'],  
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AclActionsDataTable(viewType: "ListView", 
                                            pageNo: 0, 
