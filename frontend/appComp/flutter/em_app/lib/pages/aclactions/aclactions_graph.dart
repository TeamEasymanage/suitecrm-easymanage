...
class AclActionsGraph extends StatefulWidget { 	
  const AclActionsGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _AclActionsGraphState createState() => _AclActionsGraphState(); 	
} 	
	 	
class _AclActionsGraphState extends State<AclActionsGraph> { 	
 	
  //List<AclActions> aclActionsList = []; 	
  List<EmChartModel> aclActionsList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    super.initState(); 	
    //AclActionsService.AclActionsViewAll().then((getList) { 	
    setState(() { 	
      //aclActionsList = getList; 	
      //Local static data loading 	
      aclActionsList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'AclActions Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                aclActionsList: aclActionsList) 	
                            : LineChart(lineChartAclActions()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartAclActions() { 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> aclActionsList; 	
  const BarChartSample2({Key? key, required this.aclActionsList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.aclActionsList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	
