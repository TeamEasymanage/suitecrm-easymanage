...
class AopCaseEventsAuditOnlyDd extends StatefulWidget { 
  const AopCaseEventsAuditOnlyDd({Key? key}) : super(key: key); 
 
  @override 
  _AopCaseEventsAuditOnlyDdState createState() => _AopCaseEventsAuditOnlyDdState(); 
} 
 
class _AopCaseEventsAuditOnlyDdState extends State<AopCaseEventsAuditOnlyDd> { 
    ...
    AopCaseEventsAuditService.AopCaseEventsAuditViewAll( 	
      ...
      setState(() { 	
       aopCaseEventsAuditList = getList; 	
		idSelected = aopCaseEventsAuditList[0].toListLabVal()[0][1].toString();	
		 //Remove duplicates 	
        //aopCaseEventsAuditList = aopCaseEventsAuditList.toSet().toList();	
        _loading = false;	
      });	
    });	
  } 	
...
class AopCaseEventsAuditEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AopCaseEventsAuditEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AopCaseEventsAuditEditDdState createState() => _AopCaseEventsAuditEditDdState(); 
} 
 
class _AopCaseEventsAuditEditDdState extends State<AopCaseEventsAuditEditDd> { 
  ...
  void initState() {	
    ...
    AopCaseEventsAuditService.AopCaseEventsAuditViewAllIds().then((ids) { 	
      if (ids is String) {	
        setState(() {	
          errorMsg = ids;	
        });	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
	     backgroundColor: Colors.blue.shade200,	
        appBar: AppBar( 	
          title: const Text("AopCaseEventsAudit Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
            ? EmShowProgress(msg: errorMsg)	
                ...
                child: Row(	
                  ...
                  children: [	
                    Padding(	
                      ...
                      _isKeySelected 	
                          ? FutureBuilder<AopCaseEventsAudit>( 	
                              future: AopCaseEventsAuditService 	
                                      .AopCaseEventsAuditQuery(_chosenValue) 	
                                  .then((value) => value), 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AopCaseEventsAuditEditDdRec( 	
                                          aopCaseEventsAudit: snapshot.data!); 	
                                    } 	
                                } 	
                              }) 	
                          : const SizedBox( 	
...
class AopCaseEventsAuditEditDdRec extends StatefulWidget { 
  final AopCaseEventsAudit aopCaseEventsAudit; 
  const AopCaseEventsAuditEditDdRec({Key? key, required this.aopCaseEventsAudit}) : super(key: key); 
 
  @override 
  _AopCaseEventsAuditEditDdRecState createState() => _AopCaseEventsAuditEditDdRecState(); 
} 
 
class _AopCaseEventsAuditEditDdRecState extends State<AopCaseEventsAuditEditDdRec> { 
  AopCaseEventsAudit foundAopCaseEventsAudit = AopCaseEventsAudit(id: "" ); 
...
void didChangeDependencies() { 
  ...
  void initState() { 
    super.initState(); 
    setState(() { 
      foundAopCaseEventsAudit = widget.aopCaseEventsAudit; 
    }); 
  } 
            ...
            child: Form( 
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					   enabled: false,    initialValue: getEmStrOpt(foundAopCaseEventsAudit.id),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAopCaseEventsAudit.parentId),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAopCaseEventsAudit.dateCreated),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAopCaseEventsAudit.createdBy),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAopCaseEventsAudit.fieldName),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAopCaseEventsAudit.dataType),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAopCaseEventsAudit.beforeValueString),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAopCaseEventsAudit.afterValueString),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
				  ...
				  TextFormField( 
					...
					//em size: Lines : Size: 3, Columns : Display Size: 50 
					      initialValue: getEmStrOpt(foundAopCaseEventsAudit.beforeValueText),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
				  ...
				  TextFormField( 
						keyboardType: TextInputType.multiline,  
							maxLines: 3, 
					//em size: Lines : Size: 3, Columns : Display Size: 50 
					      initialValue: getEmStrOpt(foundAopCaseEventsAudit.afterValueText),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
                    ...
                    builder: (context) => ButtonWidget( 
                      ...
                      onClicked: () async { 
						...
						// ===== BEGIN BLOCK : Calling API Service Calls ('Edit') 1st (optional 2nd...) and Routing to Next Screen 
                          ...
                          AopCaseEventsAudit newAopCaseEventsAudit = AopCaseEventsAudit( 
					   id: idVar , 
					   ...
					   afterValueText: afterValueTextVar , 
                          ...
                          await AopCaseEventsAuditService.AopCaseEventsAuditEdit( 
                                  newAopCaseEventsAudit.id, 
                                  newAopCaseEventsAudit) 
                              .then((message) { 
                                    apiMessage = message; 
