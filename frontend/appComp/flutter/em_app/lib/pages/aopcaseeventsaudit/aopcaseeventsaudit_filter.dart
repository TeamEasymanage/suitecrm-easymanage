...
class AopCaseEventsAuditFilter extends StatefulWidget { 
  const AopCaseEventsAuditFilter({Key? key}) : super(key: key); 
 
  @override 
  _AopCaseEventsAuditFilterState createState() => _AopCaseEventsAuditFilterState(); 
} 
 
class _AopCaseEventsAuditFilterState extends State<AopCaseEventsAuditFilter> { 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AopCaseEventsAuditDataTable(viewType: "ListView", 
                                            pageNo: 0, 
