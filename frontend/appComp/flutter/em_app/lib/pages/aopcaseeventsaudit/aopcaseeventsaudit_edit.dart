...
class AopCaseEventsAuditEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AopCaseEventsAuditEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AopCaseEventsAuditEditState createState() => _AopCaseEventsAuditEditState(); 
} 
 
class _AopCaseEventsAuditEditState extends State<AopCaseEventsAuditEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("AopCaseEventsAudit Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AopCaseEventsAuditEditRec( 	
...
class AopCaseEventsAuditEditRec extends StatefulWidget { 
  final AopCaseEventsAudit aopCaseEventsAudit; 
  const AopCaseEventsAuditEditRec({Key? key, required this.aopCaseEventsAudit}) : super(key: key); 
 
  @override 
  _AopCaseEventsAuditEditRecState createState() => _AopCaseEventsAuditEditRecState(); 
} 
 
class _AopCaseEventsAuditEditRecState extends State<AopCaseEventsAuditEditRec> { 
