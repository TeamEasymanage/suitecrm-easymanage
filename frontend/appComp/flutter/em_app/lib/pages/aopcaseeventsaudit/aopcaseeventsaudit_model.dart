...
List<AopCaseEventsAudit> aopCaseEventsAuditFromJson(String str) => 
    List<AopCaseEventsAudit>.from(json.decode(str).map((x) => AopCaseEventsAudit.fromJson(x))); 
 
String aopCaseEventsAuditToJson(List<AopCaseEventsAudit> data) => 
...
class AopCaseEventsAudit { 
  ...
  factory AopCaseEventsAudit.fromJson(Map<String, dynamic> json) => AopCaseEventsAudit( 
		id: json["id"], 
...
/* 
class AopCaseEventsAuditWoKey { 
  AopCaseEventsAuditWoKey({ 
	//		required this.id, 
		this.parentId, 
		this.dateCreated, 
		this.createdBy, 
