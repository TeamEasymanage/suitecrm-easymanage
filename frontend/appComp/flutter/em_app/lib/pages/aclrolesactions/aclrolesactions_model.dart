...
List<AclRolesActions> aclRolesActionsFromJson(String str) => 
    List<AclRolesActions>.from(json.decode(str).map((x) => AclRolesActions.fromJson(x))); 
 
String aclRolesActionsToJson(List<AclRolesActions> data) => 
...
class AclRolesActions { 
  ...
  factory AclRolesActions.fromJson(Map<String, dynamic> json) => AclRolesActions( 
		id: json["id"], 
		roleId: json["roleId"], 
		actionId: json["actionId"], 
		accessOverride: json["accessOverride"], 
  ...
  Map<String, dynamic> toMapLabelVal() => { 
		...
		"Role Id": roleId, 
		"Action Id": actionId, 
		"Access Override": accessOverride, 
...
String ret = ""; 
        ...
        case "Access Override": { ret = getEmFmtNumOpt(val); } break;	 
        default: { 
        ret = val.toString(); 
        } 
        } 
...
/* 
class AclRolesActionsWoKey { 
  AclRolesActionsWoKey({ 
	//		required this.id, 
		this.roleId, 
		this.actionId, 
		this.accessOverride, 
