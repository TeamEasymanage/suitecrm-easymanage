...
class AclRolesActionsGraph extends StatefulWidget { 	
  const AclRolesActionsGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _AclRolesActionsGraphState createState() => _AclRolesActionsGraphState(); 	
} 	
	 	
class _AclRolesActionsGraphState extends State<AclRolesActionsGraph> { 	
 	
  //List<AclRolesActions> aclRolesActionsList = []; 	
  List<EmChartModel> aclRolesActionsList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    super.initState(); 	
    //AclRolesActionsService.AclRolesActionsViewAll().then((getList) { 	
    setState(() { 	
      //aclRolesActionsList = getList; 	
      //Local static data loading 	
      aclRolesActionsList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'AclRolesActions Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                aclRolesActionsList: aclRolesActionsList) 	
                            : LineChart(lineChartAclRolesActions()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartAclRolesActions() { 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> aclRolesActionsList; 	
  const BarChartSample2({Key? key, required this.aclRolesActionsList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.aclRolesActionsList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	
