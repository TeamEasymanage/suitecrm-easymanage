...
class AclRolesActionsEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AclRolesActionsEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AclRolesActionsEditState createState() => _AclRolesActionsEditState(); 
} 
 
class _AclRolesActionsEditState extends State<AclRolesActionsEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("AclRolesActions Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
...
class AclRolesActionsEditRec extends StatefulWidget { 
  final AclRolesActions aclRolesActions; 
  const AclRolesActionsEditRec({Key? key, required this.aclRolesActions}) : super(key: key); 
 
  @override 
  _AclRolesActionsEditRecState createState() => _AclRolesActionsEditRecState(); 
} 
 
class _AclRolesActionsEditRecState extends State<AclRolesActionsEditRec> { 
