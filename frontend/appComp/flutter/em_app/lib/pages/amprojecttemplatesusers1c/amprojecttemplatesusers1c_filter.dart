...
class AmProjecttemplatesUsers1CFilter extends StatefulWidget { 
  const AmProjecttemplatesUsers1CFilter({Key? key}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesUsers1CFilterState createState() => _AmProjecttemplatesUsers1CFilterState(); 
} 
 
class _AmProjecttemplatesUsers1CFilterState extends State<AmProjecttemplatesUsers1CFilter> { 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AmProjecttemplatesUsers1CDataTable(viewType: "ListView", 
                                            pageNo: 0, 
