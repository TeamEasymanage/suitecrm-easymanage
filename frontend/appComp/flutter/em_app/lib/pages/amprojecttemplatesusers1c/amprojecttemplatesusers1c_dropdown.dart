...
class AmProjecttemplatesUsers1COnlyDd extends StatefulWidget { 
  const AmProjecttemplatesUsers1COnlyDd({Key? key}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesUsers1COnlyDdState createState() => _AmProjecttemplatesUsers1COnlyDdState(); 
} 
 
class _AmProjecttemplatesUsers1COnlyDdState extends State<AmProjecttemplatesUsers1COnlyDd> { 
    ...
    AmProjecttemplatesUsers1CService.AmProjecttemplatesUsers1CViewAll( 	
      ...
      setState(() { 	
       amProjecttemplatesUsers1CList = getList; 	
		idSelected = amProjecttemplatesUsers1CList[0].toListLabVal()[0][1].toString();	
		 //Remove duplicates 	
        //amProjecttemplatesUsers1CList = amProjecttemplatesUsers1CList.toSet().toList();	
        _loading = false;	
      });	
    });	
  } 	
                                  ...
                                  children: [	
                                    ...
                                    DropdownButton<String>(	
                                      ...
                                      style: const TextStyle(	
                                          ...
                                          color: Colors.black),	
                                      items: amProjecttemplatesUsers1CList	
...
class AmProjecttemplatesUsers1CEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AmProjecttemplatesUsers1CEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesUsers1CEditDdState createState() => _AmProjecttemplatesUsers1CEditDdState(); 
} 
 
class _AmProjecttemplatesUsers1CEditDdState extends State<AmProjecttemplatesUsers1CEditDd> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
	     backgroundColor: Colors.blue.shade200,	
        appBar: AppBar( 	
          title: const Text("AmProjecttemplatesUsers1C Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
            ? EmShowProgress(msg: errorMsg)	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AmProjecttemplatesUsers1CEditDdRec( 	
...
class AmProjecttemplatesUsers1CEditDdRec extends StatefulWidget { 
  final AmProjecttemplatesUsers1C amProjecttemplatesUsers1C; 
  const AmProjecttemplatesUsers1CEditDdRec({Key? key, required this.amProjecttemplatesUsers1C}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesUsers1CEditDdRecState createState() => _AmProjecttemplatesUsers1CEditDdRecState(); 
} 
 
class _AmProjecttemplatesUsers1CEditDdRecState extends State<AmProjecttemplatesUsers1CEditDdRec> { 
