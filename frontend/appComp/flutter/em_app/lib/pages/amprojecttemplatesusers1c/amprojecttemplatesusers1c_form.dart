...
class AmProjecttemplatesUsers1CForm extends StatefulWidget { 
  const AmProjecttemplatesUsers1CForm({Key? key}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesUsers1CFormState createState() => _AmProjecttemplatesUsers1CFormState(); 
} 
 
class _AmProjecttemplatesUsers1CFormState extends State<AmProjecttemplatesUsers1CForm> { 
...
void didChangeDependencies() { 
  ...
  Widget build(BuildContext context) { 
	return Scaffold( 
        ...
        appBar: AppBar( 
          title: const Text("AmProjecttemplatesUsers1C Add Form"), 
          centerTitle: true, 
        ), 
        body: Center( 
          child: Padding( 
            ...
            child: SingleChildScrollView(
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.usersIdb),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
 ...
 */ 
 ...
 // [4] Uncomment For Media Upload Customization. Also Uncomment Media Field Assignment in  newAmProjecttemplatesUsers1C creation below  
 /* 
                          //Get Base64 ready 
 ...
 */ 
 ...
 /* 
                          //Uncomment and Use Model AmProjecttemplatesUsers1CWoKey from model.dart, when key should not be passed, it is @GeneratedValue on API side  
                          AmProjecttemplatesUsers1CWoKey newAmProjecttemplatesUsers1C = AmProjecttemplatesUsers1CWoKey( 
 ...
 */ 
					   ...
					   usersIdb: usersIdbVar , 
                          ...
                          await AmProjecttemplatesUsers1CService.AmProjecttemplatesUsers1CCreate( 
                                  newAmProjecttemplatesUsers1C.toJson()) 
                              .then((message) { 
                                    apiMessage = message; 
