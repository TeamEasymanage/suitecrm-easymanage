...
class AmProjecttemplatesUsers1CDataTable extends StatefulWidget { 
  final String? viewType; 
  final int? pageNo; 
  final String? searchClause; 
  final String? sortClause; 
  const AmProjecttemplatesUsers1CDataTable({Key? key, this.viewType  
  , this.pageNo 
  , this.searchClause 
  , this.sortClause 
  }) : super(key: key); 
  ...
  @override 
  _AmProjecttemplatesUsers1CDataTableState createState() => _AmProjecttemplatesUsers1CDataTableState(); 
} 
 
class _AmProjecttemplatesUsers1CDataTableState extends State<AmProjecttemplatesUsers1CDataTable> { 
  String dispType = "DataTable"; 
  String emTitle =  "AmProjecttemplatesUsers1C Data Table"; 
  int noOfCardsPerRow = 2; 
  int noOfFieldsForCard = 2; 
 
  String errorMsg = timeErrStr; 
 
  List<AmProjecttemplatesUsers1C> amProjecttemplatesUsers1CList = []; 
  ...
  void initState() { 
    ...
    if (widget.viewType != null ) { 
      ...
      switch (widget.viewType) { 
        case "ListView": { 
        dispType = "ListView"; 
        emTitle = "AmProjecttemplatesUsers1C List View"; 
        } 
        break; 
        case "ListCard": { 
        dispType = "ListCard"; 
        emTitle = "AmProjecttemplatesUsers1C List Card"; 
        } 
        break; 
        default: 
      } 
    ...
    print("Calling Service : AmProjecttemplatesUsers1CSelectWhere ... "); 
    print("searchClause: [" +searchFilter +"]");  
    print("sortClause: [" +sortBy +"]");  
    AmProjecttemplatesUsers1CService.AmProjecttemplatesUsers1CSelectWhere( 
      currPageNo 
      , searchFilter 
      , sortBy 
    ).then((getList) { 
      ...
      setState(() { 
        amProjecttemplatesUsers1CList = getList; 
        _loading = false; 
      }); 
      }  
    }); 
    ...
    print("Calling Service : AmProjecttemplatesUsers1CViewAll ... "); 
    AmProjecttemplatesUsers1CService.AmProjecttemplatesUsers1CViewAll( 
      currPageNo 
    ).then((getList) { 
      if (getList is String) { 
        setState(() { 
 ...
 /* ---------- To Implement - GET value from Hive and FindByColumnName -------------------  
  ...
  bool _loadingProvider = true; 
    ...
    _loading = true; 
    print("Calling Service : AmProjecttemplatesUsers1CFindByColumnName ... "); 
    if (userCode.isNotEmpty) {
    AmProjecttemplatesUsers1CService.AmProjecttemplatesUsers1CFindByColumnName(userCode).then((getList) {
      if (getList is String) {
        setState(() {
          errorMsg = getList;
        });
...
Container getDataTableView() { 
          ...
          return Container(  
                   ...
                   //------------------------------------ Scrollbars 	
                      ...
                      source: AmProjecttemplatesUsers1CDataSource(amProjecttemplatesUsers1CList), 
                      columns: <DataColumn>[ 
                DataColumn( 
                ...
                DataColumn( 
                    label: const Text('Users Idb'), onSort: doColumnSort), 
                      const DataColumn( 
                        label: Text( 
                          'Edit/Delete', 
...
// --------------- List Card View ------------------- 
  GridView getListCard() { 
    Iterable AmProjecttemplatesUsers1CCardList = 
        amProjecttemplatesUsers1CList.map((e) =>  
     SizedBox( 
    ...
    return GridView.count( 
        ...
        children: List.from(AmProjecttemplatesUsers1CCardList) 
    ); 
  } 
 
  Widget getColumnsForListCard1(AmProjecttemplatesUsers1C e) { 
...
Widget _buildListView() {  
    ...
    if (amProjecttemplatesUsers1CList.length == 0) { 
    return Column( 
      children: [ 
                            ...
                            IconButton( 	 
                              onPressed: () { 	 
                                Navigator.of(context).push(MaterialPageRoute( 	 
                                  builder: (context) =>  
                                  const AmProjecttemplatesUsers1CForm(), 	 
                                  ), 	 
                                ); 	 
                              }, 	 
                              icon: const Icon( 	 
    ...
    var noOfFields = amProjecttemplatesUsers1CList[0].toMapLabelVal().length;  
    //print (noOfFields);  
    ...
    dataColumns.add(  
              DataColumn( 
                label: Text(  
                            amProjecttemplatesUsers1CList[0].toListLabVal()[i][0].toString(),  
    ...
    return DataTable(  
      columns: dataColumns, 
      /* <DataColumn>[  
        DataColumn(label: Text(amProjecttemplatesUsers1CList[0].toListLabVal()[0][0].toString(), style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600))),  
        DataColumn(label: Text(amProjecttemplatesUsers1CList[0].toListLabVal()[1][0].toString(), style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600))),  
      ],  
      */ 
      rows: amProjecttemplatesUsers1CList  
          .map((e) =>  
              getDataRow(e) 
          ).toList(),  
    );  
...
DataRow getDataRow(AmProjecttemplatesUsers1C oh) { 
                      ...
                      children: [ 
                        IconButton( 	 
                            onPressed:  () => showDialog<String>( 	 
                                ...
                                builder: (BuildContext context) => AlertDialog(  
                                  ...
                                  title: Text('AmProjecttemplatesUsers1C Details', 	 
                                      style: TextStyle( 	 
                                          color: Colors.red.shade400, 	 
                                          //fontSize: 22, 	 
                                          //fontWeight: FontWeight.w400 	 
                                          )), 	 
                                  content: _AmProjecttemplatesUsers1CInfo(foundAmProjecttemplatesUsers1C: oh), 	 
                                  actions: <Widget>[ 	 
                                    TextButton( 	 
                        ...
                        IconButton( 	 
                                ...
                                builder: (BuildContext context) => AlertDialog(  
                                  ...
                                  actions: <Widget>[ 	 
                                    ...
                                    TextButton( 	  
                                      ...
                                      Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AmProjecttemplatesUsers1CDataTable(viewType: dispType, pageNo: 0, searchClause: " id = "+valParam+" ",),  
                                            ), 
                                          ); 
                                      }, 
                                      child: const Text('Go'), 
                            ...
                            IconButton( 	 
                              onPressed: () { 	 
                                Navigator.of(context).push(MaterialPageRoute( 	 
                                  builder: (context) => AmProjecttemplatesUsers1CEdit( 	 
                      				idSelected: oh.id, 	
                                  ), 	 
                                )); 	 
                              }, 	 
                        ...
                        actions: <Widget>[ 	 
                          ...
                          TextButton( 	 
                            onPressed: () async { 	 
                              ...
                              String apiMessage = ""; 	 
                              // Begin Service Call 	 
                              await AmProjecttemplatesUsers1CService.AmProjecttemplatesUsers1CDelete( 	 
                                      oh.id) 	 
                                  .then((message) { 	 
                                    apiMessage = message;	 
...
// --------------- DataTable Functions ------------------- 
  void doColumnSort(int columnIndex, bool ascending) { 
	if (columnIndex == 0) { 
	  amProjecttemplatesUsers1CList.sort((item1, item2) => 
	  ...
	  amProjecttemplatesUsers1CList.sort((item1, item2) => 
		  compareColumn(ascending, item1.usersIdb, item2.usersIdb)); 
    } 
...
void goPage(int pageNoNext) { 
                          ...
                          //} else { 
                            ...
                            Navigator.pushAndRemoveUntil( 
                              context, 
                              MaterialPageRoute(  
                                      builder: (context) =>  AmProjecttemplatesUsers1CDataTable(viewType: dispType, pageNo: pageNoNext, searchClause: searchFilter, sortClause: sortBy,), 
                                    ), 
                              (Route<dynamic> route) => route.isFirst 
                              ); 
...
class AmProjecttemplatesUsers1CDataSource extends DataTableSource { 
  // Generate some made-up data 
  @required 
  late List<AmProjecttemplatesUsers1C> _data; 
 
  AmProjecttemplatesUsers1CDataSource(List<AmProjecttemplatesUsers1C> amProjecttemplatesUsers1CList) { 
    _data = amProjecttemplatesUsers1CList; 
  } 
  ...
  DataRow getRow(int index) { 
	...
	DataCell(Text(getEmStrOpt(_data[index].usersIdb))), 
      DataCell(Row( 	
        mainAxisAlignment: MainAxisAlignment.spaceBetween, 	
        children: [ 	
          Builder(builder: (context) { 	
            ...
            return IconButton( 	
                onPressed: () => showDialog<String>( 	
                      ...
                      builder: (BuildContext context) => AlertDialog( 	
                        ...
                        content: _AmProjecttemplatesUsers1CInfo(foundAmProjecttemplatesUsers1C: _data[index]), 	
                        actions: <Widget>[ 	
                          TextButton( 	
                            onPressed: () => Navigator.pop(context, 'Cancel'), 	
                            child: const Text('Cancel'), 	
                          ...
                          TextButton( 	
                            onPressed: () async { 	
                              ...
                              context,  
                              MaterialPageRoute(   
                                      builder: (context) =>  const AmProjecttemplatesUsers1CDataTable(), //default: Disp type PaginatedDataTable   
                                    ),  
                              (Route<dynamic> route) => route.isFirst  
                              ) 
                              : null; 	
...
// --------------- DataTable Delete Call Functions - View Record -------------------	
	...
	class _AmProjecttemplatesUsers1CInfo extends StatelessWidget { 	
	  final AmProjecttemplatesUsers1C foundAmProjecttemplatesUsers1C; 	
	  const _AmProjecttemplatesUsers1CInfo({Key? key, required this.foundAmProjecttemplatesUsers1C}) 	
	      : super(key: key); 	
	 	
	  @override 	
	  Widget build(BuildContext context) { 	
			return AmProjecttemplatesUsers1C_dispForm(context, foundAmProjecttemplatesUsers1C); 	
	  } 	
	} 	
