...
class AokKnowledgeBaseCategoriesAuditForm extends StatefulWidget { 
  const AokKnowledgeBaseCategoriesAuditForm({Key? key}) : super(key: key); 
 
  @override 
  _AokKnowledgeBaseCategoriesAuditFormState createState() => _AokKnowledgeBaseCategoriesAuditFormState(); 
} 
 
class _AokKnowledgeBaseCategoriesAuditFormState extends State<AokKnowledgeBaseCategoriesAuditForm> { 
...
void didChangeDependencies() { 
  ...
  Widget build(BuildContext context) { 
	return Scaffold( 
        ...
        appBar: AppBar( 
          title: const Text("AokKnowledgeBaseCategoriesAudit Add Form"), 
          centerTitle: true, 
        ), 
        body: Center( 
          child: Padding( 
 ...
 */ 
 ...
 // [4] Uncomment For Media Upload Customization. Also Uncomment Media Field Assignment in  newAokKnowledgeBaseCategoriesAudit creation below  
 /* 
                          //Get Base64 ready 
 ...
 */ 
 ...
 /* 
                          //Uncomment and Use Model AokKnowledgeBaseCategoriesAuditWoKey from model.dart, when key should not be passed, it is @GeneratedValue on API side  
                          AokKnowledgeBaseCategoriesAuditWoKey newAokKnowledgeBaseCategoriesAudit = AokKnowledgeBaseCategoriesAuditWoKey( 
 ...
 */ 
					   ...
					   afterValueText: afterValueTextVar , 
                          ...
                          await AokKnowledgeBaseCategoriesAuditService.AokKnowledgeBaseCategoriesAuditCreate( 
                                  newAokKnowledgeBaseCategoriesAudit.toJson()) 
                              .then((message) { 
                                    apiMessage = message; 
