...
class AokKnowledgeBaseCategoriesAuditEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AokKnowledgeBaseCategoriesAuditEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AokKnowledgeBaseCategoriesAuditEditState createState() => _AokKnowledgeBaseCategoriesAuditEditState(); 
} 
 
class _AokKnowledgeBaseCategoriesAuditEditState extends State<AokKnowledgeBaseCategoriesAuditEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("AokKnowledgeBaseCategoriesAudit Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AokKnowledgeBaseCategoriesAuditEditRec( 	
...
class AokKnowledgeBaseCategoriesAuditEditRec extends StatefulWidget { 
  final AokKnowledgeBaseCategoriesAudit aokKnowledgeBaseCategoriesAudit; 
  const AokKnowledgeBaseCategoriesAuditEditRec({Key? key, required this.aokKnowledgeBaseCategoriesAudit}) : super(key: key); 
 
  @override 
  _AokKnowledgeBaseCategoriesAuditEditRecState createState() => _AokKnowledgeBaseCategoriesAuditEditRecState(); 
} 
 
class _AokKnowledgeBaseCategoriesAuditEditRecState extends State<AokKnowledgeBaseCategoriesAuditEditRec> { 
