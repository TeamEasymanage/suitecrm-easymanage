...
class AokKnowledgeBaseCategoriesAuditFilter extends StatefulWidget { 
  const AokKnowledgeBaseCategoriesAuditFilter({Key? key}) : super(key: key); 
 
  @override 
  _AokKnowledgeBaseCategoriesAuditFilterState createState() => _AokKnowledgeBaseCategoriesAuditFilterState(); 
} 
 
class _AokKnowledgeBaseCategoriesAuditFilterState extends State<AokKnowledgeBaseCategoriesAuditFilter> { 
	...
	List<List<String>> tblColumnList = [ 
		...
		["Field Name", 'fieldName', 'CHAR'],  
		["Data Type", 'dataType', 'CHAR'],  
		["Before Value String", 'beforeValueString', 'CHAR'],  
		["After Value String", 'afterValueString', 'CHAR'],  
		["Before Value Text", 'beforeValueText', 'TEXT'],  
		["After Value Text", 'afterValueText', 'TEXT'],  
	]; 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AokKnowledgeBaseCategoriesAuditDataTable(viewType: "ListView", 
                                            pageNo: 0, 
