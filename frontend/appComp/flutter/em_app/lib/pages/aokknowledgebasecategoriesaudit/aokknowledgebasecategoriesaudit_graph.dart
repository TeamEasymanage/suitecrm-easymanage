...
class AokKnowledgeBaseCategoriesAuditGraph extends StatefulWidget { 	
  const AokKnowledgeBaseCategoriesAuditGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _AokKnowledgeBaseCategoriesAuditGraphState createState() => _AokKnowledgeBaseCategoriesAuditGraphState(); 	
} 	
	 	
class _AokKnowledgeBaseCategoriesAuditGraphState extends State<AokKnowledgeBaseCategoriesAuditGraph> { 	
 	
  //List<AokKnowledgeBaseCategoriesAudit> aokKnowledgeBaseCategoriesAuditList = []; 	
  List<EmChartModel> aokKnowledgeBaseCategoriesAuditList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    super.initState(); 	
    //AokKnowledgeBaseCategoriesAuditService.AokKnowledgeBaseCategoriesAuditViewAll().then((getList) { 	
    setState(() { 	
      //aokKnowledgeBaseCategoriesAuditList = getList; 	
      //Local static data loading 	
      aokKnowledgeBaseCategoriesAuditList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'AokKnowledgeBaseCategoriesAudit Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                aokKnowledgeBaseCategoriesAuditList: aokKnowledgeBaseCategoriesAuditList) 	
                            : LineChart(lineChartAokKnowledgeBaseCategoriesAudit()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartAokKnowledgeBaseCategoriesAudit() { 	
    ...
    return LineChartData( 	
      ...
      lineBarsData: [ 	
        LineChartBarData( 	
          spots: aokKnowledgeBaseCategoriesAuditList 	
              //.sublist(0, 10) 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> aokKnowledgeBaseCategoriesAuditList; 	
  const BarChartSample2({Key? key, required this.aokKnowledgeBaseCategoriesAuditList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.aokKnowledgeBaseCategoriesAuditList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	
