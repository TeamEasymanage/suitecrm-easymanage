...
class AokKnowledgeBaseCategoriesAuditOnlyDd extends StatefulWidget { 
  const AokKnowledgeBaseCategoriesAuditOnlyDd({Key? key}) : super(key: key); 
 
  @override 
  _AokKnowledgeBaseCategoriesAuditOnlyDdState createState() => _AokKnowledgeBaseCategoriesAuditOnlyDdState(); 
} 
 
class _AokKnowledgeBaseCategoriesAuditOnlyDdState extends State<AokKnowledgeBaseCategoriesAuditOnlyDd> { 
    ...
    AokKnowledgeBaseCategoriesAuditService.AokKnowledgeBaseCategoriesAuditViewAll( 	
      ...
      setState(() { 	
       aokKnowledgeBaseCategoriesAuditList = getList; 	
		idSelected = aokKnowledgeBaseCategoriesAuditList[0].toListLabVal()[0][1].toString();	
		 //Remove duplicates 	
        //aokKnowledgeBaseCategoriesAuditList = aokKnowledgeBaseCategoriesAuditList.toSet().toList();	
        _loading = false;	
      });	
    });	
  } 	
                                  ...
                                  children: [	
                                    ...
                                    DropdownButton<String>(	
                                      ...
                                      style: const TextStyle(	
                                          ...
                                          color: Colors.black),	
                                      items: aokKnowledgeBaseCategoriesAuditList	
...
class AokKnowledgeBaseCategoriesAuditEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AokKnowledgeBaseCategoriesAuditEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AokKnowledgeBaseCategoriesAuditEditDdState createState() => _AokKnowledgeBaseCategoriesAuditEditDdState(); 
} 
 
class _AokKnowledgeBaseCategoriesAuditEditDdState extends State<AokKnowledgeBaseCategoriesAuditEditDd> { 
  ...
  void initState() {	
    ...
    AokKnowledgeBaseCategoriesAuditService.AokKnowledgeBaseCategoriesAuditViewAllIds().then((ids) { 	
      if (ids is String) {	
        setState(() {	
          errorMsg = ids;	
        });	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
	     backgroundColor: Colors.blue.shade200,	
        appBar: AppBar( 	
          title: const Text("AokKnowledgeBaseCategoriesAudit Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
            ? EmShowProgress(msg: errorMsg)	
                ...
                child: Row(	
                  ...
                  children: [	
                    Padding(	
                      ...
                      _isKeySelected 	
                          ? FutureBuilder<AokKnowledgeBaseCategoriesAudit>( 	
                              future: AokKnowledgeBaseCategoriesAuditService 	
                                      .AokKnowledgeBaseCategoriesAuditQuery(_chosenValue) 	
                                  .then((value) => value), 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AokKnowledgeBaseCategoriesAuditEditDdRec( 	
                                          aokKnowledgeBaseCategoriesAudit: snapshot.data!); 	
                                    } 	
                                } 	
                              }) 	
                          : const SizedBox( 	
...
class AokKnowledgeBaseCategoriesAuditEditDdRec extends StatefulWidget { 
  final AokKnowledgeBaseCategoriesAudit aokKnowledgeBaseCategoriesAudit; 
  const AokKnowledgeBaseCategoriesAuditEditDdRec({Key? key, required this.aokKnowledgeBaseCategoriesAudit}) : super(key: key); 
 
  @override 
  _AokKnowledgeBaseCategoriesAuditEditDdRecState createState() => _AokKnowledgeBaseCategoriesAuditEditDdRecState(); 
} 
 
class _AokKnowledgeBaseCategoriesAuditEditDdRecState extends State<AokKnowledgeBaseCategoriesAuditEditDdRec> { 
  AokKnowledgeBaseCategoriesAudit foundAokKnowledgeBaseCategoriesAudit = AokKnowledgeBaseCategoriesAudit(id: "" ); 
...
void didChangeDependencies() { 
  ...
  void initState() { 
    super.initState(); 
    setState(() { 
      foundAokKnowledgeBaseCategoriesAudit = widget.aokKnowledgeBaseCategoriesAudit; 
    }); 
  } 
            ...
            child: Form( 
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					   enabled: false,    initialValue: getEmStrOpt(foundAokKnowledgeBaseCategoriesAudit.id),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAokKnowledgeBaseCategoriesAudit.parentId),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAokKnowledgeBaseCategoriesAudit.dateCreated),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAokKnowledgeBaseCategoriesAudit.createdBy),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAokKnowledgeBaseCategoriesAudit.fieldName),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAokKnowledgeBaseCategoriesAudit.dataType),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAokKnowledgeBaseCategoriesAudit.beforeValueString),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAokKnowledgeBaseCategoriesAudit.afterValueString),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
				  ...
				  TextFormField( 
					...
					//em size: Lines : Size: 3, Columns : Display Size: 50 
					      initialValue: getEmStrOpt(foundAokKnowledgeBaseCategoriesAudit.beforeValueText),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
				  ...
				  TextFormField( 
						keyboardType: TextInputType.multiline,  
							maxLines: 3, 
					//em size: Lines : Size: 3, Columns : Display Size: 50 
					      initialValue: getEmStrOpt(foundAokKnowledgeBaseCategoriesAudit.afterValueText),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
                    ...
                    builder: (context) => ButtonWidget( 
                      ...
                      onClicked: () async { 
						...
						// ===== BEGIN BLOCK : Calling API Service Calls ('Edit') 1st (optional 2nd...) and Routing to Next Screen 
                          ...
                          AokKnowledgeBaseCategoriesAudit newAokKnowledgeBaseCategoriesAudit = AokKnowledgeBaseCategoriesAudit( 
					   id: idVar , 
					   ...
					   afterValueText: afterValueTextVar , 
                          ...
                          await AokKnowledgeBaseCategoriesAuditService.AokKnowledgeBaseCategoriesAuditEdit( 
                                  newAokKnowledgeBaseCategoriesAudit.id, 
                                  newAokKnowledgeBaseCategoriesAudit) 
                              .then((message) { 
                                    apiMessage = message; 
