...
List<AokKnowledgeBaseCategoriesAudit> aokKnowledgeBaseCategoriesAuditFromJson(String str) => 
    List<AokKnowledgeBaseCategoriesAudit>.from(json.decode(str).map((x) => AokKnowledgeBaseCategoriesAudit.fromJson(x))); 
 
String aokKnowledgeBaseCategoriesAuditToJson(List<AokKnowledgeBaseCategoriesAudit> data) => 
...
class AokKnowledgeBaseCategoriesAudit { 
  ...
  factory AokKnowledgeBaseCategoriesAudit.fromJson(Map<String, dynamic> json) => AokKnowledgeBaseCategoriesAudit( 
		id: json["id"], 
...
/* 
class AokKnowledgeBaseCategoriesAuditWoKey { 
  AokKnowledgeBaseCategoriesAuditWoKey({ 
	//		required this.id, 
		this.parentId, 
		this.dateCreated, 
		this.createdBy, 
