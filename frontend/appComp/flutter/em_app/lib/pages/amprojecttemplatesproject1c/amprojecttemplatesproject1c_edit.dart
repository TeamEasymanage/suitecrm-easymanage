...
class AmProjecttemplatesProject1CEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AmProjecttemplatesProject1CEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesProject1CEditState createState() => _AmProjecttemplatesProject1CEditState(); 
} 
 
class _AmProjecttemplatesProject1CEditState extends State<AmProjecttemplatesProject1CEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("AmProjecttemplatesProject1C Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AmProjecttemplatesProject1CEditRec( 	
...
class AmProjecttemplatesProject1CEditRec extends StatefulWidget { 
  final AmProjecttemplatesProject1C amProjecttemplatesProject1C; 
  const AmProjecttemplatesProject1CEditRec({Key? key, required this.amProjecttemplatesProject1C}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesProject1CEditRecState createState() => _AmProjecttemplatesProject1CEditRecState(); 
} 
 
class _AmProjecttemplatesProject1CEditRecState extends State<AmProjecttemplatesProject1CEditRec> { 
