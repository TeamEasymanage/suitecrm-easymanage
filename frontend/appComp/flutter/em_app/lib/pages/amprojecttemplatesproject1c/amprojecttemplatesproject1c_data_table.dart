...
import 'package:em_app/pages/amprojecttemplatesproject1c/amprojecttemplatesproject1c_service.dart'; 
import 'package:em_app/pages/amprojecttemplatesproject1c/amprojecttemplatesproject1c_lib.dart'; 
...
class AmProjecttemplatesProject1CDataTable extends StatefulWidget { 
  final String? viewType; 
  final int? pageNo; 
  final String? searchClause; 
  final String? sortClause; 
  const AmProjecttemplatesProject1CDataTable({Key? key, this.viewType  
  , this.pageNo 
  , this.searchClause 
  , this.sortClause 
  }) : super(key: key); 
  ...
  @override 
  _AmProjecttemplatesProject1CDataTableState createState() => _AmProjecttemplatesProject1CDataTableState(); 
} 
 
class _AmProjecttemplatesProject1CDataTableState extends State<AmProjecttemplatesProject1CDataTable> { 
  String dispType = "DataTable"; 
  String emTitle =  "AmProjecttemplatesProject1C Data Table"; 
  int noOfCardsPerRow = 2; 
  int noOfFieldsForCard = 2; 
 
  String errorMsg = timeErrStr; 
 
  List<AmProjecttemplatesProject1C> amProjecttemplatesProject1CList = []; 
  ...
  final double formWidth =   400 + (200 * 4) ; //400 + (200 * NoOfColumns)
  ...
  void initState() { 
    ...
    if (widget.viewType != null ) { 
      ...
      switch (widget.viewType) { 
        case "ListView": { 
        dispType = "ListView"; 
        emTitle = "AmProjecttemplatesProject1C List View"; 
        } 
        break; 
        case "ListCard": { 
        dispType = "ListCard"; 
        emTitle = "AmProjecttemplatesProject1C List Card"; 
        } 
        break; 
        default: 
      } 
    ...
    print("Calling Service : AmProjecttemplatesProject1CSelectWhere ... "); 
    print("searchClause: [" +searchFilter +"]");  
    print("sortClause: [" +sortBy +"]");  
    AmProjecttemplatesProject1CService.AmProjecttemplatesProject1CSelectWhere( 
      currPageNo 
      , searchFilter 
      , sortBy 
    ).then((getList) { 
      ...
      setState(() { 
        amProjecttemplatesProject1CList = getList; 
        _loading = false; 
      }); 
      }  
    }); 
    ...
    print("Calling Service : AmProjecttemplatesProject1CViewAll ... "); 
    AmProjecttemplatesProject1CService.AmProjecttemplatesProject1CViewAll( 
      currPageNo 
    ).then((getList) { 
      if (getList is String) { 
        setState(() { 
 ...
 /* ---------- To Implement - GET value from Hive and FindByColumnName -------------------  
  ...
  bool _loadingProvider = true; 
    ...
    _loading = true; 
    print("Calling Service : AmProjecttemplatesProject1CFindByColumnName ... "); 
    if (userCode.isNotEmpty) {
    AmProjecttemplatesProject1CService.AmProjecttemplatesProject1CFindByColumnName(userCode).then((getList) {
      if (getList is String) {
        setState(() {
          errorMsg = getList;
        });
...
Container getDataTableView() { 
          ...
          return Container(  
                   ...
                   //------------------------------------ Scrollbars 	
                      ...
                      source: AmProjecttemplatesProject1CDataSource(amProjecttemplatesProject1CList), 
                      columns: <DataColumn>[ 
                DataColumn( 
                ...
                DataColumn( 
                    label: const Text('Am Projecttemplates Project 1project Idb'), onSort: doColumnSort), 
                      const DataColumn( 
                        label: Text( 
                          'Edit/Delete', 
...
// --------------- List Card View ------------------- 
  GridView getListCard() { 
    Iterable AmProjecttemplatesProject1CCardList = 
        amProjecttemplatesProject1CList.map((e) =>  
     SizedBox( 
    ...
    return GridView.count( 
        ...
        children: List.from(AmProjecttemplatesProject1CCardList) 
    ); 
  } 
 
  Widget getColumnsForListCard1(AmProjecttemplatesProject1C e) { 
...
Widget _buildListView() {  
    ...
    if (amProjecttemplatesProject1CList.length == 0) { 
    return Column( 
      children: [ 
                            ...
                            IconButton( 	 
                              onPressed: () { 	 
                                Navigator.of(context).push(MaterialPageRoute( 	 
                                  builder: (context) =>  
                                  const AmProjecttemplatesProject1CForm(), 	 
                                  ), 	 
                                ); 	 
                              }, 	 
                              icon: const Icon( 	 
    ...
    var noOfFields = amProjecttemplatesProject1CList[0].toMapLabelVal().length;  
    //print (noOfFields);  
    ...
    dataColumns.add(  
              DataColumn( 
                label: Text(  
                            amProjecttemplatesProject1CList[0].toListLabVal()[i][0].toString(),  
    ...
    return DataTable(  
      columns: dataColumns, 
      /* <DataColumn>[  
        DataColumn(label: Text(amProjecttemplatesProject1CList[0].toListLabVal()[0][0].toString(), style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600))),  
        DataColumn(label: Text(amProjecttemplatesProject1CList[0].toListLabVal()[1][0].toString(), style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600))),  
      ],  
      */ 
      rows: amProjecttemplatesProject1CList  
          .map((e) =>  
              getDataRow(e) 
          ).toList(),  
    );  
...
DataRow getDataRow(AmProjecttemplatesProject1C oh) { 
                      ...
                      children: [ 
                        IconButton( 	 
                            onPressed:  () => showDialog<String>( 	 
                                ...
                                builder: (BuildContext context) => AlertDialog(  
                                  ...
                                  title: Text('AmProjecttemplatesProject1C Details', 	 
                                      style: TextStyle( 	 
                                          color: Colors.red.shade400, 	 
                                          //fontSize: 22, 	 
                                          //fontWeight: FontWeight.w400 	 
                                          )), 	 
                                  content: _AmProjecttemplatesProject1CInfo(foundAmProjecttemplatesProject1C: oh), 	 
                                  actions: <Widget>[ 	 
                                    TextButton( 	 
                        ...
                        IconButton( 	 
                                ...
                                builder: (BuildContext context) => AlertDialog(  
                                  ...
                                  actions: <Widget>[ 	 
                                    ...
                                    TextButton( 	  
                                      ...
                                      Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AmProjecttemplatesProject1CDataTable(viewType: dispType, pageNo: 0, searchClause: " id = "+valParam+" ",),  
                                            ), 
                                          ); 
                                      }, 
                                      child: const Text('Go'), 
                            ...
                            IconButton( 	 
                              onPressed: () { 	 
                                Navigator.of(context).push(MaterialPageRoute( 	 
                                  builder: (context) => AmProjecttemplatesProject1CEdit( 	 
                      				idSelected: oh.id, 	
                                  ), 	 
                                )); 	 
                              }, 	 
                        ...
                        actions: <Widget>[ 	 
                          ...
                          TextButton( 	 
                            onPressed: () async { 	 
                              ...
                              String apiMessage = ""; 	 
                              // Begin Service Call 	 
                              await AmProjecttemplatesProject1CService.AmProjecttemplatesProject1CDelete( 	 
                                      oh.id) 	 
                                  .then((message) { 	 
                                    apiMessage = message;	 
...
// --------------- DataTable Functions ------------------- 
  void doColumnSort(int columnIndex, bool ascending) { 
	if (columnIndex == 0) { 
	  amProjecttemplatesProject1CList.sort((item1, item2) => 
	  ...
	  amProjecttemplatesProject1CList.sort((item1, item2) => 
		  compareColumn(ascending, item1.amProjecttemplatesProject1projectIdb, item2.amProjecttemplatesProject1projectIdb)); 
    } 
...
void goPage(int pageNoNext) { 
                          ...
                          //} else { 
                            ...
                            Navigator.pushAndRemoveUntil( 
                              context, 
                              MaterialPageRoute(  
                                      builder: (context) =>  AmProjecttemplatesProject1CDataTable(viewType: dispType, pageNo: pageNoNext, searchClause: searchFilter, sortClause: sortBy,), 
                                    ), 
                              (Route<dynamic> route) => route.isFirst 
                              ); 
...
class AmProjecttemplatesProject1CDataSource extends DataTableSource { 
  // Generate some made-up data 
  @required 
  late List<AmProjecttemplatesProject1C> _data; 
 
  AmProjecttemplatesProject1CDataSource(List<AmProjecttemplatesProject1C> amProjecttemplatesProject1CList) { 
    _data = amProjecttemplatesProject1CList; 
  } 
  ...
  DataRow getRow(int index) { 
	...
	DataCell(Text(getEmStrOpt(_data[index].amProjecttemplatesProject1projectIdb))), 
      DataCell(Row( 	
        mainAxisAlignment: MainAxisAlignment.spaceBetween, 	
        children: [ 	
          Builder(builder: (context) { 	
            ...
            return IconButton( 	
                onPressed: () => showDialog<String>( 	
                      ...
                      builder: (BuildContext context) => AlertDialog( 	
                        ...
                        content: _AmProjecttemplatesProject1CInfo(foundAmProjecttemplatesProject1C: _data[index]), 	
                        actions: <Widget>[ 	
                          TextButton( 	
                            onPressed: () => Navigator.pop(context, 'Cancel'), 	
                            child: const Text('Cancel'), 	
                          ...
                          TextButton( 	
                            onPressed: () async { 	
                              ...
                              context,  
                              MaterialPageRoute(   
                                      builder: (context) =>  const AmProjecttemplatesProject1CDataTable(), //default: Disp type PaginatedDataTable   
                                    ),  
                              (Route<dynamic> route) => route.isFirst  
                              ) 
                              : null; 	
...
// --------------- DataTable Delete Call Functions - View Record -------------------	
	...
	class _AmProjecttemplatesProject1CInfo extends StatelessWidget { 	
	  final AmProjecttemplatesProject1C foundAmProjecttemplatesProject1C; 	
	  const _AmProjecttemplatesProject1CInfo({Key? key, required this.foundAmProjecttemplatesProject1C}) 	
	      : super(key: key); 	
	 	
	  @override 	
	  Widget build(BuildContext context) { 	
			return AmProjecttemplatesProject1C_dispForm(context, foundAmProjecttemplatesProject1C); 	
	  } 	
	} 	
