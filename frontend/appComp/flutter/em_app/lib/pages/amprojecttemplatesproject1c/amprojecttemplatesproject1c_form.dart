...
class AmProjecttemplatesProject1CForm extends StatefulWidget { 
  const AmProjecttemplatesProject1CForm({Key? key}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesProject1CFormState createState() => _AmProjecttemplatesProject1CFormState(); 
} 
 
class _AmProjecttemplatesProject1CFormState extends State<AmProjecttemplatesProject1CForm> { 
...
void didChangeDependencies() { 
  ...
  Widget build(BuildContext context) { 
	return Scaffold( 
        ...
        appBar: AppBar( 
          title: const Text("AmProjecttemplatesProject1C Add Form"), 
          centerTitle: true, 
        ), 
        body: Center( 
          child: Padding( 
            ...
            child: SingleChildScrollView(
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.amProjecttemplatesProject1projectIdb),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
 ...
 */ 
 ...
 // [4] Uncomment For Media Upload Customization. Also Uncomment Media Field Assignment in  newAmProjecttemplatesProject1C creation below  
 /* 
                          //Get Base64 ready 
 ...
 */ 
 ...
 /* 
                          //Uncomment and Use Model AmProjecttemplatesProject1CWoKey from model.dart, when key should not be passed, it is @GeneratedValue on API side  
                          AmProjecttemplatesProject1CWoKey newAmProjecttemplatesProject1C = AmProjecttemplatesProject1CWoKey( 
 ...
 */ 
					   ...
					   amProjecttemplatesProject1projectIdb: amProjecttemplatesProject1projectIdbVar , 
                          ...
                          await AmProjecttemplatesProject1CService.AmProjecttemplatesProject1CCreate( 
                                  newAmProjecttemplatesProject1C.toJson()) 
                              .then((message) { 
                                    apiMessage = message; 
