...
class AmProjecttemplatesProject1COnlyDd extends StatefulWidget { 
  const AmProjecttemplatesProject1COnlyDd({Key? key}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesProject1COnlyDdState createState() => _AmProjecttemplatesProject1COnlyDdState(); 
} 
 
class _AmProjecttemplatesProject1COnlyDdState extends State<AmProjecttemplatesProject1COnlyDd> { 
    ...
    AmProjecttemplatesProject1CService.AmProjecttemplatesProject1CViewAll( 	
      ...
      setState(() { 	
       amProjecttemplatesProject1CList = getList; 	
		idSelected = amProjecttemplatesProject1CList[0].toListLabVal()[0][1].toString();	
		 //Remove duplicates 	
        //amProjecttemplatesProject1CList = amProjecttemplatesProject1CList.toSet().toList();	
        _loading = false;	
      });	
    });	
  } 	
                                  ...
                                  children: [	
                                    ...
                                    DropdownButton<String>(	
                                      ...
                                      style: const TextStyle(	
                                          ...
                                          color: Colors.black),	
                                      items: amProjecttemplatesProject1CList	
...
class AmProjecttemplatesProject1CEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AmProjecttemplatesProject1CEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesProject1CEditDdState createState() => _AmProjecttemplatesProject1CEditDdState(); 
} 
 
class _AmProjecttemplatesProject1CEditDdState extends State<AmProjecttemplatesProject1CEditDd> { 
  ...
  void initState() {	
    ...
    AmProjecttemplatesProject1CService.AmProjecttemplatesProject1CViewAllIds().then((ids) { 	
      if (ids is String) {	
        setState(() {	
          errorMsg = ids;	
        });	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
	     backgroundColor: Colors.blue.shade200,	
        appBar: AppBar( 	
          title: const Text("AmProjecttemplatesProject1C Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
            ? EmShowProgress(msg: errorMsg)	
                ...
                child: Row(	
                  ...
                  children: [	
                    Padding(	
                      ...
                      _isKeySelected 	
                          ? FutureBuilder<AmProjecttemplatesProject1C>( 	
                              future: AmProjecttemplatesProject1CService 	
                                      .AmProjecttemplatesProject1CQuery(_chosenValue) 	
                                  .then((value) => value), 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AmProjecttemplatesProject1CEditDdRec( 	
                                          amProjecttemplatesProject1C: snapshot.data!); 	
                                    } 	
                                } 	
                              }) 	
                          : const SizedBox( 	
...
class AmProjecttemplatesProject1CEditDdRec extends StatefulWidget { 
  final AmProjecttemplatesProject1C amProjecttemplatesProject1C; 
  const AmProjecttemplatesProject1CEditDdRec({Key? key, required this.amProjecttemplatesProject1C}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesProject1CEditDdRecState createState() => _AmProjecttemplatesProject1CEditDdRecState(); 
} 
 
class _AmProjecttemplatesProject1CEditDdRecState extends State<AmProjecttemplatesProject1CEditDdRec> { 
  AmProjecttemplatesProject1C foundAmProjecttemplatesProject1C = AmProjecttemplatesProject1C(id: "" ); 
  ...
  static final formKey = GlobalKey<FormState>(); 
		...
		String? deletedVar = ""; 
		String? amProjecttemplatesProject1projectIdbVar = ""; 
...
void didChangeDependencies() { 
  ...
  void initState() { 
    super.initState(); 
    setState(() { 
      foundAmProjecttemplatesProject1C = widget.amProjecttemplatesProject1C; 
    }); 
  } 
            ...
            child: Form( 
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					   enabled: false,    initialValue: getEmStrOpt(foundAmProjecttemplatesProject1C.id),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmProjecttemplatesProject1C.dateModified),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmProjecttemplatesProject1C.deleted),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
                  ...
                  const SizedBox(height: 10), 
				  // ---------------------------------------------------------------------------------------  
				  // Column Details:  Srl No : [4] [ Name [Amprojecttemplatesproject1projectidb] : EM Type [CHAR], Java Type [String]  
				  //                  EM size: maxlength: 36, Display Size : 20 
				  // Flutter Details: Field Label [Am Projecttemplates Project 1project Idb], Name [amProjecttemplatesProject1projectIdb], Type [String]  
				  // ---------------------------------------------------------------------------------------  
				Row( 
				  mainAxisAlignment: MainAxisAlignment.spaceBetween, 
				  children: <Widget>[ 
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmProjecttemplatesProject1C.amProjecttemplatesProject1projectIdb),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
					  ...
					  */ 
					decoration: const InputDecoration( 
					  labelText: 'Am Projecttemplates Project 1project Idb', 
					  border: OutlineInputBorder(), 
						// filled: true, //for limiting size width/height 
					), 
					//em size: maxlength: 36, Display Size : 20 
					...
					*/  
					//maxLength: 30, 
					onSaved: (value) => setState(() => amProjecttemplatesProject1projectIdbVar = value.toString()), 
				  ), //textformfield 
				), //flexible 
				]), //Widget[] //Row 
                  const SizedBox(height: 10), 
                    ...
                    builder: (context) => ButtonWidget( 
                      ...
                      onClicked: () async { 
						...
						// ===== BEGIN BLOCK : Calling API Service Calls ('Edit') 1st (optional 2nd...) and Routing to Next Screen 
                          ...
                          AmProjecttemplatesProject1C newAmProjecttemplatesProject1C = AmProjecttemplatesProject1C( 
					   id: idVar , 
					   dateModified: dateModifiedVar , 
					   deleted: deletedVar , 
					   amProjecttemplatesProject1projectIdb: amProjecttemplatesProject1projectIdbVar , 
							  ); 
 
                          await AmProjecttemplatesProject1CService.AmProjecttemplatesProject1CEdit( 
                                  newAmProjecttemplatesProject1C.id, 
                                  newAmProjecttemplatesProject1C) 
                              .then((message) { 
                                    apiMessage = message; 
