...
class AmProjecttemplatesProject1CFilter extends StatefulWidget { 
  const AmProjecttemplatesProject1CFilter({Key? key}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesProject1CFilterState createState() => _AmProjecttemplatesProject1CFilterState(); 
} 
 
class _AmProjecttemplatesProject1CFilterState extends State<AmProjecttemplatesProject1CFilter> { 
	...
	List<List<String>> tblColumnList = [ 
		...
		["Am Projecttemplates Project 1project Idb", 'amProjecttemplatesProject1projectIdb', 'CHAR'],  
	]; 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AmProjecttemplatesProject1CDataTable(viewType: "ListView", 
                                            pageNo: 0, 
