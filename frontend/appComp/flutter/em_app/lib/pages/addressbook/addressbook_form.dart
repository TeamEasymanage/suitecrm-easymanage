...
class AddressBookForm extends StatefulWidget { 
  const AddressBookForm({Key? key}) : super(key: key); 
 
  @override 
  _AddressBookFormState createState() => _AddressBookFormState(); 
} 
 
class _AddressBookFormState extends State<AddressBookForm> { 
...
void didChangeDependencies() { 
  ...
  Widget build(BuildContext context) { 
	return Scaffold( 
        ...
        appBar: AppBar( 
          title: const Text("AddressBook Add Form"), 
          centerTitle: true, 
        ), 
        body: Center( 
          child: Padding( 
            ...
            child: SingleChildScrollView(
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL   enabled: false,    initialValue: getEmStrOpt(foundRecord.assignedUserId),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.bean),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.beanId),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
 ...
 */ 
 ...
 // [4] Uncomment For Media Upload Customization. Also Uncomment Media Field Assignment in  newAddressBook creation below  
 /* 
                          //Get Base64 ready 
 ...
 */ 
 ...
 /* 
                          //Uncomment and Use Model AddressBookWoKey from model.dart, when key should not be passed, it is @GeneratedValue on API side  
                          AddressBookWoKey newAddressBook = AddressBookWoKey( 
 ...
 */ 
					   ...
					   beanId: beanIdVar , 
                          ...
                          await AddressBookService.AddressBookCreate( 
                                  newAddressBook.toJson()) 
                              .then((message) { 
                                    apiMessage = message; 
