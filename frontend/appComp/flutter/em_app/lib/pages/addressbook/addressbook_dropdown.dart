...
class AddressBookOnlyDd extends StatefulWidget { 
  const AddressBookOnlyDd({Key? key}) : super(key: key); 
 
  @override 
  _AddressBookOnlyDdState createState() => _AddressBookOnlyDdState(); 
} 
 
class _AddressBookOnlyDdState extends State<AddressBookOnlyDd> { 
    ...
    AddressBookService.AddressBookViewAll( 	
      ...
      setState(() { 	
       addressBookList = getList; 	
		assignedUserIdSelected = addressBookList[0].toListLabVal()[0][1].toString();	
		 //Remove duplicates 	
        //addressBookList = addressBookList.toSet().toList();	
        _loading = false;	
      });	
    });	
  } 	
                                ...
                                child: Row(	
                                  ...
                                  children: [	
                                    ...
                                    DropdownButton<String>(	
                                      ...
                                      value: assignedUserIdSelected,	
                                      style: const TextStyle(	
                                          //fontSize: 18,	
                                          //fontWeight: FontWeight.w400,	
                                          color: Colors.black),	
                                      items: addressBookList	
...
class AddressBookEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final String assignedUserIdSelected; 
  const AddressBookEditDd({Key? key, required this.assignedUserIdSelected}) : super(key: key); 
 
  @override 
  _AddressBookEditDdState createState() => _AddressBookEditDdState(); 
} 
 
class _AddressBookEditDdState extends State<AddressBookEditDd> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
	     backgroundColor: Colors.blue.shade200,	
        appBar: AppBar( 	
          title: const Text("AddressBook Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
            ? EmShowProgress(msg: errorMsg)	
...
class AddressBookEditDdRec extends StatefulWidget { 
  final AddressBook addressBook; 
  const AddressBookEditDdRec({Key? key, required this.addressBook}) : super(key: key); 
 
  @override 
  _AddressBookEditDdRecState createState() => _AddressBookEditDdRecState(); 
} 
 
class _AddressBookEditDdRecState extends State<AddressBookEditDdRec> { 
