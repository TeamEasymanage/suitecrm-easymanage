...
class AddressBookGraph extends StatefulWidget { 	
  const AddressBookGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _AddressBookGraphState createState() => _AddressBookGraphState(); 	
} 	
	 	
class _AddressBookGraphState extends State<AddressBookGraph> { 	
 	
  //List<AddressBook> addressBookList = []; 	
  List<EmChartModel> addressBookList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    super.initState(); 	
    //AddressBookService.AddressBookViewAll().then((getList) { 	
    setState(() { 	
      //addressBookList = getList; 	
      //Local static data loading 	
      addressBookList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'AddressBook Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ...
                            : LineChart(lineChartAddressBook()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartAddressBook() { 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> addressBookList; 	
  const BarChartSample2({Key? key, required this.addressBookList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.addressBookList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	
