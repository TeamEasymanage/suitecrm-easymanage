...
class AddressBookFilter extends StatefulWidget { 
  const AddressBookFilter({Key? key}) : super(key: key); 
 
  @override 
  _AddressBookFilterState createState() => _AddressBookFilterState(); 
} 
 
class _AddressBookFilterState extends State<AddressBookFilter> { 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AddressBookDataTable(viewType: "ListView", 
                                            pageNo: 0, 
