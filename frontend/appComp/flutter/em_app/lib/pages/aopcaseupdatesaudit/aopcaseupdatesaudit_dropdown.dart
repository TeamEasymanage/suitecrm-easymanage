...
class AopCaseUpdatesAuditOnlyDd extends StatefulWidget { 
  const AopCaseUpdatesAuditOnlyDd({Key? key}) : super(key: key); 
 
  @override 
  _AopCaseUpdatesAuditOnlyDdState createState() => _AopCaseUpdatesAuditOnlyDdState(); 
} 
 
class _AopCaseUpdatesAuditOnlyDdState extends State<AopCaseUpdatesAuditOnlyDd> { 
    ...
    AopCaseUpdatesAuditService.AopCaseUpdatesAuditViewAll( 	
      ...
      setState(() { 	
       aopCaseUpdatesAuditList = getList; 	
		idSelected = aopCaseUpdatesAuditList[0].toListLabVal()[0][1].toString();	
		 //Remove duplicates 	
        //aopCaseUpdatesAuditList = aopCaseUpdatesAuditList.toSet().toList();	
        _loading = false;	
      });	
    });	
  } 	
...
class AopCaseUpdatesAuditEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AopCaseUpdatesAuditEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AopCaseUpdatesAuditEditDdState createState() => _AopCaseUpdatesAuditEditDdState(); 
} 
 
class _AopCaseUpdatesAuditEditDdState extends State<AopCaseUpdatesAuditEditDd> { 
  ...
  void initState() {	
    ...
    AopCaseUpdatesAuditService.AopCaseUpdatesAuditViewAllIds().then((ids) { 	
      if (ids is String) {	
        setState(() {	
          errorMsg = ids;	
        });	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
	     backgroundColor: Colors.blue.shade200,	
        appBar: AppBar( 	
          title: const Text("AopCaseUpdatesAudit Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
            ? EmShowProgress(msg: errorMsg)	
                ...
                child: Row(	
                  ...
                  children: [	
                    Padding(	
                      ...
                      _isKeySelected 	
                          ? FutureBuilder<AopCaseUpdatesAudit>( 	
                              future: AopCaseUpdatesAuditService 	
                                      .AopCaseUpdatesAuditQuery(_chosenValue) 	
                                  .then((value) => value), 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AopCaseUpdatesAuditEditDdRec( 	
                                          aopCaseUpdatesAudit: snapshot.data!); 	
                                    } 	
                                } 	
                              }) 	
                          : const SizedBox( 	
...
class AopCaseUpdatesAuditEditDdRec extends StatefulWidget { 
  final AopCaseUpdatesAudit aopCaseUpdatesAudit; 
  const AopCaseUpdatesAuditEditDdRec({Key? key, required this.aopCaseUpdatesAudit}) : super(key: key); 
 
  @override 
  _AopCaseUpdatesAuditEditDdRecState createState() => _AopCaseUpdatesAuditEditDdRecState(); 
} 
 
class _AopCaseUpdatesAuditEditDdRecState extends State<AopCaseUpdatesAuditEditDdRec> { 
  AopCaseUpdatesAudit foundAopCaseUpdatesAudit = AopCaseUpdatesAudit(id: "" ); 
...
void didChangeDependencies() { 
  ...
  void initState() { 
    super.initState(); 
    setState(() { 
      foundAopCaseUpdatesAudit = widget.aopCaseUpdatesAudit; 
    }); 
  } 
            ...
            child: Form( 
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					   enabled: false,    initialValue: getEmStrOpt(foundAopCaseUpdatesAudit.id),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAopCaseUpdatesAudit.parentId),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAopCaseUpdatesAudit.dateCreated),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAopCaseUpdatesAudit.createdBy),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAopCaseUpdatesAudit.fieldName),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAopCaseUpdatesAudit.dataType),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAopCaseUpdatesAudit.beforeValueString),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAopCaseUpdatesAudit.afterValueString),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
				  ...
				  TextFormField( 
					...
					//em size: Lines : Size: 3, Columns : Display Size: 50 
					      initialValue: getEmStrOpt(foundAopCaseUpdatesAudit.beforeValueText),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
				  ...
				  TextFormField( 
						keyboardType: TextInputType.multiline,  
							maxLines: 3, 
					//em size: Lines : Size: 3, Columns : Display Size: 50 
					      initialValue: getEmStrOpt(foundAopCaseUpdatesAudit.afterValueText),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
                    ...
                    builder: (context) => ButtonWidget( 
                      ...
                      onClicked: () async { 
						...
						// ===== BEGIN BLOCK : Calling API Service Calls ('Edit') 1st (optional 2nd...) and Routing to Next Screen 
                          ...
                          AopCaseUpdatesAudit newAopCaseUpdatesAudit = AopCaseUpdatesAudit( 
					   id: idVar , 
					   ...
					   afterValueText: afterValueTextVar , 
                          ...
                          await AopCaseUpdatesAuditService.AopCaseUpdatesAuditEdit( 
                                  newAopCaseUpdatesAudit.id, 
                                  newAopCaseUpdatesAudit) 
                              .then((message) { 
                                    apiMessage = message; 
