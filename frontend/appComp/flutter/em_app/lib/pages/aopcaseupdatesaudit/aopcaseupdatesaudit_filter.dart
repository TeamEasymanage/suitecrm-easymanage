...
class AopCaseUpdatesAuditFilter extends StatefulWidget { 
  const AopCaseUpdatesAuditFilter({Key? key}) : super(key: key); 
 
  @override 
  _AopCaseUpdatesAuditFilterState createState() => _AopCaseUpdatesAuditFilterState(); 
} 
 
class _AopCaseUpdatesAuditFilterState extends State<AopCaseUpdatesAuditFilter> { 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AopCaseUpdatesAuditDataTable(viewType: "ListView", 
                                            pageNo: 0, 
