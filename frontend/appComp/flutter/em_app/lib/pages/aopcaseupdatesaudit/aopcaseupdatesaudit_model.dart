...
List<AopCaseUpdatesAudit> aopCaseUpdatesAuditFromJson(String str) => 
    List<AopCaseUpdatesAudit>.from(json.decode(str).map((x) => AopCaseUpdatesAudit.fromJson(x))); 
 
String aopCaseUpdatesAuditToJson(List<AopCaseUpdatesAudit> data) => 
...
class AopCaseUpdatesAudit { 
  ...
  factory AopCaseUpdatesAudit.fromJson(Map<String, dynamic> json) => AopCaseUpdatesAudit( 
		id: json["id"], 
...
/* 
class AopCaseUpdatesAuditWoKey { 
  AopCaseUpdatesAuditWoKey({ 
	//		required this.id, 
		this.parentId, 
		this.dateCreated, 
		this.createdBy, 
