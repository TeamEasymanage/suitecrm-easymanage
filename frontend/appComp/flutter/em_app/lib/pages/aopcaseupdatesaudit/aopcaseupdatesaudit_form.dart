...
class AopCaseUpdatesAuditForm extends StatefulWidget { 
  const AopCaseUpdatesAuditForm({Key? key}) : super(key: key); 
 
  @override 
  _AopCaseUpdatesAuditFormState createState() => _AopCaseUpdatesAuditFormState(); 
} 
 
class _AopCaseUpdatesAuditFormState extends State<AopCaseUpdatesAuditForm> { 
...
void didChangeDependencies() { 
  ...
  Widget build(BuildContext context) { 
	return Scaffold( 
        ...
        appBar: AppBar( 
          title: const Text("AopCaseUpdatesAudit Add Form"), 
          centerTitle: true, 
        ), 
        body: Center( 
          child: Padding( 
 ...
 */ 
 ...
 // [4] Uncomment For Media Upload Customization. Also Uncomment Media Field Assignment in  newAopCaseUpdatesAudit creation below  
 /* 
                          //Get Base64 ready 
 ...
 */ 
 ...
 /* 
                          //Uncomment and Use Model AopCaseUpdatesAuditWoKey from model.dart, when key should not be passed, it is @GeneratedValue on API side  
                          AopCaseUpdatesAuditWoKey newAopCaseUpdatesAudit = AopCaseUpdatesAuditWoKey( 
 ...
 */ 
					   ...
					   afterValueText: afterValueTextVar , 
                          ...
                          await AopCaseUpdatesAuditService.AopCaseUpdatesAuditCreate( 
                                  newAopCaseUpdatesAudit.toJson()) 
                              .then((message) { 
                                    apiMessage = message; 
