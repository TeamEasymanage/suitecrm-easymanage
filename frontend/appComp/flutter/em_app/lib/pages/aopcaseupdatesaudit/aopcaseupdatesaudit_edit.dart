...
class AopCaseUpdatesAuditEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AopCaseUpdatesAuditEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AopCaseUpdatesAuditEditState createState() => _AopCaseUpdatesAuditEditState(); 
} 
 
class _AopCaseUpdatesAuditEditState extends State<AopCaseUpdatesAuditEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("AopCaseUpdatesAudit Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AopCaseUpdatesAuditEditRec( 	
...
class AopCaseUpdatesAuditEditRec extends StatefulWidget { 
  final AopCaseUpdatesAudit aopCaseUpdatesAudit; 
  const AopCaseUpdatesAuditEditRec({Key? key, required this.aopCaseUpdatesAudit}) : super(key: key); 
 
  @override 
  _AopCaseUpdatesAuditEditRecState createState() => _AopCaseUpdatesAuditEditRecState(); 
} 
 
class _AopCaseUpdatesAuditEditRecState extends State<AopCaseUpdatesAuditEditRec> { 
