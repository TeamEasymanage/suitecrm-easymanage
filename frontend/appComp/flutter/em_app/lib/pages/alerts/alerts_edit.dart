...
class AlertsEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AlertsEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AlertsEditState createState() => _AlertsEditState(); 
} 
 
class _AlertsEditState extends State<AlertsEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("Alerts Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
...
class AlertsEditRec extends StatefulWidget { 
  final Alerts alerts; 
  const AlertsEditRec({Key? key, required this.alerts}) : super(key: key); 
 
  @override 
  _AlertsEditRecState createState() => _AlertsEditRecState(); 
} 
 
class _AlertsEditRecState extends State<AlertsEditRec> { 
