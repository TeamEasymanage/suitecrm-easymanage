...
import 'package:em_app/pages/alerts/alerts_lib.dart'; 
	...
	class AlertsSearch extends StatefulWidget { 	
	  const AlertsSearch({Key? key}) : super(key: key); 	
	 	
	  @override 	
	  _AlertsSearchState createState() => _AlertsSearchState(); 	
	} 	
	 	
	class _AlertsSearchState extends State<AlertsSearch> { 	
	  ...
	  Widget build(BuildContext context) { 	
		return Scaffold( 	
	        ...
	        appBar: AppBar( 	
	          title: const Text("Alerts Search Record"), 	
	          centerTitle: true, 	
	        ), 	
	                    ...
	                    children: [ 	
	                      ...
	                      _isKeySelected 	
	                          ? FutureBuilder<Alerts>( 	
	                              future: AlertsService.AlertsQuery(_chosenValue) 	
	                                  .then((value) => value), 	
	...
	class AlertsSearchResult extends StatelessWidget { 	
	  final Alerts foundAlerts; 	
	  const AlertsSearchResult({Key? key, required this.foundAlerts}) : super(key: key); 	
