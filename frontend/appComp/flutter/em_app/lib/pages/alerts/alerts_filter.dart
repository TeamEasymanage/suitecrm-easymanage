...
class AlertsFilter extends StatefulWidget { 
  const AlertsFilter({Key? key}) : super(key: key); 
 
  @override 
  _AlertsFilterState createState() => _AlertsFilterState(); 
} 
...
class _AlertsFilterState extends State<AlertsFilter> { 
	...
	List<List<String>> tblColumnList = [ 
		...
		["Is Read", 'isRead', 'CHAR'],  
		["Target Module", 'targetModule', 'CHAR'],  
		["Type", 'type', 'CHAR'],  
		["Url Redirect", 'urlRedirect', 'CHAR'],  
		["Reminder Id", 'reminderId', 'CHAR'],  
	]; 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AlertsDataTable(viewType: "ListView", 
                                            pageNo: 0, 
