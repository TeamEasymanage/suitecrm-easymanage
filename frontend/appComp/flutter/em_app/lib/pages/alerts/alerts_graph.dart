...
class AlertsGraph extends StatefulWidget { 	
  const AlertsGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _AlertsGraphState createState() => _AlertsGraphState(); 	
} 	
	 	
class _AlertsGraphState extends State<AlertsGraph> { 	
 	
  //List<Alerts> alertsList = []; 	
  List<EmChartModel> alertsList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    super.initState(); 	
    //AlertsService.AlertsViewAll().then((getList) { 	
    setState(() { 	
      //alertsList = getList; 	
      //Local static data loading 	
      alertsList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'Alerts Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> alertsList; 	
  const BarChartSample2({Key? key, required this.alertsList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.alertsList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	
