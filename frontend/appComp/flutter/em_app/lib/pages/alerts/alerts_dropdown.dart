...
class AlertsOnlyDd extends StatefulWidget { 
  const AlertsOnlyDd({Key? key}) : super(key: key); 
 
  @override 
  _AlertsOnlyDdState createState() => _AlertsOnlyDdState(); 
} 
 
class _AlertsOnlyDdState extends State<AlertsOnlyDd> { 
  ...
  void initState() {	
    ...
    AlertsService.AlertsViewAll( 	
      ...
      setState(() { 	
       alertsList = getList; 	
		idSelected = alertsList[0].toListLabVal()[0][1].toString();	
		 //Remove duplicates 	
        //alertsList = alertsList.toSet().toList();	
        _loading = false;	
      });	
    });	
  } 	
...
class AlertsEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AlertsEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AlertsEditDdState createState() => _AlertsEditDdState(); 
} 
 
class _AlertsEditDdState extends State<AlertsEditDd> { 
  ...
  void initState() {	
    ...
    AlertsService.AlertsViewAllIds().then((ids) { 	
      if (ids is String) {	
        setState(() {	
          errorMsg = ids;	
        });	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
	     backgroundColor: Colors.blue.shade200,	
        appBar: AppBar( 	
          title: const Text("Alerts Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
            ? EmShowProgress(msg: errorMsg)	
                    ...
                    Padding(	
                      ...
                      _isKeySelected 	
                          ? FutureBuilder<Alerts>( 	
                              future: AlertsService 	
                                      .AlertsQuery(_chosenValue) 	
                                  .then((value) => value), 	
...
class AlertsEditDdRec extends StatefulWidget { 
  final Alerts alerts; 
  const AlertsEditDdRec({Key? key, required this.alerts}) : super(key: key); 
 
  @override 
  _AlertsEditDdRecState createState() => _AlertsEditDdRecState(); 
} 
 
class _AlertsEditDdRecState extends State<AlertsEditDdRec> { 
  Alerts foundAlerts = Alerts(id: "" ); 
  ...
  static final formKey = GlobalKey<FormState>(); 
		...
		String? isReadVar = ""; 
		String? targetModuleVar = ""; 
		String? typeVar = ""; 
		String? urlRedirectVar = ""; 
		String? reminderIdVar = ""; 
            ...
            child: Form( 
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					   enabled: false,    initialValue: getEmStrOpt(foundAlerts.id),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAlerts.name),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAlerts.dateEntered),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAlerts.dateModified),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAlerts.modifiedUserId),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAlerts.createdBy),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
				  ...
				  TextFormField( 
					...
					//em size: Lines : Size: 3, Columns : Display Size: 50 
					      initialValue: getEmStrOpt(foundAlerts.description),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAlerts.deleted),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAlerts.assignedUserId),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
                  ...
                  const SizedBox(height: 10), 
				  // ---------------------------------------------------------------------------------------  
				  // Column Details:  Srl No : [10] [ Name [Isread] : EM Type [CHAR], Java Type [String]  
				  //                  EM size: maxlength: 0, Display Size : 20 
				  // Flutter Details: Field Label [Is Read], Name [isRead], Type [String]  
				  // ---------------------------------------------------------------------------------------  
				Row( 
				  mainAxisAlignment: MainAxisAlignment.spaceBetween, 
				  children: <Widget>[ 
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAlerts.isRead),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
					...
					*/  
					//maxLength: 30, 
					onSaved: (value) => setState(() => isReadVar = value.toString()), 
				  ), //textformfield 
				), //flexible 
				]), //Widget[] //Row 
                  const SizedBox(height: 10), 
				  // ---------------------------------------------------------------------------------------  
				  // Column Details:  Srl No : [11] [ Name [Targetmodule] : EM Type [CHAR], Java Type [String]  
				  //                  EM size: maxlength: 255, Display Size : 20 
				  // Flutter Details: Field Label [Target Module], Name [targetModule], Type [String]  
				  // ---------------------------------------------------------------------------------------  
				Row( 
				  mainAxisAlignment: MainAxisAlignment.spaceBetween, 
				  children: <Widget>[ 
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAlerts.targetModule),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
					...
					*/  
					//maxLength: 30, 
					onSaved: (value) => setState(() => targetModuleVar = value.toString()), 
				  ), //textformfield 
				), //flexible 
				]), //Widget[] //Row 
                  const SizedBox(height: 10), 
				  // ---------------------------------------------------------------------------------------  
				  // Column Details:  Srl No : [12] [ Name [Type] : EM Type [CHAR], Java Type [String]  
				  //                  EM size: maxlength: 255, Display Size : 20 
				  // Flutter Details: Field Label [Type], Name [type], Type [String]  
				  // ---------------------------------------------------------------------------------------  
				Row( 
				  mainAxisAlignment: MainAxisAlignment.spaceBetween, 
				  children: <Widget>[ 
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAlerts.type),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
					...
					*/  
					//maxLength: 30, 
					onSaved: (value) => setState(() => typeVar = value.toString()), 
				  ), //textformfield 
				), //flexible 
				]), //Widget[] //Row 
                  const SizedBox(height: 10), 
				  // ---------------------------------------------------------------------------------------  
				  // Column Details:  Srl No : [13] [ Name [Urlredirect] : EM Type [CHAR], Java Type [String]  
				  //                  EM size: maxlength: 255, Display Size : 20 
				  // Flutter Details: Field Label [Url Redirect], Name [urlRedirect], Type [String]  
				  // ---------------------------------------------------------------------------------------  
				Row( 
				  mainAxisAlignment: MainAxisAlignment.spaceBetween, 
				  children: <Widget>[ 
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAlerts.urlRedirect),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
					...
					*/  
					//maxLength: 30, 
					onSaved: (value) => setState(() => urlRedirectVar = value.toString()), 
				  ), //textformfield 
				), //flexible 
				]), //Widget[] //Row 
                  const SizedBox(height: 10), 
				  // ---------------------------------------------------------------------------------------  
				  // Column Details:  Srl No : [14] [ Name [Reminderid] : EM Type [CHAR], Java Type [String]  
				  //                  EM size: maxlength: 36, Display Size : 20 
				  // Flutter Details: Field Label [Reminder Id], Name [reminderId], Type [String]  
				  // ---------------------------------------------------------------------------------------  
				Row( 
				  mainAxisAlignment: MainAxisAlignment.spaceBetween, 
				  children: <Widget>[ 
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAlerts.reminderId),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
					...
					*/  
					//maxLength: 30, 
					onSaved: (value) => setState(() => reminderIdVar = value.toString()), 
				  ), //textformfield 
				), //flexible 
				]), //Widget[] //Row 
                  const SizedBox(height: 10), 
                  ...
                  Builder( 
                    builder: (context) => ButtonWidget( 
                      ...
                      onClicked: () async { 
					   ...
					   isRead: isReadVar , 
					   targetModule: targetModuleVar , 
					   type: typeVar , 
					   urlRedirect: urlRedirectVar , 
					   reminderId: reminderIdVar , 
							  ); 
 
                          await AlertsService.AlertsEdit( 
                                  newAlerts.id, 
                                  newAlerts) 
                              .then((message) { 
                                    apiMessage = message; 
