...
class AobhBusinesshoursFilter extends StatefulWidget { 
  const AobhBusinesshoursFilter({Key? key}) : super(key: key); 
 
  @override 
  _AobhBusinesshoursFilterState createState() => _AobhBusinesshoursFilterState(); 
} 
 
class _AobhBusinesshoursFilterState extends State<AobhBusinesshoursFilter> { 
	...
	List<List<String>> tblColumnList = [ 
		...
		["Opening Hours", 'openingHours', 'CHAR'],  
		["Closing Hours", 'closingHours', 'CHAR'],  
		["Open Status", 'openStatus', 'CHAR'],  
		["Day", 'day', 'CHAR'],  
	]; 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AobhBusinesshoursDataTable(viewType: "ListView", 
                                            pageNo: 0, 
