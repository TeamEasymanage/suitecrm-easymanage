...
class AobhBusinesshoursDataTable extends StatefulWidget { 
  final String? viewType; 
  final int? pageNo; 
  final String? searchClause; 
  final String? sortClause; 
  const AobhBusinesshoursDataTable({Key? key, this.viewType  
  , this.pageNo 
  , this.searchClause 
  , this.sortClause 
  }) : super(key: key); 
  ...
  @override 
  _AobhBusinesshoursDataTableState createState() => _AobhBusinesshoursDataTableState(); 
} 
 
class _AobhBusinesshoursDataTableState extends State<AobhBusinesshoursDataTable> { 
  String dispType = "DataTable"; 
  String emTitle =  "AobhBusinesshours Data Table"; 
  ...
  final double formWidth =   400 + (200 * 12) ; //400 + (200 * NoOfColumns)
  ...
  void initState() { 
    ...
    if (widget.viewType != null ) { 
      ...
      switch (widget.viewType) { 
        case "ListView": { 
        dispType = "ListView"; 
        emTitle = "AobhBusinesshours List View"; 
        } 
        break; 
        case "ListCard": { 
        dispType = "ListCard"; 
        emTitle = "AobhBusinesshours List Card"; 
        } 
        break; 
        default: 
      } 
    ...
    print("Calling Service : AobhBusinesshoursSelectWhere ... "); 
    print("searchClause: [" +searchFilter +"]");  
    print("sortClause: [" +sortBy +"]");  
    AobhBusinesshoursService.AobhBusinesshoursSelectWhere( 
      currPageNo 
      , searchFilter 
      , sortBy 
    ).then((getList) { 
    ...
    print("Calling Service : AobhBusinesshoursViewAll ... "); 
 ...
 /* ---------- To Implement - GET value from Hive and FindByColumnName -------------------  
  ...
  bool _loadingProvider = true; 
    ...
    _loading = true; 
    print("Calling Service : AobhBusinesshoursFindByColumnName ... "); 
    if (userCode.isNotEmpty) {
    AobhBusinesshoursService.AobhBusinesshoursFindByColumnName(userCode).then((getList) {
      if (getList is String) {
        setState(() {
          errorMsg = getList;
        });
...
Container getDataTableView() { 
          ...
          return Container(  
                   ...
                   //------------------------------------ Scrollbars 	
                      ...
                      source: AobhBusinesshoursDataSource(aobhBusinesshoursList), 
                      columns: <DataColumn>[ 
                DataColumn( 
                ...
                DataColumn( 
                    label: const Text('Opening Hours'), onSort: doColumnSort), 
                DataColumn( 
                    label: const Text('Closing Hours'), onSort: doColumnSort), 
                DataColumn( 
                    label: const Text('Open Status'), onSort: doColumnSort), 
                DataColumn( 
                    label: const Text('Day'), onSort: doColumnSort), 
                      const DataColumn( 
                        label: Text( 
                          'Edit/Delete', 
...
// --------------- List Card View ------------------- 
  GridView getListCard() { 
    Iterable AobhBusinesshoursCardList = 
        aobhBusinesshoursList.map((e) =>  
     SizedBox( 
    ...
    return GridView.count( 
        ...
        children: List.from(AobhBusinesshoursCardList) 
    ); 
  } 
 
  Widget getColumnsForListCard1(AobhBusinesshours e) { 
...
Widget _buildListView() {  
    ...
    if (aobhBusinesshoursList.length == 0) { 
    return Column( 
      children: [ 
    ...
    var noOfFields = aobhBusinesshoursList[0].toMapLabelVal().length;  
    //print (noOfFields);  
    ...
    dataColumns.add(  
              DataColumn( 
                label: Text(  
                            aobhBusinesshoursList[0].toListLabVal()[i][0].toString(),  
    ...
    return DataTable(  
      columns: dataColumns, 
      /* <DataColumn>[  
        DataColumn(label: Text(aobhBusinesshoursList[0].toListLabVal()[0][0].toString(), style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600))),  
        DataColumn(label: Text(aobhBusinesshoursList[0].toListLabVal()[1][0].toString(), style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600))),  
      ],  
      */ 
      rows: aobhBusinesshoursList  
          .map((e) =>  
              getDataRow(e) 
          ).toList(),  
    );  
...
DataRow getDataRow(AobhBusinesshours oh) { 
                      ...
                      children: [ 
                        IconButton( 	 
                            onPressed:  () => showDialog<String>( 	 
                                ...
                                builder: (BuildContext context) => AlertDialog(  
                                  ...
                                  title: Text('AobhBusinesshours Details', 	 
                                      style: TextStyle( 	 
                                          color: Colors.red.shade400, 	 
                                          //fontSize: 22, 	 
                                          //fontWeight: FontWeight.w400 	 
                                          )), 	 
                                  content: _AobhBusinesshoursInfo(foundAobhBusinesshours: oh), 	 
                                  actions: <Widget>[ 	 
                                    TextButton( 	 
                        ...
                        IconButton( 	 
                                ...
                                builder: (BuildContext context) => AlertDialog(  
                                  ...
                                  actions: <Widget>[ 	 
                                    ...
                                    TextButton( 	  
                                      ...
                                      Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AobhBusinesshoursDataTable(viewType: dispType, pageNo: 0, searchClause: " id = "+valParam+" ",),  
                                            ), 
                                          ); 
                                      }, 
                                      child: const Text('Go'), 
                            ...
                            IconButton( 	 
                              onPressed: () { 	 
                                Navigator.of(context).push(MaterialPageRoute( 	 
                                  builder: (context) => AobhBusinesshoursEdit( 	 
                      				idSelected: oh.id, 	
                                  ), 	 
                                )); 	 
                              }, 	 
                        ...
                        actions: <Widget>[ 	 
                          ...
                          TextButton( 	 
                            onPressed: () async { 	 
                              ...
                              String apiMessage = ""; 	 
                              // Begin Service Call 	 
                              await AobhBusinesshoursService.AobhBusinesshoursDelete( 	 
                                      oh.id) 	 
                                  .then((message) { 	 
                                    apiMessage = message;	 
...
// --------------- DataTable Functions ------------------- 
  void doColumnSort(int columnIndex, bool ascending) { 
	if (columnIndex == 0) { 
	  aobhBusinesshoursList.sort((item1, item2) => 
	  ...
	  aobhBusinesshoursList.sort((item1, item2) => 
		  compareColumn(ascending, item1.openingHours, item2.openingHours)); 
	} else if (columnIndex == 9) { 
	  aobhBusinesshoursList.sort((item1, item2) => 
		  compareColumn(ascending, item1.closingHours, item2.closingHours)); 
	} else if (columnIndex == 10) { 
	  aobhBusinesshoursList.sort((item1, item2) => 
		  compareColumn(ascending, item1.openStatus, item2.openStatus)); 
	} else if (columnIndex == 11) { 
	  aobhBusinesshoursList.sort((item1, item2) => 
		  compareColumn(ascending, item1.day, item2.day)); 
    } 
...
void goPage(int pageNoNext) { 
                          ...
                          //} else { 
                            ...
                            Navigator.pushAndRemoveUntil( 
                              context, 
                              MaterialPageRoute(  
                                      builder: (context) =>  AobhBusinesshoursDataTable(viewType: dispType, pageNo: pageNoNext, searchClause: searchFilter, sortClause: sortBy,), 
                                    ), 
                              (Route<dynamic> route) => route.isFirst 
                              ); 
...
class AobhBusinesshoursDataSource extends DataTableSource { 
  // Generate some made-up data 
  @required 
  late List<AobhBusinesshours> _data; 
 
  AobhBusinesshoursDataSource(List<AobhBusinesshours> aobhBusinesshoursList) { 
    _data = aobhBusinesshoursList; 
  } 
  ...
  DataRow getRow(int index) { 
	...
	DataCell(Text(getEmStrOpt(_data[index].openingHours))), 
	DataCell(Text(getEmStrOpt(_data[index].closingHours))), 
	DataCell(Text(getEmStrOpt(_data[index].openStatus))), 
	DataCell(Text(getEmStrOpt(_data[index].day))), 
      DataCell(Row( 	
        mainAxisAlignment: MainAxisAlignment.spaceBetween, 	
        children: [ 	
          Builder(builder: (context) { 	
            ...
            return IconButton( 	
                onPressed: () => showDialog<String>( 	
                      ...
                      builder: (BuildContext context) => AlertDialog( 	
                        ...
                        content: _AobhBusinesshoursInfo(foundAobhBusinesshours: _data[index]), 	
                        actions: <Widget>[ 	
                          TextButton( 	
                            onPressed: () => Navigator.pop(context, 'Cancel'), 	
                            child: const Text('Cancel'), 	
                          ...
                          TextButton( 	
                            onPressed: () async { 	
                              ...
                              context,  
                              MaterialPageRoute(   
                                      builder: (context) =>  const AobhBusinesshoursDataTable(), //default: Disp type PaginatedDataTable   
                                    ),  
                              (Route<dynamic> route) => route.isFirst  
                              ) 
                              : null; 	
...
// --------------- DataTable Delete Call Functions - View Record -------------------	
	...
	class _AobhBusinesshoursInfo extends StatelessWidget { 	
	  final AobhBusinesshours foundAobhBusinesshours; 	
	  const _AobhBusinesshoursInfo({Key? key, required this.foundAobhBusinesshours}) 	
	      : super(key: key); 	
	 	
	  @override 	
	  Widget build(BuildContext context) { 	
			return AobhBusinesshours_dispForm(context, foundAobhBusinesshours); 	
	  } 	
	} 	
