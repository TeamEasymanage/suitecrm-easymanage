...
class AobhBusinesshoursEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AobhBusinesshoursEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AobhBusinesshoursEditState createState() => _AobhBusinesshoursEditState(); 
} 
 
class _AobhBusinesshoursEditState extends State<AobhBusinesshoursEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("AobhBusinesshours Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AobhBusinesshoursEditRec( 	
...
class AobhBusinesshoursEditRec extends StatefulWidget { 
  final AobhBusinesshours aobhBusinesshours; 
  const AobhBusinesshoursEditRec({Key? key, required this.aobhBusinesshours}) : super(key: key); 
 
  @override 
  _AobhBusinesshoursEditRecState createState() => _AobhBusinesshoursEditRecState(); 
} 
 
class _AobhBusinesshoursEditRecState extends State<AobhBusinesshoursEditRec> { 
