...
import 'package:em_app/pages/aobhbusinesshours/aobhbusinesshours_model.dart'; 
import 'package:em_app/pages/aobhbusinesshours/aobhbusinesshours_service.dart'; 
import 'package:em_app/pages/aobhbusinesshours/aobhbusinesshours_lib.dart'; 
import 'package:em_app/pages/aobhbusinesshours/aobhbusinesshours_data_table.dart'; 
 
 
class AobhBusinesshoursOnlyDd extends StatefulWidget { 
  const AobhBusinesshoursOnlyDd({Key? key}) : super(key: key); 
 
  @override 
  _AobhBusinesshoursOnlyDdState createState() => _AobhBusinesshoursOnlyDdState(); 
} 
 
class _AobhBusinesshoursOnlyDdState extends State<AobhBusinesshoursOnlyDd> { 
 
  String errorMsg = timeErrStr; 
 
  bool _loading = false; 	
  List<AobhBusinesshours> aobhBusinesshoursList = []; 
  ...
  void initState() {	
    ...
    AobhBusinesshoursService.AobhBusinesshoursViewAll( 	
      ...
      setState(() { 	
       aobhBusinesshoursList = getList; 	
		idSelected = aobhBusinesshoursList[0].toListLabVal()[0][1].toString();	
		 //Remove duplicates 	
        //aobhBusinesshoursList = aobhBusinesshoursList.toSet().toList();	
        _loading = false;	
      });	
    });	
  } 	
...
class AobhBusinesshoursEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AobhBusinesshoursEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AobhBusinesshoursEditDdState createState() => _AobhBusinesshoursEditDdState(); 
} 
 
class _AobhBusinesshoursEditDdState extends State<AobhBusinesshoursEditDd> { 
  ...
  void initState() {	
    ...
    AobhBusinesshoursService.AobhBusinesshoursViewAllIds().then((ids) { 	
      if (ids is String) {	
        setState(() {	
          errorMsg = ids;	
        });	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
	     backgroundColor: Colors.blue.shade200,	
        appBar: AppBar( 	
          title: const Text("AobhBusinesshours Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
            ? EmShowProgress(msg: errorMsg)	
                ...
                child: Row(	
                  ...
                  children: [	
                    Padding(	
                      ...
                      _isKeySelected 	
                          ? FutureBuilder<AobhBusinesshours>( 	
                              future: AobhBusinesshoursService 	
                                      .AobhBusinesshoursQuery(_chosenValue) 	
                                  .then((value) => value), 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AobhBusinesshoursEditDdRec( 	
                                          aobhBusinesshours: snapshot.data!); 	
                                    } 	
                                } 	
                              }) 	
                          : const SizedBox( 	
...
class AobhBusinesshoursEditDdRec extends StatefulWidget { 
  final AobhBusinesshours aobhBusinesshours; 
  const AobhBusinesshoursEditDdRec({Key? key, required this.aobhBusinesshours}) : super(key: key); 
 
  @override 
  _AobhBusinesshoursEditDdRecState createState() => _AobhBusinesshoursEditDdRecState(); 
} 
 
class _AobhBusinesshoursEditDdRecState extends State<AobhBusinesshoursEditDdRec> { 
  AobhBusinesshours foundAobhBusinesshours = AobhBusinesshours(id: "" ); 
  ...
  static final formKey = GlobalKey<FormState>(); 
		...
		String? deletedVar = ""; 
		String? openingHoursVar = ""; 
		String? closingHoursVar = ""; 
		String? openStatusVar = ""; 
		String? dayVar = ""; 
...
void didChangeDependencies() { 
  ...
  void initState() { 
    super.initState(); 
    setState(() { 
      foundAobhBusinesshours = widget.aobhBusinesshours; 
    }); 
  } 
            ...
            child: Form( 
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					   enabled: false,    initialValue: getEmStrOpt(foundAobhBusinesshours.id),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAobhBusinesshours.name),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAobhBusinesshours.dateEntered),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAobhBusinesshours.dateModified),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAobhBusinesshours.modifiedUserId),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAobhBusinesshours.createdBy),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
				  ...
				  TextFormField( 
					...
					//em size: Lines : Size: 3, Columns : Display Size: 50 
					      initialValue: getEmStrOpt(foundAobhBusinesshours.description),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAobhBusinesshours.deleted),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
                  ...
                  const SizedBox(height: 10), 
				  // ---------------------------------------------------------------------------------------  
				  // Column Details:  Srl No : [9] [ Name [Openinghours] : EM Type [CHAR], Java Type [String]  
				  //                  EM size: maxlength: 100, Display Size : 20 
				  // Flutter Details: Field Label [Opening Hours], Name [openingHours], Type [String]  
				  // ---------------------------------------------------------------------------------------  
				Row( 
				  mainAxisAlignment: MainAxisAlignment.spaceBetween, 
				  children: <Widget>[ 
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAobhBusinesshours.openingHours),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
					...
					*/  
					//maxLength: 30, 
					onSaved: (value) => setState(() => openingHoursVar = value.toString()), 
				  ), //textformfield 
				), //flexible 
				]), //Widget[] //Row 
                  const SizedBox(height: 10), 
				  // ---------------------------------------------------------------------------------------  
				  // Column Details:  Srl No : [10] [ Name [Closinghours] : EM Type [CHAR], Java Type [String]  
				  //                  EM size: maxlength: 100, Display Size : 20 
				  // Flutter Details: Field Label [Closing Hours], Name [closingHours], Type [String]  
				  // ---------------------------------------------------------------------------------------  
				Row( 
				  mainAxisAlignment: MainAxisAlignment.spaceBetween, 
				  children: <Widget>[ 
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAobhBusinesshours.closingHours),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
					...
					*/  
					//maxLength: 30, 
					onSaved: (value) => setState(() => closingHoursVar = value.toString()), 
				  ), //textformfield 
				), //flexible 
				]), //Widget[] //Row 
                  const SizedBox(height: 10), 
				  // ---------------------------------------------------------------------------------------  
				  // Column Details:  Srl No : [11] [ Name [Openstatus] : EM Type [CHAR], Java Type [String]  
				  //                  EM size: maxlength: 0, Display Size : 20 
				  // Flutter Details: Field Label [Open Status], Name [openStatus], Type [String]  
				  // ---------------------------------------------------------------------------------------  
				Row( 
				  mainAxisAlignment: MainAxisAlignment.spaceBetween, 
				  children: <Widget>[ 
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAobhBusinesshours.openStatus),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
					...
					*/  
					//maxLength: 30, 
					onSaved: (value) => setState(() => openStatusVar = value.toString()), 
				  ), //textformfield 
				), //flexible 
				]), //Widget[] //Row 
                  const SizedBox(height: 10), 
				  // ---------------------------------------------------------------------------------------  
				  // Column Details:  Srl No : [12] [ Name [Day] : EM Type [CHAR], Java Type [String]  
				  //                  EM size: maxlength: 100, Display Size : 20 
				  // Flutter Details: Field Label [Day], Name [day], Type [String]  
				  // ---------------------------------------------------------------------------------------  
				Row( 
				  mainAxisAlignment: MainAxisAlignment.spaceBetween, 
				  children: <Widget>[ 
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAobhBusinesshours.day),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
					...
					*/  
					//maxLength: 30, 
					onSaved: (value) => setState(() => dayVar = value.toString()), 
				  ), //textformfield 
				), //flexible 
				]), //Widget[] //Row 
                  const SizedBox(height: 10), 
                    ...
                    builder: (context) => ButtonWidget( 
                      ...
                      onClicked: () async { 
						...
						// ===== BEGIN BLOCK : Calling API Service Calls ('Edit') 1st (optional 2nd...) and Routing to Next Screen 
                          ...
                          AobhBusinesshours newAobhBusinesshours = AobhBusinesshours( 
					   id: idVar , 
					   name: nameVar , 
					   ...
					   deleted: deletedVar , 
					   openingHours: openingHoursVar , 
					   closingHours: closingHoursVar , 
					   openStatus: openStatusVar , 
					   day: dayVar , 
							  ); 
 
                          await AobhBusinesshoursService.AobhBusinesshoursEdit( 
                                  newAobhBusinesshours.id, 
                                  newAobhBusinesshours) 
                              .then((message) { 
                                    apiMessage = message; 
