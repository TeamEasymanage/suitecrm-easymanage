...
class AccountsBugsFilter extends StatefulWidget { 
  const AccountsBugsFilter({Key? key}) : super(key: key); 
 
  @override 
  _AccountsBugsFilterState createState() => _AccountsBugsFilterState(); 
} 
 
class _AccountsBugsFilterState extends State<AccountsBugsFilter> { 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AccountsBugsDataTable(viewType: "ListView", 
                                            pageNo: 0, 
