...
class AccountsBugsForm extends StatefulWidget { 
  const AccountsBugsForm({Key? key}) : super(key: key); 
 
  @override 
  _AccountsBugsFormState createState() => _AccountsBugsFormState(); 
} 
 
class _AccountsBugsFormState extends State<AccountsBugsForm> { 
...
void didChangeDependencies() { 
  ...
  Widget build(BuildContext context) { 
	return Scaffold( 
        ...
        appBar: AppBar( 
          title: const Text("AccountsBugs Add Form"), 
          centerTitle: true, 
        ), 
        body: Center( 
          child: Padding( 
            ...
            child: SingleChildScrollView(
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.bugId),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
 ...
 */ 
 ...
 // [4] Uncomment For Media Upload Customization. Also Uncomment Media Field Assignment in  newAccountsBugs creation below  
 /* 
                          //Get Base64 ready 
 ...
 */ 
 ...
 /* 
                          //Uncomment and Use Model AccountsBugsWoKey from model.dart, when key should not be passed, it is @GeneratedValue on API side  
                          AccountsBugsWoKey newAccountsBugs = AccountsBugsWoKey( 
 ...
 */ 
					   ...
					   deleted: deletedVar , 
                          ...
                          await AccountsBugsService.AccountsBugsCreate( 
                                  newAccountsBugs.toJson()) 
                              .then((message) { 
                                    apiMessage = message; 
