...
class AccountsBugsEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AccountsBugsEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AccountsBugsEditState createState() => _AccountsBugsEditState(); 
} 
 
class _AccountsBugsEditState extends State<AccountsBugsEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("AccountsBugs Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
...
class AccountsBugsEditRec extends StatefulWidget { 
  final AccountsBugs accountsBugs; 
  const AccountsBugsEditRec({Key? key, required this.accountsBugs}) : super(key: key); 
 
  @override 
  _AccountsBugsEditRecState createState() => _AccountsBugsEditRecState(); 
} 
 
class _AccountsBugsEditRecState extends State<AccountsBugsEditRec> { 
