...
class AclRolesUsersEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AclRolesUsersEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AclRolesUsersEditState createState() => _AclRolesUsersEditState(); 
} 
 
class _AclRolesUsersEditState extends State<AclRolesUsersEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("AclRolesUsers Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
...
class AclRolesUsersEditRec extends StatefulWidget { 
  final AclRolesUsers aclRolesUsers; 
  const AclRolesUsersEditRec({Key? key, required this.aclRolesUsers}) : super(key: key); 
 
  @override 
  _AclRolesUsersEditRecState createState() => _AclRolesUsersEditRecState(); 
} 
 
class _AclRolesUsersEditRecState extends State<AclRolesUsersEditRec> { 
