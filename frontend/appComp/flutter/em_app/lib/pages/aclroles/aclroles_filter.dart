...
class AclRolesFilter extends StatefulWidget { 
  const AclRolesFilter({Key? key}) : super(key: key); 
 
  @override 
  _AclRolesFilterState createState() => _AclRolesFilterState(); 
} 
 
class _AclRolesFilterState extends State<AclRolesFilter> { 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AclRolesDataTable(viewType: "ListView", 
                                            pageNo: 0, 
