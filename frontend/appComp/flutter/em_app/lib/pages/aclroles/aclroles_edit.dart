...
class AclRolesEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AclRolesEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AclRolesEditState createState() => _AclRolesEditState(); 
} 
 
class _AclRolesEditState extends State<AclRolesEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("AclRoles Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
...
class AclRolesEditRec extends StatefulWidget { 
  final AclRoles aclRoles; 
  const AclRolesEditRec({Key? key, required this.aclRoles}) : super(key: key); 
 
  @override 
  _AclRolesEditRecState createState() => _AclRolesEditRecState(); 
} 
 
class _AclRolesEditRecState extends State<AclRolesEditRec> { 
