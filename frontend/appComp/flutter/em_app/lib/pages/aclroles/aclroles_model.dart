...
List<AclRoles> aclRolesFromJson(String str) => 
    List<AclRoles>.from(json.decode(str).map((x) => AclRoles.fromJson(x))); 
 
String aclRolesToJson(List<AclRoles> data) => 
...
class AclRoles { 
  ...
  factory AclRoles.fromJson(Map<String, dynamic> json) => AclRoles( 
		id: json["id"], 
