...
import 'package:em_app/pages/aclroles/aclroles_service.dart'; 
import 'package:em_app/pages/aclroles/aclroles_lib.dart'; 
import 'package:em_app/pages/aclroles/aclroles_data_table.dart'; 
 
 
class AclRolesOnlyDd extends StatefulWidget { 
  const AclRolesOnlyDd({Key? key}) : super(key: key); 
 
  @override 
  _AclRolesOnlyDdState createState() => _AclRolesOnlyDdState(); 
} 
 
class _AclRolesOnlyDdState extends State<AclRolesOnlyDd> { 
 
  String errorMsg = timeErrStr; 
 
  bool _loading = false; 	
  List<AclRoles> aclRolesList = []; 
  ...
  void initState() {	
    ...
    AclRolesService.AclRolesViewAll( 	
      ...
      setState(() { 	
       aclRolesList = getList; 	
		idSelected = aclRolesList[0].toListLabVal()[0][1].toString();	
		 //Remove duplicates 	
        //aclRolesList = aclRolesList.toSet().toList();	
        _loading = false;	
      });	
    });	
  } 	
...
class AclRolesEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AclRolesEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AclRolesEditDdState createState() => _AclRolesEditDdState(); 
} 
 
class _AclRolesEditDdState extends State<AclRolesEditDd> { 
  ...
  void initState() {	
    ...
    AclRolesService.AclRolesViewAllIds().then((ids) { 	
      if (ids is String) {	
        setState(() {	
          errorMsg = ids;	
        });	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
	     backgroundColor: Colors.blue.shade200,	
        appBar: AppBar( 	
          title: const Text("AclRoles Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
            ? EmShowProgress(msg: errorMsg)	
                ...
                child: Row(	
                  ...
                  children: [	
                    Padding(	
                      ...
                      _isKeySelected 	
                          ? FutureBuilder<AclRoles>( 	
                              future: AclRolesService 	
                                      .AclRolesQuery(_chosenValue) 	
                                  .then((value) => value), 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AclRolesEditDdRec( 	
                                          aclRoles: snapshot.data!); 	
                                    } 	
                                } 	
                              }) 	
                          : const SizedBox( 	
...
class AclRolesEditDdRec extends StatefulWidget { 
  final AclRoles aclRoles; 
  const AclRolesEditDdRec({Key? key, required this.aclRoles}) : super(key: key); 
 
  @override 
  _AclRolesEditDdRecState createState() => _AclRolesEditDdRecState(); 
} 
 
class _AclRolesEditDdRecState extends State<AclRolesEditDdRec> { 
  AclRoles foundAclRoles = AclRoles(id: "" ); 
            ...
            child: Form( 
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					   enabled: false,    initialValue: getEmStrOpt(foundAclRoles.id),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAclRoles.dateEntered),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAclRoles.dateModified),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAclRoles.modifiedUserId),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAclRoles.createdBy),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAclRoles.name),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
				  ...
				  TextFormField( 
					...
					//em size: Lines : Size: 3, Columns : Display Size: 50 
					      initialValue: getEmStrOpt(foundAclRoles.description),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAclRoles.deleted),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
                    ...
                    builder: (context) => ButtonWidget( 
                      ...
                      onClicked: () async { 
					   ...
					   deleted: deletedVar , 
                          ...
                          await AclRolesService.AclRolesEdit( 
                                  newAclRoles.id, 
                                  newAclRoles) 
                              .then((message) { 
                                    apiMessage = message; 
