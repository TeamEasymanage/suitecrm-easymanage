...
class AclRolesGraph extends StatefulWidget { 	
  const AclRolesGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _AclRolesGraphState createState() => _AclRolesGraphState(); 	
} 	
	 	
class _AclRolesGraphState extends State<AclRolesGraph> { 	
 	
  //List<AclRoles> aclRolesList = []; 	
  List<EmChartModel> aclRolesList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    super.initState(); 	
    //AclRolesService.AclRolesViewAll().then((getList) { 	
    setState(() { 	
      //aclRolesList = getList; 	
      //Local static data loading 	
      aclRolesList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'AclRoles Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                aclRolesList: aclRolesList) 	
                            : LineChart(lineChartAclRoles()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartAclRoles() { 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> aclRolesList; 	
  const BarChartSample2({Key? key, required this.aclRolesList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.aclRolesList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	
