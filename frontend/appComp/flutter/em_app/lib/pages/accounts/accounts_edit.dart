...
class AccountsEdit extends StatefulWidget { 
  ...
  const AccountsEdit({Key? key, required this.idSelected}) : super(key: key); 
...
class _AccountsEditState extends State<AccountsEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("Accounts Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
...
class AccountsEditRec extends StatefulWidget { 
  final Accounts accounts; 
  const AccountsEditRec({Key? key, required this.accounts}) : super(key: key); 
 
  @override 
  _AccountsEditRecState createState() => _AccountsEditRecState(); 
} 
 
class _AccountsEditRecState extends State<AccountsEditRec> { 
