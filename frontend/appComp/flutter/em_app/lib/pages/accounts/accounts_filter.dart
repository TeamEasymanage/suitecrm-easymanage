...
class AccountsFilter extends StatefulWidget { 
  ...
  @override 
  _AccountsFilterState createState() => _AccountsFilterState(); 
} 
 
class _AccountsFilterState extends State<AccountsFilter> { 
	...
	List<List<String>> tblColumnList = [ 
		...
		["Account Type", 'accountType', 'CHAR'],  
		["Industry", 'industry', 'CHAR'],  
		["Annual Revenue", 'annualRevenue', 'CHAR'],  
		["Phone Fax", 'phoneFax', 'CHAR'],  
		["Billing Address Street", 'billingAddressStreet', 'CHAR'],  
		["Billing Address City", 'billingAddressCity', 'CHAR'],  
		["Billing Address State", 'billingAddressState', 'CHAR'],  
		["Billing Address Postalcode", 'billingAddressPostalcode', 'CHAR'],  
		["Billing Address Country", 'billingAddressCountry', 'CHAR'],  
		["Rating", 'rating', 'CHAR'],  
		["Phone Office", 'phoneOffice', 'CHAR'],  
		["Phone Alternate", 'phoneAlternate', 'CHAR'],  
		["Website", 'website', 'CHAR'],  
		["Ownership", 'ownership', 'CHAR'],  
		["Employees", 'employees', 'CHAR'],  
		["Ticker Symbol", 'tickerSymbol', 'CHAR'],  
		["Shipping Address Street", 'shippingAddressStreet', 'CHAR'],  
		["Shipping Address City", 'shippingAddressCity', 'CHAR'],  
		["Shipping Address State", 'shippingAddressState', 'CHAR'],  
		["Shipping Address Postalcode", 'shippingAddressPostalcode', 'CHAR'],  
		["Shipping Address Country", 'shippingAddressCountry', 'CHAR'],  
		["Parent Id", 'parentId', 'CHAR'],  
		["Sic Code", 'sicCode', 'CHAR'],  
		["Campaign Id", 'campaignId', 'CHAR'],  
	]; 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AccountsDataTable(viewType: "ListView", 
                                            pageNo: 0, 
