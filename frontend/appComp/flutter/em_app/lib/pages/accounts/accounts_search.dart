...
import 'package:em_app/pages/accounts/accounts_lib.dart'; 
	...
	class AccountsSearch extends StatefulWidget { 	
	  const AccountsSearch({Key? key}) : super(key: key); 	
	...
	class _AccountsSearchState extends State<AccountsSearch> { 	
	  ...
	  Widget build(BuildContext context) { 	
		return Scaffold( 	
	        ...
	        appBar: AppBar( 	
	          title: const Text("Accounts Search Record"), 	
	          centerTitle: true, 	
	        ), 	
	                    ...
	                    children: [ 	
	                      ...
	                      _isKeySelected 	
	                          ? FutureBuilder<Accounts>( 	
	                              future: AccountsService.AccountsQuery(_chosenValue) 	
	                                  .then((value) => value), 	
	...
	class AccountsSearchResult extends StatelessWidget { 	
	  final Accounts foundAccounts; 	
	  const AccountsSearchResult({Key? key, required this.foundAccounts}) : super(key: key); 	
