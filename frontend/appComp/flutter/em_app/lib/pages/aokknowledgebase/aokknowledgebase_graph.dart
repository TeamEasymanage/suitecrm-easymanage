...
class AokKnowledgebaseGraph extends StatefulWidget { 	
  const AokKnowledgebaseGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _AokKnowledgebaseGraphState createState() => _AokKnowledgebaseGraphState(); 	
} 	
	 	
class _AokKnowledgebaseGraphState extends State<AokKnowledgebaseGraph> { 	
 	
  //List<AokKnowledgebase> aokKnowledgebaseList = []; 	
  List<EmChartModel> aokKnowledgebaseList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    super.initState(); 	
    //AokKnowledgebaseService.AokKnowledgebaseViewAll().then((getList) { 	
    setState(() { 	
      //aokKnowledgebaseList = getList; 	
      //Local static data loading 	
      aokKnowledgebaseList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'AokKnowledgebase Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                aokKnowledgebaseList: aokKnowledgebaseList) 	
                            : LineChart(lineChartAokKnowledgebase()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartAokKnowledgebase() { 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> aokKnowledgebaseList; 	
  const BarChartSample2({Key? key, required this.aokKnowledgebaseList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.aokKnowledgebaseList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	
