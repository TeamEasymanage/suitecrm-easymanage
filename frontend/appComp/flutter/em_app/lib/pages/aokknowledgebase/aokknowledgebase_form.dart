...
class AokKnowledgebaseForm extends StatefulWidget { 
  const AokKnowledgebaseForm({Key? key}) : super(key: key); 
 
  @override 
  _AokKnowledgebaseFormState createState() => _AokKnowledgebaseFormState(); 
} 
 
class _AokKnowledgebaseFormState extends State<AokKnowledgebaseForm> { 
...
void didChangeDependencies() { 
  ...
  Widget build(BuildContext context) { 
	return Scaffold( 
        ...
        appBar: AppBar( 
          title: const Text("AokKnowledgebase Add Form"), 
          centerTitle: true, 
        ), 
        body: Center( 
          child: Padding( 
            ...
            child: SingleChildScrollView(
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.revision),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
				  ...
				  TextFormField( 
						keyboardType: TextInputType.multiline,  
							maxLines: 3, 
					//em size: Lines : Size: 3, Columns : Display Size: 50 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.additionalInfo),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.userIdC),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.userId1C),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
 ...
 */ 
 ...
 // [4] Uncomment For Media Upload Customization. Also Uncomment Media Field Assignment in  newAokKnowledgebase creation below  
 /* 
                          //Get Base64 ready 
 ...
 */ 
 ...
 /* 
                          //Uncomment and Use Model AokKnowledgebaseWoKey from model.dart, when key should not be passed, it is @GeneratedValue on API side  
                          AokKnowledgebaseWoKey newAokKnowledgebase = AokKnowledgebaseWoKey( 
 ...
 */ 
					   ...
					   userId1C: userId1CVar , 
                          ...
                          await AokKnowledgebaseService.AokKnowledgebaseCreate( 
                                  newAokKnowledgebase.toJson()) 
                              .then((message) { 
                                    apiMessage = message; 
