...
class AokKnowledgebaseOnlyDd extends StatefulWidget { 
  const AokKnowledgebaseOnlyDd({Key? key}) : super(key: key); 
 
  @override 
  _AokKnowledgebaseOnlyDdState createState() => _AokKnowledgebaseOnlyDdState(); 
} 
 
class _AokKnowledgebaseOnlyDdState extends State<AokKnowledgebaseOnlyDd> { 
    ...
    AokKnowledgebaseService.AokKnowledgebaseViewAll( 	
      ...
      setState(() { 	
       aokKnowledgebaseList = getList; 	
		idSelected = aokKnowledgebaseList[0].toListLabVal()[0][1].toString();	
		 //Remove duplicates 	
        //aokKnowledgebaseList = aokKnowledgebaseList.toSet().toList();	
        _loading = false;	
      });	
    });	
  } 	
...
class AokKnowledgebaseEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AokKnowledgebaseEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AokKnowledgebaseEditDdState createState() => _AokKnowledgebaseEditDdState(); 
} 
 
class _AokKnowledgebaseEditDdState extends State<AokKnowledgebaseEditDd> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
	     backgroundColor: Colors.blue.shade200,	
        appBar: AppBar( 	
          title: const Text("AokKnowledgebase Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
            ? EmShowProgress(msg: errorMsg)	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AokKnowledgebaseEditDdRec( 	
...
class AokKnowledgebaseEditDdRec extends StatefulWidget { 
  final AokKnowledgebase aokKnowledgebase; 
  const AokKnowledgebaseEditDdRec({Key? key, required this.aokKnowledgebase}) : super(key: key); 
 
  @override 
  _AokKnowledgebaseEditDdRecState createState() => _AokKnowledgebaseEditDdRecState(); 
} 
 
class _AokKnowledgebaseEditDdRecState extends State<AokKnowledgebaseEditDdRec> { 
