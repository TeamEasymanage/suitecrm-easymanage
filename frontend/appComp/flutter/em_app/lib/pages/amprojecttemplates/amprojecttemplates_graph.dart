...
class AmProjecttemplatesGraph extends StatefulWidget { 	
  const AmProjecttemplatesGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _AmProjecttemplatesGraphState createState() => _AmProjecttemplatesGraphState(); 	
} 	
	 	
class _AmProjecttemplatesGraphState extends State<AmProjecttemplatesGraph> { 	
 	
  //List<AmProjecttemplates> amProjecttemplatesList = []; 	
  List<EmChartModel> amProjecttemplatesList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    super.initState(); 	
    //AmProjecttemplatesService.AmProjecttemplatesViewAll().then((getList) { 	
    setState(() { 	
      //amProjecttemplatesList = getList; 	
      //Local static data loading 	
      amProjecttemplatesList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'AmProjecttemplates Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                amProjecttemplatesList: amProjecttemplatesList) 	
                            : LineChart(lineChartAmProjecttemplates()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartAmProjecttemplates() { 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> amProjecttemplatesList; 	
  const BarChartSample2({Key? key, required this.amProjecttemplatesList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.amProjecttemplatesList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	
