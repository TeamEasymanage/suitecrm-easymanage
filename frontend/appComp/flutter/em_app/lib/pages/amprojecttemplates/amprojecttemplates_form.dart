...
class AmProjecttemplatesForm extends StatefulWidget { 
  const AmProjecttemplatesForm({Key? key}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesFormState createState() => _AmProjecttemplatesFormState(); 
} 
 
class _AmProjecttemplatesFormState extends State<AmProjecttemplatesForm> { 
...
void didChangeDependencies() { 
  ...
  Widget build(BuildContext context) { 
	return Scaffold( 
        ...
        appBar: AppBar( 
          title: const Text("AmProjecttemplates Add Form"), 
          centerTitle: true, 
        ), 
        body: Center( 
          child: Padding( 
            ...
            child: SingleChildScrollView(
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.overrideBusinessHours),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
 ...
 */ 
 ...
 // [4] Uncomment For Media Upload Customization. Also Uncomment Media Field Assignment in  newAmProjecttemplates creation below  
 /* 
                          //Get Base64 ready 
 ...
 */ 
 ...
 /* 
                          //Uncomment and Use Model AmProjecttemplatesWoKey from model.dart, when key should not be passed, it is @GeneratedValue on API side  
                          AmProjecttemplatesWoKey newAmProjecttemplates = AmProjecttemplatesWoKey( 
 ...
 */ 
					   ...
					   overrideBusinessHours: overrideBusinessHoursVar , 
                          ...
                          await AmProjecttemplatesService.AmProjecttemplatesCreate( 
                                  newAmProjecttemplates.toJson()) 
                              .then((message) { 
                                    apiMessage = message; 
