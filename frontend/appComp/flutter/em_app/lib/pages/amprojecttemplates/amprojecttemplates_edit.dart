...
class AmProjecttemplatesEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AmProjecttemplatesEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesEditState createState() => _AmProjecttemplatesEditState(); 
} 
 
class _AmProjecttemplatesEditState extends State<AmProjecttemplatesEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("AmProjecttemplates Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AmProjecttemplatesEditRec( 	
...
class AmProjecttemplatesEditRec extends StatefulWidget { 
  final AmProjecttemplates amProjecttemplates; 
  const AmProjecttemplatesEditRec({Key? key, required this.amProjecttemplates}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesEditRecState createState() => _AmProjecttemplatesEditRecState(); 
} 
 
class _AmProjecttemplatesEditRecState extends State<AmProjecttemplatesEditRec> { 
