...
class AmProjecttemplatesFilter extends StatefulWidget { 
  const AmProjecttemplatesFilter({Key? key}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesFilterState createState() => _AmProjecttemplatesFilterState(); 
} 
 
class _AmProjecttemplatesFilterState extends State<AmProjecttemplatesFilter> { 
	...
	List<List<String>> tblColumnList = [ 
		...
		["Override Business Hours", 'overrideBusinessHours', 'CHAR'],  
	]; 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AmProjecttemplatesDataTable(viewType: "ListView", 
                                            pageNo: 0, 
