...
class AmProjecttemplatesOnlyDd extends StatefulWidget { 
  const AmProjecttemplatesOnlyDd({Key? key}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesOnlyDdState createState() => _AmProjecttemplatesOnlyDdState(); 
} 
 
class _AmProjecttemplatesOnlyDdState extends State<AmProjecttemplatesOnlyDd> { 
 
  String errorMsg = timeErrStr; 
 
  bool _loading = false; 	
  List<AmProjecttemplates> amProjecttemplatesList = []; 
  ...
  void initState() {	
    ...
    AmProjecttemplatesService.AmProjecttemplatesViewAll( 	
      ...
      setState(() { 	
       amProjecttemplatesList = getList; 	
		idSelected = amProjecttemplatesList[0].toListLabVal()[0][1].toString();	
		 //Remove duplicates 	
        //amProjecttemplatesList = amProjecttemplatesList.toSet().toList();	
        _loading = false;	
      });	
    });	
  } 	
...
class AmProjecttemplatesEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AmProjecttemplatesEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesEditDdState createState() => _AmProjecttemplatesEditDdState(); 
} 
 
class _AmProjecttemplatesEditDdState extends State<AmProjecttemplatesEditDd> { 
  ...
  void initState() {	
    ...
    AmProjecttemplatesService.AmProjecttemplatesViewAllIds().then((ids) { 	
      if (ids is String) {	
        setState(() {	
          errorMsg = ids;	
        });	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
	     backgroundColor: Colors.blue.shade200,	
        appBar: AppBar( 	
          title: const Text("AmProjecttemplates Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
            ? EmShowProgress(msg: errorMsg)	
                    ...
                    Padding(	
                      ...
                      _isKeySelected 	
                          ? FutureBuilder<AmProjecttemplates>( 	
                              future: AmProjecttemplatesService 	
                                      .AmProjecttemplatesQuery(_chosenValue) 	
                                  .then((value) => value), 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AmProjecttemplatesEditDdRec( 	
                                          amProjecttemplates: snapshot.data!); 	
                                    } 	
                                } 	
                              }) 	
                          : const SizedBox( 	
...
class AmProjecttemplatesEditDdRec extends StatefulWidget { 
  final AmProjecttemplates amProjecttemplates; 
  const AmProjecttemplatesEditDdRec({Key? key, required this.amProjecttemplates}) : super(key: key); 
 
  @override 
  _AmProjecttemplatesEditDdRecState createState() => _AmProjecttemplatesEditDdRecState(); 
} 
 
class _AmProjecttemplatesEditDdRecState extends State<AmProjecttemplatesEditDdRec> { 
  AmProjecttemplates foundAmProjecttemplates = AmProjecttemplates(id: "" ); 
  ...
  static final formKey = GlobalKey<FormState>(); 
		...
		String? statusVar = ""; 
		String? priorityVar = ""; 
		String? overrideBusinessHoursVar = ""; 
...
void didChangeDependencies() { 
  ...
  void initState() { 
    super.initState(); 
    setState(() { 
      foundAmProjecttemplates = widget.amProjecttemplates; 
    }); 
  } 
            ...
            child: Form( 
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					   enabled: false,    initialValue: getEmStrOpt(foundAmProjecttemplates.id),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmProjecttemplates.name),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmProjecttemplates.dateEntered),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmProjecttemplates.dateModified),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmProjecttemplates.modifiedUserId),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmProjecttemplates.createdBy),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
				  ...
				  TextFormField( 
					...
					//em size: Lines : Size: 3, Columns : Display Size: 50 
					      initialValue: getEmStrOpt(foundAmProjecttemplates.description),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmProjecttemplates.deleted),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmProjecttemplates.assignedUserId),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmProjecttemplates.status),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmProjecttemplates.priority),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
                  ...
                  const SizedBox(height: 10), 
				  // ---------------------------------------------------------------------------------------  
				  // Column Details:  Srl No : [12] [ Name [Overridebusinesshours] : EM Type [CHAR], Java Type [String]  
				  //                  EM size: maxlength: 0, Display Size : 20 
				  // Flutter Details: Field Label [Override Business Hours], Name [overrideBusinessHours], Type [String]  
				  // ---------------------------------------------------------------------------------------  
				Row( 
				  mainAxisAlignment: MainAxisAlignment.spaceBetween, 
				  children: <Widget>[ 
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmProjecttemplates.overrideBusinessHours),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
					  ...
					  */ 
					decoration: const InputDecoration( 
					  labelText: 'Override Business Hours', 
					  border: OutlineInputBorder(), 
						// filled: true, //for limiting size width/height 
					), 
					//em size: maxlength: 0, Display Size : 20 
					...
					*/  
					//maxLength: 30, 
					onSaved: (value) => setState(() => overrideBusinessHoursVar = value.toString()), 
				  ), //textformfield 
				), //flexible 
				]), //Widget[] //Row 
                  const SizedBox(height: 10), 
                    ...
                    builder: (context) => ButtonWidget( 
                      ...
                      onClicked: () async { 
						...
						// ===== BEGIN BLOCK : Calling API Service Calls ('Edit') 1st (optional 2nd...) and Routing to Next Screen 
                          ...
                          AmProjecttemplates newAmProjecttemplates = AmProjecttemplates( 
					   id: idVar , 
					   name: nameVar , 
					   ...
					   overrideBusinessHours: overrideBusinessHoursVar , 
							  ); 
 
                          await AmProjecttemplatesService.AmProjecttemplatesEdit( 
                                  newAmProjecttemplates.id, 
                                  newAmProjecttemplates) 
                              .then((message) { 
                                    apiMessage = message; 
