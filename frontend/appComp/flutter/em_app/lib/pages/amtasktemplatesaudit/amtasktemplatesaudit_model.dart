...
List<AmTasktemplatesAudit> amTasktemplatesAuditFromJson(String str) => 
    List<AmTasktemplatesAudit>.from(json.decode(str).map((x) => AmTasktemplatesAudit.fromJson(x))); 
 
String amTasktemplatesAuditToJson(List<AmTasktemplatesAudit> data) => 
...
class AmTasktemplatesAudit { 
  ...
  factory AmTasktemplatesAudit.fromJson(Map<String, dynamic> json) => AmTasktemplatesAudit( 
		id: json["id"], 
...
/* 
class AmTasktemplatesAuditWoKey { 
  AmTasktemplatesAuditWoKey({ 
	//		required this.id, 
		this.parentId, 
		this.dateCreated, 
		this.createdBy, 
