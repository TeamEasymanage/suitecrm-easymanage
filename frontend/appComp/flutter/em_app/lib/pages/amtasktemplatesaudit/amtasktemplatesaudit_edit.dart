...
class AmTasktemplatesAuditEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AmTasktemplatesAuditEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AmTasktemplatesAuditEditState createState() => _AmTasktemplatesAuditEditState(); 
} 
 
class _AmTasktemplatesAuditEditState extends State<AmTasktemplatesAuditEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("AmTasktemplatesAudit Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AmTasktemplatesAuditEditRec( 	
...
class AmTasktemplatesAuditEditRec extends StatefulWidget { 
  final AmTasktemplatesAudit amTasktemplatesAudit; 
  const AmTasktemplatesAuditEditRec({Key? key, required this.amTasktemplatesAudit}) : super(key: key); 
 
  @override 
  _AmTasktemplatesAuditEditRecState createState() => _AmTasktemplatesAuditEditRecState(); 
} 
 
class _AmTasktemplatesAuditEditRecState extends State<AmTasktemplatesAuditEditRec> { 
