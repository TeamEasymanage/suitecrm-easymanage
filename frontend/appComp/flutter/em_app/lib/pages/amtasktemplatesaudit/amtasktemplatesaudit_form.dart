...
class AmTasktemplatesAuditForm extends StatefulWidget { 
  const AmTasktemplatesAuditForm({Key? key}) : super(key: key); 
 
  @override 
  _AmTasktemplatesAuditFormState createState() => _AmTasktemplatesAuditFormState(); 
} 
 
class _AmTasktemplatesAuditFormState extends State<AmTasktemplatesAuditForm> { 
...
void didChangeDependencies() { 
  ...
  Widget build(BuildContext context) { 
	return Scaffold( 
        ...
        appBar: AppBar( 
          title: const Text("AmTasktemplatesAudit Add Form"), 
          centerTitle: true, 
        ), 
        body: Center( 
          child: Padding( 
 ...
 */ 
 ...
 // [4] Uncomment For Media Upload Customization. Also Uncomment Media Field Assignment in  newAmTasktemplatesAudit creation below  
 /* 
                          //Get Base64 ready 
 ...
 */ 
 ...
 /* 
                          //Uncomment and Use Model AmTasktemplatesAuditWoKey from model.dart, when key should not be passed, it is @GeneratedValue on API side  
                          AmTasktemplatesAuditWoKey newAmTasktemplatesAudit = AmTasktemplatesAuditWoKey( 
 ...
 */ 
					   ...
					   afterValueText: afterValueTextVar , 
                          ...
                          await AmTasktemplatesAuditService.AmTasktemplatesAuditCreate( 
                                  newAmTasktemplatesAudit.toJson()) 
                              .then((message) { 
                                    apiMessage = message; 
