...
class AmTasktemplatesAuditFilter extends StatefulWidget { 
  const AmTasktemplatesAuditFilter({Key? key}) : super(key: key); 
 
  @override 
  _AmTasktemplatesAuditFilterState createState() => _AmTasktemplatesAuditFilterState(); 
} 
 
class _AmTasktemplatesAuditFilterState extends State<AmTasktemplatesAuditFilter> { 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            AmTasktemplatesAuditDataTable(viewType: "ListView", 
                                            pageNo: 0, 
