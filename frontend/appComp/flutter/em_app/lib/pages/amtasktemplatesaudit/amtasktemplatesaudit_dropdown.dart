...
class AmTasktemplatesAuditOnlyDd extends StatefulWidget { 
  const AmTasktemplatesAuditOnlyDd({Key? key}) : super(key: key); 
 
  @override 
  _AmTasktemplatesAuditOnlyDdState createState() => _AmTasktemplatesAuditOnlyDdState(); 
} 
 
class _AmTasktemplatesAuditOnlyDdState extends State<AmTasktemplatesAuditOnlyDd> { 
    ...
    AmTasktemplatesAuditService.AmTasktemplatesAuditViewAll( 	
      ...
      setState(() { 	
       amTasktemplatesAuditList = getList; 	
		idSelected = amTasktemplatesAuditList[0].toListLabVal()[0][1].toString();	
		 //Remove duplicates 	
        //amTasktemplatesAuditList = amTasktemplatesAuditList.toSet().toList();	
        _loading = false;	
      });	
    });	
  } 	
                                  ...
                                  children: [	
                                    ...
                                    DropdownButton<String>(	
                                      ...
                                      style: const TextStyle(	
                                          ...
                                          color: Colors.black),	
                                      items: amTasktemplatesAuditList	
...
class AmTasktemplatesAuditEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final String idSelected; 
  const AmTasktemplatesAuditEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _AmTasktemplatesAuditEditDdState createState() => _AmTasktemplatesAuditEditDdState(); 
} 
 
class _AmTasktemplatesAuditEditDdState extends State<AmTasktemplatesAuditEditDd> { 
  ...
  void initState() {	
    ...
    AmTasktemplatesAuditService.AmTasktemplatesAuditViewAllIds().then((ids) { 	
      if (ids is String) {	
        setState(() {	
          errorMsg = ids;	
        });	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
	     backgroundColor: Colors.blue.shade200,	
        appBar: AppBar( 	
          title: const Text("AmTasktemplatesAudit Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
            ? EmShowProgress(msg: errorMsg)	
                ...
                child: Row(	
                  ...
                  children: [	
                    Padding(	
                      ...
                      _isKeySelected 	
                          ? FutureBuilder<AmTasktemplatesAudit>( 	
                              future: AmTasktemplatesAuditService 	
                                      .AmTasktemplatesAuditQuery(_chosenValue) 	
                                  .then((value) => value), 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return AmTasktemplatesAuditEditDdRec( 	
                                          amTasktemplatesAudit: snapshot.data!); 	
                                    } 	
                                } 	
                              }) 	
                          : const SizedBox( 	
...
class AmTasktemplatesAuditEditDdRec extends StatefulWidget { 
  final AmTasktemplatesAudit amTasktemplatesAudit; 
  const AmTasktemplatesAuditEditDdRec({Key? key, required this.amTasktemplatesAudit}) : super(key: key); 
 
  @override 
  _AmTasktemplatesAuditEditDdRecState createState() => _AmTasktemplatesAuditEditDdRecState(); 
} 
 
class _AmTasktemplatesAuditEditDdRecState extends State<AmTasktemplatesAuditEditDdRec> { 
  AmTasktemplatesAudit foundAmTasktemplatesAudit = AmTasktemplatesAudit(id: "" ); 
...
void didChangeDependencies() { 
  ...
  void initState() { 
    super.initState(); 
    setState(() { 
      foundAmTasktemplatesAudit = widget.amTasktemplatesAudit; 
    }); 
  } 
            ...
            child: Form( 
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					   enabled: false,    initialValue: getEmStrOpt(foundAmTasktemplatesAudit.id),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmTasktemplatesAudit.parentId),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmTasktemplatesAudit.dateCreated),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmTasktemplatesAudit.createdBy),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmTasktemplatesAudit.fieldName),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmTasktemplatesAudit.dataType),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmTasktemplatesAudit.beforeValueString),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundAmTasktemplatesAudit.afterValueString),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
				  ...
				  TextFormField( 
					...
					//em size: Lines : Size: 3, Columns : Display Size: 50 
					      initialValue: getEmStrOpt(foundAmTasktemplatesAudit.beforeValueText),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
				  ...
				  TextFormField( 
						keyboardType: TextInputType.multiline,  
							maxLines: 3, 
					//em size: Lines : Size: 3, Columns : Display Size: 50 
					      initialValue: getEmStrOpt(foundAmTasktemplatesAudit.afterValueText),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
                    ...
                    builder: (context) => ButtonWidget( 
                      ...
                      onClicked: () async { 
						...
						// ===== BEGIN BLOCK : Calling API Service Calls ('Edit') 1st (optional 2nd...) and Routing to Next Screen 
                          ...
                          AmTasktemplatesAudit newAmTasktemplatesAudit = AmTasktemplatesAudit( 
					   id: idVar , 
					   ...
					   afterValueText: afterValueTextVar , 
                          ...
                          await AmTasktemplatesAuditService.AmTasktemplatesAuditEdit( 
                                  newAmTasktemplatesAudit.id, 
                                  newAmTasktemplatesAudit) 
                              .then((message) { 
                                    apiMessage = message; 
